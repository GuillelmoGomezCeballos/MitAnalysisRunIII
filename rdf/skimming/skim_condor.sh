...
if [ ! -d "/work/submit/ceballos/skims/pho/${sampleName}" ]; then
  ...
  mkdir -p /work/submit/ceballos/skims/pho/${sampleName}
fi
...
transfer_input_files = skim.py, skim_input_samples.cfg, skim_input_samples_fromDAS.cfg, skim_input_files.cfg, skim_input_files_fromDAS.cfg, functions_skim.cc, haddnanoaod.py, jsns/Cert_314472-325175_13TeV_Legacy2018_Collisions18_JSON.txt
