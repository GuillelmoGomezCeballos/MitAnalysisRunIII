...
def make3LVar(df,postFixMu,postFixEl):
    ...
    dftag =(df.Define("m3l{0}".format(postFix),    "compute_3l_var(fake_Muon_pt{0}, fake_Muon_eta, fake_Muon_phi, fake_Muon_mass, fake_Muon_charge, fake_Electron_pt{1}, fake_Electron_eta, fake_Electron_phi, fake_Electron_mass, fake_Electron_charge, MET_pt, MET_phi, 0)".format(postFixMu,postFixEl))
              ...
              .Define("etalW{0}".format(postFix),  "abs(compute_3l_var(fake_Muon_pt{0}, fake_Muon_eta, fake_Muon_phi, fake_Muon_mass, fake_Muon_charge, fake_Electron_pt{1}, fake_Electron_eta, fake_Electron_phi, fake_Electron_mass, fake_Electron_charge, MET_pt, MET_phi,13))".format(postFixMu,postFixEl))
              .Define("mtW{0}".format(postFix),    "compute_3l_var(fake_Muon_pt{0}, fake_Muon_eta, fake_Muon_phi, fake_Muon_mass, fake_Muon_charge, fake_Electron_pt{1}, fake_Electron_eta, fake_Electron_phi, fake_Electron_mass, fake_Electron_charge, MET_pt, MET_phi,14)".format(postFixMu,postFixEl))
