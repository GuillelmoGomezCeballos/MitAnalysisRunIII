...
def selectionJetMet(df,year,bTagSel,isData,count,jetEtaCut):
    ...
    if(isData == "false"):
        dftag =(dftag.Define("clean_Jet_genJetIdx", "Jet_genJetIdx[clean_jet]")
                     ...
                     .Define("clean_Jet_ptJes03Up", "compute_JSON_JES_Unc(clean_Jet_ptDef,clean_Jet_eta,clean_Jet_rawFactor,clean_Jet_area,Rho_fixedGridRhoFastjetAll, +4,{0})".format(jetTypeCorr))
                     .Define("clean_Jet_ptJes04Up", "compute_JSON_JES_Unc(clean_Jet_ptDef,clean_Jet_eta,clean_Jet_rawFactor,clean_Jet_area,Rho_fixedGridRhoFastjetAll, +5,{0})".format(jetTypeCorr))
                     .Define("clean_Jet_ptJes05Up", "compute_JSON_JES_Unc(clean_Jet_ptDef,clean_Jet_eta,clean_Jet_rawFactor,clean_Jet_area,Rho_fixedGridRhoFastjetAll, +6,{0})".format(jetTypeCorr))
                     .Define("clean_Jet_ptJes06Up", "compute_JSON_JES_Unc(clean_Jet_ptDef,clean_Jet_eta,clean_Jet_rawFactor,clean_Jet_area,Rho_fixedGridRhoFastjetAll, +7,{0})".format(jetTypeCorr))
                     .Define("clean_Jet_ptJes07Up", "compute_JSON_JES_Unc(clean_Jet_ptDef,clean_Jet_eta,clean_Jet_rawFactor,clean_Jet_area,Rho_fixedGridRhoFastjetAll, +8,{0})".format(jetTypeCorr))
                     .Define("clean_Jet_ptJes08Up", "compute_JSON_JES_Unc(clean_Jet_ptDef,clean_Jet_eta,clean_Jet_rawFactor,clean_Jet_area,Rho_fixedGridRhoFastjetAll, +9,{0})".format(jetTypeCorr))
                     .Define("clean_Jet_ptJes09Up", "compute_JSON_JES_Unc(clean_Jet_ptDef,clean_Jet_eta,clean_Jet_rawFactor,clean_Jet_area,Rho_fixedGridRhoFastjetAll,+10,{0})".format(jetTypeCorr))
                     .Define("clean_Jet_ptJes10Up", "compute_JSON_JES_Unc(clean_Jet_ptDef,clean_Jet_eta,clean_Jet_rawFactor,clean_Jet_area,Rho_fixedGridRhoFastjetAll,+11,{0})".format(jetTypeCorr))
                     .Define("clean_Jet_ptJes11Up", "compute_JSON_JES_Unc(clean_Jet_ptDef,clean_Jet_eta,clean_Jet_rawFactor,clean_Jet_area,Rho_fixedGridRhoFastjetAll,+12,{0})".format(jetTypeCorr))
                     .Define("clean_Jet_ptJes12Up", "compute_JSON_JES_Unc(clean_Jet_ptDef,clean_Jet_eta,clean_Jet_rawFactor,clean_Jet_area,Rho_fixedGridRhoFastjetAll,+13,{0})".format(jetTypeCorr))
                     .Define("clean_Jet_ptJes13Up", "compute_JSON_JES_Unc(clean_Jet_ptDef,clean_Jet_eta,clean_Jet_rawFactor,clean_Jet_area,Rho_fixedGridRhoFastjetAll,+14,{0})".format(jetTypeCorr))
                     .Define("clean_Jet_ptJes14Up", "compute_JSON_JES_Unc(clean_Jet_ptDef,clean_Jet_eta,clean_Jet_rawFactor,clean_Jet_area,Rho_fixedGridRhoFastjetAll,+15,{0})".format(jetTypeCorr))
                     .Define("clean_Jet_ptJes15Up", "compute_JSON_JES_Unc(clean_Jet_ptDef,clean_Jet_eta,clean_Jet_rawFactor,clean_Jet_area,Rho_fixedGridRhoFastjetAll,+16,{0})".format(jetTypeCorr))
                     .Define("clean_Jet_ptJes16Up", "compute_JSON_JES_Unc(clean_Jet_ptDef,clean_Jet_eta,clean_Jet_rawFactor,clean_Jet_area,Rho_fixedGridRhoFastjetAll,+17,{0})".format(jetTypeCorr))
                     .Define("clean_Jet_ptJes17Up", "compute_JSON_JES_Unc(clean_Jet_ptDef,clean_Jet_eta,clean_Jet_rawFactor,clean_Jet_area,Rho_fixedGridRhoFastjetAll,+18,{0})".format(jetTypeCorr))
                     .Define("clean_Jet_ptJes18Up", "compute_JSON_JES_Unc(clean_Jet_ptDef,clean_Jet_eta,clean_Jet_rawFactor,clean_Jet_area,Rho_fixedGridRhoFastjetAll,+19,{0})".format(jetTypeCorr))
                     .Define("clean_Jet_ptJes19Up", "compute_JSON_JES_Unc(clean_Jet_ptDef,clean_Jet_eta,clean_Jet_rawFactor,clean_Jet_area,Rho_fixedGridRhoFastjetAll,+20,{0})".format(jetTypeCorr))
                     .Define("clean_Jet_ptJes20Up", "compute_JSON_JES_Unc(clean_Jet_ptDef,clean_Jet_eta,clean_Jet_rawFactor,clean_Jet_area,Rho_fixedGridRhoFastjetAll,+21,{0})".format(jetTypeCorr))
                     .Define("clean_Jet_ptJes21Up", "compute_JSON_JES_Unc(clean_Jet_ptDef,clean_Jet_eta,clean_Jet_rawFactor,clean_Jet_area,Rho_fixedGridRhoFastjetAll,+22,{0})".format(jetTypeCorr))
                     .Define("clean_Jet_ptJes22Up", "compute_JSON_JES_Unc(clean_Jet_ptDef,clean_Jet_eta,clean_Jet_rawFactor,clean_Jet_area,Rho_fixedGridRhoFastjetAll,+23,{0})".format(jetTypeCorr))
                     .Define("clean_Jet_ptJes23Up", "compute_JSON_JES_Unc(clean_Jet_ptDef,clean_Jet_eta,clean_Jet_rawFactor,clean_Jet_area,Rho_fixedGridRhoFastjetAll,+24,{0})".format(jetTypeCorr))
                     .Define("clean_Jet_ptJes24Up", "compute_JSON_JES_Unc(clean_Jet_ptDef,clean_Jet_eta,clean_Jet_rawFactor,clean_Jet_area,Rho_fixedGridRhoFastjetAll,+25,{0})".format(jetTypeCorr))
