...
def analysis(df,count,category,weight,year,PDType,isData,whichJob,nTheoryReplicas,genEventSumLHEScaleRenorm,genEventSumPSRenorm,puWeights,histoBTVEffEtaPtLF,histoBTVEffEtaPtCJ,histoBTVEffEtaPtBJ,histoFakeEtaPt_mu,histoFakeEtaPt_el,histoLepSFEtaPt_mu,histoLepSFEtaPt_el,histoTriggerSFEtaPt_0_0,histoTriggerSFEtaPt_0_1,histoTriggerSFEtaPt_0_2,histoTriggerSFEtaPt_0_3,histoTriggerSFEtaPt_1_0,histoTriggerSFEtaPt_1_1,histoTriggerSFEtaPt_1_2,histoTriggerSFEtaPt_1_3,histoTriggerSFEtaPt_2_0,histoTriggerSFEtaPt_2_1,histoTriggerSFEtaPt_2_2,histoTriggerSFEtaPt_2_3,histoTriggerSFEtaPt_3_0,histoTriggerSFEtaPt_3_1,histoTriggerSFEtaPt_3_2,histoTriggerSFEtaPt_3_3):
    ...
    for x in range(nCat):
        ...
        if(makeDataCards >= 1):
            ...
            histo2D[startF+154][x]    = makeFinalVariable2D(dfssx0cat[x],"ngood_jetsJes0Up"	    ,"theGenCat",theCat,startF,x,BinXF,minXF,maxXF,BinYF,minYF,maxYF,154)
            histo2D[startF+155][x]    = makeFinalVariable2D(dfssx0cat[x],"ngood_jetsJes0Down"	    ,"theGenCat",theCat,startF,x,BinXF,minXF,maxXF,BinYF,minYF,maxYF,155)
            histo2D[startF+156][x]    = makeFinalVariable2D(dfssx0cat[x],"ngood_jetsJerUp"	    ,"theGenCat",theCat,startF,x,BinXF,minXF,maxXF,BinYF,minYF,maxYF,156)
            histo2D[startF+157][x]    = makeFinalVariable2D(dfssx0cat[x],"ngood_jetsJerDown"	    ,"theGenCat",theCat,startF,x,BinXF,minXF,maxXF,BinYF,minYF,maxYF,157)
            histo2D[startF+158][x]    = makeFinalVariable2D(dfssx0catMuonMomUp      [x],"ngood_jets","theGenCat",theCat,startF,x,BinXF,minXF,maxXF,BinYF,minYF,maxYF,158)
            histo2D[startF+159][x]    = makeFinalVariable2D(dfssx0catMuonMomDown    [x],"ngood_jets","theGenCat",theCat,startF,x,BinXF,minXF,maxXF,BinYF,minYF,maxYF,159)
            histo2D[startF+160][x]    = makeFinalVariable2D(dfssx0catElectronMomUp  [x],"ngood_jets","theGenCat",theCat,startF,x,BinXF,minXF,maxXF,BinYF,minYF,maxYF,160)
            histo2D[startF+161][x]    = makeFinalVariable2D(dfssx0catElectronMomDown[x],"ngood_jets","theGenCat",theCat,startF,x,BinXF,minXF,maxXF,BinYF,minYF,maxYF,161)
            ...
            histo2D[startF+168][x]    = makeFinalVariable2D(dfssx0cat[x],"ngood_jetsJes1Up"	    ,"theGenCat",theCat,startF,x,BinXF,minXF,maxXF,BinYF,minYF,maxYF,168)
            histo2D[startF+169][x]    = makeFinalVariable2D(dfssx0cat[x],"ngood_jetsJes1Down"	    ,"theGenCat",theCat,startF,x,BinXF,minXF,maxXF,BinYF,minYF,maxYF,169)
            histo2D[startF+170][x]    = makeFinalVariable2D(dfssx0cat[x],"ngood_jetsJes2Up"	    ,"theGenCat",theCat,startF,x,BinXF,minXF,maxXF,BinYF,minYF,maxYF,170)
            histo2D[startF+171][x]    = makeFinalVariable2D(dfssx0cat[x],"ngood_jetsJes2Down"	    ,"theGenCat",theCat,startF,x,BinXF,minXF,maxXF,BinYF,minYF,maxYF,171)
            histo2D[startF+172][x]    = makeFinalVariable2D(dfssx0cat[x],"ngood_jetsJes3Up"	    ,"theGenCat",theCat,startF,x,BinXF,minXF,maxXF,BinYF,minYF,maxYF,172)
            histo2D[startF+173][x]    = makeFinalVariable2D(dfssx0cat[x],"ngood_jetsJes3Down"	    ,"theGenCat",theCat,startF,x,BinXF,minXF,maxXF,BinYF,minYF,maxYF,173)
            histo2D[startF+174][x]    = makeFinalVariable2D(dfssx0cat[x],"ngood_jetsJes4Up"	    ,"theGenCat",theCat,startF,x,BinXF,minXF,maxXF,BinYF,minYF,maxYF,174)
            histo2D[startF+175][x]    = makeFinalVariable2D(dfssx0cat[x],"ngood_jetsJes4Down"	    ,"theGenCat",theCat,startF,x,BinXF,minXF,maxXF,BinYF,minYF,maxYF,175)
            histo2D[startF+176][x]    = makeFinalVariable2D(dfssx0cat[x],"ngood_jetsJes5Up"	    ,"theGenCat",theCat,startF,x,BinXF,minXF,maxXF,BinYF,minYF,maxYF,176)
            histo2D[startF+177][x]    = makeFinalVariable2D(dfssx0cat[x],"ngood_jetsJes5Down"	    ,"theGenCat",theCat,startF,x,BinXF,minXF,maxXF,BinYF,minYF,maxYF,177)
            histo2D[startF+178][x]    = makeFinalVariable2D(dfssx0cat[x],"ngood_jetsJes6Up"	    ,"theGenCat",theCat,startF,x,BinXF,minXF,maxXF,BinYF,minYF,maxYF,178)
            histo2D[startF+179][x]    = makeFinalVariable2D(dfssx0cat[x],"ngood_jetsJes6Down"	    ,"theGenCat",theCat,startF,x,BinXF,minXF,maxXF,BinYF,minYF,maxYF,179)
            ...
            histo2D[startF+154][x]    = makeFinalVariable2D(dfwwx0cat[x],"ngood_jetsJes0Up"	    ,"theGenCat",theCat,startF,x,BinXF,minXF,maxXF,BinYF,minYF,maxYF,154)
            histo2D[startF+155][x]    = makeFinalVariable2D(dfwwx0cat[x],"ngood_jetsJes0Down"	    ,"theGenCat",theCat,startF,x,BinXF,minXF,maxXF,BinYF,minYF,maxYF,155)
            histo2D[startF+156][x]    = makeFinalVariable2D(dfwwx0cat[x],"ngood_jetsJerUp"	    ,"theGenCat",theCat,startF,x,BinXF,minXF,maxXF,BinYF,minYF,maxYF,156)
            histo2D[startF+157][x]    = makeFinalVariable2D(dfwwx0cat[x],"ngood_jetsJerDown"	    ,"theGenCat",theCat,startF,x,BinXF,minXF,maxXF,BinYF,minYF,maxYF,157)
            histo2D[startF+158][x]    = makeFinalVariable2D(dfwwx0catMuonMomUp      [x],"ngood_jets","theGenCat",theCat,startF,x,BinXF,minXF,maxXF,BinYF,minYF,maxYF,158)
            histo2D[startF+159][x]    = makeFinalVariable2D(dfwwx0catMuonMomDown    [x],"ngood_jets","theGenCat",theCat,startF,x,BinXF,minXF,maxXF,BinYF,minYF,maxYF,159)
            histo2D[startF+160][x]    = makeFinalVariable2D(dfwwx0catElectronMomUp  [x],"ngood_jets","theGenCat",theCat,startF,x,BinXF,minXF,maxXF,BinYF,minYF,maxYF,160)
            histo2D[startF+161][x]    = makeFinalVariable2D(dfwwx0catElectronMomDown[x],"ngood_jets","theGenCat",theCat,startF,x,BinXF,minXF,maxXF,BinYF,minYF,maxYF,161)
            ...
            histo2D[startF+168][x]    = makeFinalVariable2D(dfwwx0cat[x],"ngood_jetsJes1Up"	    ,"theGenCat",theCat,startF,x,BinXF,minXF,maxXF,BinYF,minYF,maxYF,168)
            histo2D[startF+169][x]    = makeFinalVariable2D(dfwwx0cat[x],"ngood_jetsJes1Down"	    ,"theGenCat",theCat,startF,x,BinXF,minXF,maxXF,BinYF,minYF,maxYF,169)
            histo2D[startF+170][x]    = makeFinalVariable2D(dfwwx0cat[x],"ngood_jetsJes2Up"	    ,"theGenCat",theCat,startF,x,BinXF,minXF,maxXF,BinYF,minYF,maxYF,170)
            histo2D[startF+171][x]    = makeFinalVariable2D(dfwwx0cat[x],"ngood_jetsJes2Down"	    ,"theGenCat",theCat,startF,x,BinXF,minXF,maxXF,BinYF,minYF,maxYF,171)
            histo2D[startF+172][x]    = makeFinalVariable2D(dfwwx0cat[x],"ngood_jetsJes3Up"	    ,"theGenCat",theCat,startF,x,BinXF,minXF,maxXF,BinYF,minYF,maxYF,172)
            histo2D[startF+173][x]    = makeFinalVariable2D(dfwwx0cat[x],"ngood_jetsJes3Down"	    ,"theGenCat",theCat,startF,x,BinXF,minXF,maxXF,BinYF,minYF,maxYF,173)
            histo2D[startF+174][x]    = makeFinalVariable2D(dfwwx0cat[x],"ngood_jetsJes4Up"	    ,"theGenCat",theCat,startF,x,BinXF,minXF,maxXF,BinYF,minYF,maxYF,174)
            histo2D[startF+175][x]    = makeFinalVariable2D(dfwwx0cat[x],"ngood_jetsJes4Down"	    ,"theGenCat",theCat,startF,x,BinXF,minXF,maxXF,BinYF,minYF,maxYF,175)
            histo2D[startF+176][x]    = makeFinalVariable2D(dfwwx0cat[x],"ngood_jetsJes5Up"	    ,"theGenCat",theCat,startF,x,BinXF,minXF,maxXF,BinYF,minYF,maxYF,176)
            histo2D[startF+177][x]    = makeFinalVariable2D(dfwwx0cat[x],"ngood_jetsJes5Down"	    ,"theGenCat",theCat,startF,x,BinXF,minXF,maxXF,BinYF,minYF,maxYF,177)
            histo2D[startF+178][x]    = makeFinalVariable2D(dfwwx0cat[x],"ngood_jetsJes6Up"	    ,"theGenCat",theCat,startF,x,BinXF,minXF,maxXF,BinYF,minYF,maxYF,178)
            histo2D[startF+179][x]    = makeFinalVariable2D(dfwwx0cat[x],"ngood_jetsJes6Down"	    ,"theGenCat",theCat,startF,x,BinXF,minXF,maxXF,BinYF,minYF,maxYF,179)
            if(x == plotCategory("kPlotNonPrompt")):
                startNonPrompt = 6
            ...
            histo2D[startF+154][x]    = makeFinalVariable2D(dfztt0cat[x],"ngood_jetsJes0Up"	    ,"theGenCat",theCat,startF,x,BinXF,minXF,maxXF,BinYF,minYF,maxYF,154)
            histo2D[startF+155][x]    = makeFinalVariable2D(dfztt0cat[x],"ngood_jetsJes0Down"	    ,"theGenCat",theCat,startF,x,BinXF,minXF,maxXF,BinYF,minYF,maxYF,155)
            histo2D[startF+156][x]    = makeFinalVariable2D(dfztt0cat[x],"ngood_jetsJerUp"	    ,"theGenCat",theCat,startF,x,BinXF,minXF,maxXF,BinYF,minYF,maxYF,156)
            histo2D[startF+157][x]    = makeFinalVariable2D(dfztt0cat[x],"ngood_jetsJerDown"	    ,"theGenCat",theCat,startF,x,BinXF,minXF,maxXF,BinYF,minYF,maxYF,157)
            histo2D[startF+158][x]    = makeFinalVariable2D(dfztt0catMuonMomUp      [x],"ngood_jets","theGenCat",theCat,startF,x,BinXF,minXF,maxXF,BinYF,minYF,maxYF,158)
            histo2D[startF+159][x]    = makeFinalVariable2D(dfztt0catMuonMomDown    [x],"ngood_jets","theGenCat",theCat,startF,x,BinXF,minXF,maxXF,BinYF,minYF,maxYF,159)
            histo2D[startF+160][x]    = makeFinalVariable2D(dfztt0catElectronMomUp  [x],"ngood_jets","theGenCat",theCat,startF,x,BinXF,minXF,maxXF,BinYF,minYF,maxYF,160)
            histo2D[startF+161][x]    = makeFinalVariable2D(dfztt0catElectronMomDown[x],"ngood_jets","theGenCat",theCat,startF,x,BinXF,minXF,maxXF,BinYF,minYF,maxYF,161)
            ...
            histo2D[startF+168][x]    = makeFinalVariable2D(dfztt0cat[x],"ngood_jetsJes1Up"	    ,"theGenCat",theCat,startF,x,BinXF,minXF,maxXF,BinYF,minYF,maxYF,168)
            histo2D[startF+169][x]    = makeFinalVariable2D(dfztt0cat[x],"ngood_jetsJes1Down"	    ,"theGenCat",theCat,startF,x,BinXF,minXF,maxXF,BinYF,minYF,maxYF,169)
            histo2D[startF+170][x]    = makeFinalVariable2D(dfztt0cat[x],"ngood_jetsJes2Up"	    ,"theGenCat",theCat,startF,x,BinXF,minXF,maxXF,BinYF,minYF,maxYF,170)
            histo2D[startF+171][x]    = makeFinalVariable2D(dfztt0cat[x],"ngood_jetsJes2Down"	    ,"theGenCat",theCat,startF,x,BinXF,minXF,maxXF,BinYF,minYF,maxYF,171)
            histo2D[startF+172][x]    = makeFinalVariable2D(dfztt0cat[x],"ngood_jetsJes3Up"	    ,"theGenCat",theCat,startF,x,BinXF,minXF,maxXF,BinYF,minYF,maxYF,172)
            histo2D[startF+173][x]    = makeFinalVariable2D(dfztt0cat[x],"ngood_jetsJes3Down"	    ,"theGenCat",theCat,startF,x,BinXF,minXF,maxXF,BinYF,minYF,maxYF,173)
            histo2D[startF+174][x]    = makeFinalVariable2D(dfztt0cat[x],"ngood_jetsJes4Up"	    ,"theGenCat",theCat,startF,x,BinXF,minXF,maxXF,BinYF,minYF,maxYF,174)
            histo2D[startF+175][x]    = makeFinalVariable2D(dfztt0cat[x],"ngood_jetsJes4Down"	    ,"theGenCat",theCat,startF,x,BinXF,minXF,maxXF,BinYF,minYF,maxYF,175)
            histo2D[startF+176][x]    = makeFinalVariable2D(dfztt0cat[x],"ngood_jetsJes5Up"	    ,"theGenCat",theCat,startF,x,BinXF,minXF,maxXF,BinYF,minYF,maxYF,176)
            histo2D[startF+177][x]    = makeFinalVariable2D(dfztt0cat[x],"ngood_jetsJes5Down"	    ,"theGenCat",theCat,startF,x,BinXF,minXF,maxXF,BinYF,minYF,maxYF,177)
            histo2D[startF+178][x]    = makeFinalVariable2D(dfztt0cat[x],"ngood_jetsJes6Up"	    ,"theGenCat",theCat,startF,x,BinXF,minXF,maxXF,BinYF,minYF,maxYF,178)
            histo2D[startF+179][x]    = makeFinalVariable2D(dfztt0cat[x],"ngood_jetsJes6Down"	    ,"theGenCat",theCat,startF,x,BinXF,minXF,maxXF,BinYF,minYF,maxYF,179)
            if(x == plotCategory("kPlotNonPrompt")):
                startNonPrompt = 12
            ...
            histo2D[startF+154][x]    = makeFinalVariable2D(dftop0cat[x],"ngood_jetsJes0Up"	    ,"theGenCat",theCat,startF,x,BinXF,minXF,maxXF,BinYF,minYF,maxYF,154)
            histo2D[startF+155][x]    = makeFinalVariable2D(dftop0cat[x],"ngood_jetsJes0Down"	    ,"theGenCat",theCat,startF,x,BinXF,minXF,maxXF,BinYF,minYF,maxYF,155)
            histo2D[startF+156][x]    = makeFinalVariable2D(dftop0cat[x],"ngood_jetsJerUp"	    ,"theGenCat",theCat,startF,x,BinXF,minXF,maxXF,BinYF,minYF,maxYF,156)
            histo2D[startF+157][x]    = makeFinalVariable2D(dftop0cat[x],"ngood_jetsJerDown"	    ,"theGenCat",theCat,startF,x,BinXF,minXF,maxXF,BinYF,minYF,maxYF,157)
            histo2D[startF+158][x]    = makeFinalVariable2D(dftop0catMuonMomUp      [x],"ngood_jets","theGenCat",theCat,startF,x,BinXF,minXF,maxXF,BinYF,minYF,maxYF,158)
            histo2D[startF+159][x]    = makeFinalVariable2D(dftop0catMuonMomDown    [x],"ngood_jets","theGenCat",theCat,startF,x,BinXF,minXF,maxXF,BinYF,minYF,maxYF,159)
            histo2D[startF+160][x]    = makeFinalVariable2D(dftop0catElectronMomUp  [x],"ngood_jets","theGenCat",theCat,startF,x,BinXF,minXF,maxXF,BinYF,minYF,maxYF,160)
            histo2D[startF+161][x]    = makeFinalVariable2D(dftop0catElectronMomDown[x],"ngood_jets","theGenCat",theCat,startF,x,BinXF,minXF,maxXF,BinYF,minYF,maxYF,161)
            ...
            histo2D[startF+168][x]    = makeFinalVariable2D(dftop0cat[x],"ngood_jetsJes1Up"	    ,"theGenCat",theCat,startF,x,BinXF,minXF,maxXF,BinYF,minYF,maxYF,168)
            histo2D[startF+169][x]    = makeFinalVariable2D(dftop0cat[x],"ngood_jetsJes1Down"	    ,"theGenCat",theCat,startF,x,BinXF,minXF,maxXF,BinYF,minYF,maxYF,169)
            histo2D[startF+170][x]    = makeFinalVariable2D(dftop0cat[x],"ngood_jetsJes2Up"	    ,"theGenCat",theCat,startF,x,BinXF,minXF,maxXF,BinYF,minYF,maxYF,170)
            histo2D[startF+171][x]    = makeFinalVariable2D(dftop0cat[x],"ngood_jetsJes2Down"	    ,"theGenCat",theCat,startF,x,BinXF,minXF,maxXF,BinYF,minYF,maxYF,171)
            histo2D[startF+172][x]    = makeFinalVariable2D(dftop0cat[x],"ngood_jetsJes3Up"	    ,"theGenCat",theCat,startF,x,BinXF,minXF,maxXF,BinYF,minYF,maxYF,172)
            histo2D[startF+173][x]    = makeFinalVariable2D(dftop0cat[x],"ngood_jetsJes3Down"	    ,"theGenCat",theCat,startF,x,BinXF,minXF,maxXF,BinYF,minYF,maxYF,173)
            histo2D[startF+174][x]    = makeFinalVariable2D(dftop0cat[x],"ngood_jetsJes4Up"	    ,"theGenCat",theCat,startF,x,BinXF,minXF,maxXF,BinYF,minYF,maxYF,174)
            histo2D[startF+175][x]    = makeFinalVariable2D(dftop0cat[x],"ngood_jetsJes4Down"	    ,"theGenCat",theCat,startF,x,BinXF,minXF,maxXF,BinYF,minYF,maxYF,175)
            histo2D[startF+176][x]    = makeFinalVariable2D(dftop0cat[x],"ngood_jetsJes5Up"	    ,"theGenCat",theCat,startF,x,BinXF,minXF,maxXF,BinYF,minYF,maxYF,176)
            histo2D[startF+177][x]    = makeFinalVariable2D(dftop0cat[x],"ngood_jetsJes5Down"	    ,"theGenCat",theCat,startF,x,BinXF,minXF,maxXF,BinYF,minYF,maxYF,177)
            histo2D[startF+178][x]    = makeFinalVariable2D(dftop0cat[x],"ngood_jetsJes6Up"	    ,"theGenCat",theCat,startF,x,BinXF,minXF,maxXF,BinYF,minYF,maxYF,178)
            histo2D[startF+179][x]    = makeFinalVariable2D(dftop0cat[x],"ngood_jetsJes6Down"	    ,"theGenCat",theCat,startF,x,BinXF,minXF,maxXF,BinYF,minYF,maxYF,179)
            if(x == plotCategory("kPlotNonPrompt")):
                startNonPrompt = 18
            ...
            histo2D[startF+154][x]    = makeFinalVariable2D(dftop1cat[x],"ngood_jetsJes0Up"	    ,"theGenCat",theCat,startF,x,BinXF,minXF,maxXF,BinYF,minYF,maxYF,154)
            histo2D[startF+155][x]    = makeFinalVariable2D(dftop1cat[x],"ngood_jetsJes0Down"	    ,"theGenCat",theCat,startF,x,BinXF,minXF,maxXF,BinYF,minYF,maxYF,155)
            histo2D[startF+156][x]    = makeFinalVariable2D(dftop1cat[x],"ngood_jetsJerUp"	    ,"theGenCat",theCat,startF,x,BinXF,minXF,maxXF,BinYF,minYF,maxYF,156)
            histo2D[startF+157][x]    = makeFinalVariable2D(dftop1cat[x],"ngood_jetsJerDown"	    ,"theGenCat",theCat,startF,x,BinXF,minXF,maxXF,BinYF,minYF,maxYF,157)
            histo2D[startF+158][x]    = makeFinalVariable2D(dftop1catMuonMomUp      [x],"ngood_jets","theGenCat",theCat,startF,x,BinXF,minXF,maxXF,BinYF,minYF,maxYF,158)
            histo2D[startF+159][x]    = makeFinalVariable2D(dftop1catMuonMomDown    [x],"ngood_jets","theGenCat",theCat,startF,x,BinXF,minXF,maxXF,BinYF,minYF,maxYF,159)
            histo2D[startF+160][x]    = makeFinalVariable2D(dftop1catElectronMomUp  [x],"ngood_jets","theGenCat",theCat,startF,x,BinXF,minXF,maxXF,BinYF,minYF,maxYF,160)
            histo2D[startF+161][x]    = makeFinalVariable2D(dftop1catElectronMomDown[x],"ngood_jets","theGenCat",theCat,startF,x,BinXF,minXF,maxXF,BinYF,minYF,maxYF,161)
            ...
            histo2D[startF+168][x]    = makeFinalVariable2D(dftop1cat[x],"ngood_jetsJes1Up"	    ,"theGenCat",theCat,startF,x,BinXF,minXF,maxXF,BinYF,minYF,maxYF,168)
            histo2D[startF+169][x]    = makeFinalVariable2D(dftop1cat[x],"ngood_jetsJes1Down"	    ,"theGenCat",theCat,startF,x,BinXF,minXF,maxXF,BinYF,minYF,maxYF,169)
            histo2D[startF+170][x]    = makeFinalVariable2D(dftop1cat[x],"ngood_jetsJes2Up"	    ,"theGenCat",theCat,startF,x,BinXF,minXF,maxXF,BinYF,minYF,maxYF,170)
            histo2D[startF+171][x]    = makeFinalVariable2D(dftop1cat[x],"ngood_jetsJes2Down"	    ,"theGenCat",theCat,startF,x,BinXF,minXF,maxXF,BinYF,minYF,maxYF,171)
            histo2D[startF+172][x]    = makeFinalVariable2D(dftop1cat[x],"ngood_jetsJes3Up"	    ,"theGenCat",theCat,startF,x,BinXF,minXF,maxXF,BinYF,minYF,maxYF,172)
            histo2D[startF+173][x]    = makeFinalVariable2D(dftop1cat[x],"ngood_jetsJes3Down"	    ,"theGenCat",theCat,startF,x,BinXF,minXF,maxXF,BinYF,minYF,maxYF,173)
            histo2D[startF+174][x]    = makeFinalVariable2D(dftop1cat[x],"ngood_jetsJes4Up"	    ,"theGenCat",theCat,startF,x,BinXF,minXF,maxXF,BinYF,minYF,maxYF,174)
            histo2D[startF+175][x]    = makeFinalVariable2D(dftop1cat[x],"ngood_jetsJes4Down"	    ,"theGenCat",theCat,startF,x,BinXF,minXF,maxXF,BinYF,minYF,maxYF,175)
            histo2D[startF+176][x]    = makeFinalVariable2D(dftop1cat[x],"ngood_jetsJes5Up"	    ,"theGenCat",theCat,startF,x,BinXF,minXF,maxXF,BinYF,minYF,maxYF,176)
            histo2D[startF+177][x]    = makeFinalVariable2D(dftop1cat[x],"ngood_jetsJes5Down"	    ,"theGenCat",theCat,startF,x,BinXF,minXF,maxXF,BinYF,minYF,maxYF,177)
            histo2D[startF+178][x]    = makeFinalVariable2D(dftop1cat[x],"ngood_jetsJes6Up"	    ,"theGenCat",theCat,startF,x,BinXF,minXF,maxXF,BinYF,minYF,maxYF,178)
            histo2D[startF+179][x]    = makeFinalVariable2D(dftop1cat[x],"ngood_jetsJes6Down"	    ,"theGenCat",theCat,startF,x,BinXF,minXF,maxXF,BinYF,minYF,maxYF,179)
            if(x == plotCategory("kPlotNonPrompt")):
                startNonPrompt = 24
            ...
            if(makeDataCards >= 2):
                ...
                histo2D[startF+154][x]    = makeFinalVariable2D(dfwwx0cat[x].Filter("ngood_jetsJes0Up==0")     ,"mll{0}".format(altMass),"theGenCat",theCat,startF,x,BinXF1,minXF1,maxXF1,BinYF,minYF,maxYF,154)
                histo2D[startF+155][x]    = makeFinalVariable2D(dfwwx0cat[x].Filter("ngood_jetsJes0Down==0")   ,"mll{0}".format(altMass),"theGenCat",theCat,startF,x,BinXF1,minXF1,maxXF1,BinYF,minYF,maxYF,155)
                histo2D[startF+156][x]    = makeFinalVariable2D(dfwwx0cat[x].Filter("ngood_jetsJerUp==0")      ,"mll{0}".format(altMass),"theGenCat",theCat,startF,x,BinXF1,minXF1,maxXF1,BinYF,minYF,maxYF,156)
                histo2D[startF+157][x]    = makeFinalVariable2D(dfwwx0cat[x].Filter("ngood_jetsJerDown==0")    ,"mll{0}".format(altMass),"theGenCat",theCat,startF,x,BinXF1,minXF1,maxXF1,BinYF,minYF,maxYF,157)
                histo2D[startF+158][x]    = makeFinalVariable2D(dfwwx0catMuonMomUp	[x].Filter("ngood_jets==0"),"mllMuonMomUp"	,"theGenCat",theCat,startF,x,BinXF1,minXF1,maxXF1,BinYF,minYF,maxYF,158)
                histo2D[startF+159][x]    = makeFinalVariable2D(dfwwx0catMuonMomDown	[x].Filter("ngood_jets==0"),"mllMuonMomDown"	,"theGenCat",theCat,startF,x,BinXF1,minXF1,maxXF1,BinYF,minYF,maxYF,159)
                histo2D[startF+160][x]    = makeFinalVariable2D(dfwwx0catElectronMomUp  [x].Filter("ngood_jets==0"),"mllElectronMomUp"  ,"theGenCat",theCat,startF,x,BinXF1,minXF1,maxXF1,BinYF,minYF,maxYF,160)
                histo2D[startF+161][x]    = makeFinalVariable2D(dfwwx0catElectronMomDown[x].Filter("ngood_jets==0"),"mllElectronMomDown","theGenCat",theCat,startF,x,BinXF1,minXF1,maxXF1,BinYF,minYF,maxYF,161)
                ...
                histo2D[startF+166][x]    = makeFinalVariable2D(dfwwx0cat[x].Filter("ngood_jets==0")	       ,"mll{0}".format(altMass),"theGenCat",theCat,startF,x,BinXF1,minXF1,maxXF1,BinYF,minYF,maxYF,166)
                histo2D[startF+167][x]    = makeFinalVariable2D(dfwwx0cat[x].Filter("ngood_jets==0")	       ,"mll{0}".format(altMass),"theGenCat",theCat,startF,x,BinXF1,minXF1,maxXF1,BinYF,minYF,maxYF,167)
                histo2D[startF+168][x]    = makeFinalVariable2D(dfwwx0cat[x].Filter("ngood_jetsJes1Up==0")     ,"mll{0}".format(altMass),"theGenCat",theCat,startF,x,BinXF1,minXF1,maxXF1,BinYF,minYF,maxYF,168)
                histo2D[startF+169][x]    = makeFinalVariable2D(dfwwx0cat[x].Filter("ngood_jetsJes1Down==0")   ,"mll{0}".format(altMass),"theGenCat",theCat,startF,x,BinXF1,minXF1,maxXF1,BinYF,minYF,maxYF,169)
                histo2D[startF+170][x]    = makeFinalVariable2D(dfwwx0cat[x].Filter("ngood_jetsJes2Up==0")     ,"mll{0}".format(altMass),"theGenCat",theCat,startF,x,BinXF1,minXF1,maxXF1,BinYF,minYF,maxYF,170)
                histo2D[startF+171][x]    = makeFinalVariable2D(dfwwx0cat[x].Filter("ngood_jetsJes2Down==0")   ,"mll{0}".format(altMass),"theGenCat",theCat,startF,x,BinXF1,minXF1,maxXF1,BinYF,minYF,maxYF,171)
                histo2D[startF+172][x]    = makeFinalVariable2D(dfwwx0cat[x].Filter("ngood_jetsJes3Up==0")     ,"mll{0}".format(altMass),"theGenCat",theCat,startF,x,BinXF1,minXF1,maxXF1,BinYF,minYF,maxYF,172)
                histo2D[startF+173][x]    = makeFinalVariable2D(dfwwx0cat[x].Filter("ngood_jetsJes3Down==0")   ,"mll{0}".format(altMass),"theGenCat",theCat,startF,x,BinXF1,minXF1,maxXF1,BinYF,minYF,maxYF,173)
                histo2D[startF+174][x]    = makeFinalVariable2D(dfwwx0cat[x].Filter("ngood_jetsJes4Up==0")     ,"mll{0}".format(altMass),"theGenCat",theCat,startF,x,BinXF1,minXF1,maxXF1,BinYF,minYF,maxYF,174)
                histo2D[startF+175][x]    = makeFinalVariable2D(dfwwx0cat[x].Filter("ngood_jetsJes4Down==0")   ,"mll{0}".format(altMass),"theGenCat",theCat,startF,x,BinXF1,minXF1,maxXF1,BinYF,minYF,maxYF,175)
                histo2D[startF+176][x]    = makeFinalVariable2D(dfwwx0cat[x].Filter("ngood_jetsJes5Up==0")     ,"mll{0}".format(altMass),"theGenCat",theCat,startF,x,BinXF1,minXF1,maxXF1,BinYF,minYF,maxYF,176)
                histo2D[startF+177][x]    = makeFinalVariable2D(dfwwx0cat[x].Filter("ngood_jetsJes5Down==0")   ,"mll{0}".format(altMass),"theGenCat",theCat,startF,x,BinXF1,minXF1,maxXF1,BinYF,minYF,maxYF,177)
                histo2D[startF+178][x]    = makeFinalVariable2D(dfwwx0cat[x].Filter("ngood_jetsJes6Up==0")     ,"mll{0}".format(altMass),"theGenCat",theCat,startF,x,BinXF1,minXF1,maxXF1,BinYF,minYF,maxYF,178)
                histo2D[startF+179][x]    = makeFinalVariable2D(dfwwx0cat[x].Filter("ngood_jetsJes6Down==0")   ,"mll{0}".format(altMass),"theGenCat",theCat,startF,x,BinXF1,minXF1,maxXF1,BinYF,minYF,maxYF,179)
                if(x == plotCategory("kPlotNonPrompt")):
                    startNonPrompt = 30
                ...
                histo2D[startF+154][x]    = makeFinalVariable2D(dfwwx0cat[x].Filter("ngood_jetsJes0Up==1")     ,"mll{0}".format(altMass),"theGenCat",theCat,startF,x,BinXF1,minXF1,maxXF1,BinYF,minYF,maxYF,154)
                histo2D[startF+155][x]    = makeFinalVariable2D(dfwwx0cat[x].Filter("ngood_jetsJes0Down==1")   ,"mll{0}".format(altMass),"theGenCat",theCat,startF,x,BinXF1,minXF1,maxXF1,BinYF,minYF,maxYF,155)
                histo2D[startF+156][x]    = makeFinalVariable2D(dfwwx0cat[x].Filter("ngood_jetsJerUp==1")      ,"mll{0}".format(altMass),"theGenCat",theCat,startF,x,BinXF1,minXF1,maxXF1,BinYF,minYF,maxYF,156)
                histo2D[startF+157][x]    = makeFinalVariable2D(dfwwx0cat[x].Filter("ngood_jetsJerDown==1")    ,"mll{0}".format(altMass),"theGenCat",theCat,startF,x,BinXF1,minXF1,maxXF1,BinYF,minYF,maxYF,157)
                histo2D[startF+158][x]    = makeFinalVariable2D(dfwwx0catMuonMomUp	[x].Filter("ngood_jets==1"),"mllMuonMomUp"	,"theGenCat",theCat,startF,x,BinXF1,minXF1,maxXF1,BinYF,minYF,maxYF,158)
                histo2D[startF+159][x]    = makeFinalVariable2D(dfwwx0catMuonMomDown	[x].Filter("ngood_jets==1"),"mllMuonMomDown"	,"theGenCat",theCat,startF,x,BinXF1,minXF1,maxXF1,BinYF,minYF,maxYF,159)
                histo2D[startF+160][x]    = makeFinalVariable2D(dfwwx0catElectronMomUp  [x].Filter("ngood_jets==1"),"mllElectronMomUp"  ,"theGenCat",theCat,startF,x,BinXF1,minXF1,maxXF1,BinYF,minYF,maxYF,160)
                histo2D[startF+161][x]    = makeFinalVariable2D(dfwwx0catElectronMomDown[x].Filter("ngood_jets==1"),"mllElectronMomDown","theGenCat",theCat,startF,x,BinXF1,minXF1,maxXF1,BinYF,minYF,maxYF,161)
                ...
                histo2D[startF+166][x]    = makeFinalVariable2D(dfwwx0cat[x].Filter("ngood_jets==1")	       ,"mll{0}".format(altMass),"theGenCat",theCat,startF,x,BinXF1,minXF1,maxXF1,BinYF,minYF,maxYF,166)
                histo2D[startF+167][x]    = makeFinalVariable2D(dfwwx0cat[x].Filter("ngood_jets==1")	       ,"mll{0}".format(altMass),"theGenCat",theCat,startF,x,BinXF1,minXF1,maxXF1,BinYF,minYF,maxYF,167)
                histo2D[startF+168][x]    = makeFinalVariable2D(dfwwx0cat[x].Filter("ngood_jetsJes1Up==1")     ,"mll{0}".format(altMass),"theGenCat",theCat,startF,x,BinXF1,minXF1,maxXF1,BinYF,minYF,maxYF,168)
                histo2D[startF+169][x]    = makeFinalVariable2D(dfwwx0cat[x].Filter("ngood_jetsJes1Down==1")   ,"mll{0}".format(altMass),"theGenCat",theCat,startF,x,BinXF1,minXF1,maxXF1,BinYF,minYF,maxYF,169)
                histo2D[startF+170][x]    = makeFinalVariable2D(dfwwx0cat[x].Filter("ngood_jetsJes2Up==1")     ,"mll{0}".format(altMass),"theGenCat",theCat,startF,x,BinXF1,minXF1,maxXF1,BinYF,minYF,maxYF,170)
                histo2D[startF+171][x]    = makeFinalVariable2D(dfwwx0cat[x].Filter("ngood_jetsJes2Down==1")   ,"mll{0}".format(altMass),"theGenCat",theCat,startF,x,BinXF1,minXF1,maxXF1,BinYF,minYF,maxYF,171)
                histo2D[startF+172][x]    = makeFinalVariable2D(dfwwx0cat[x].Filter("ngood_jetsJes3Up==1")     ,"mll{0}".format(altMass),"theGenCat",theCat,startF,x,BinXF1,minXF1,maxXF1,BinYF,minYF,maxYF,172)
                histo2D[startF+173][x]    = makeFinalVariable2D(dfwwx0cat[x].Filter("ngood_jetsJes3Down==1")   ,"mll{0}".format(altMass),"theGenCat",theCat,startF,x,BinXF1,minXF1,maxXF1,BinYF,minYF,maxYF,173)
                histo2D[startF+174][x]    = makeFinalVariable2D(dfwwx0cat[x].Filter("ngood_jetsJes4Up==1")     ,"mll{0}".format(altMass),"theGenCat",theCat,startF,x,BinXF1,minXF1,maxXF1,BinYF,minYF,maxYF,174)
                histo2D[startF+175][x]    = makeFinalVariable2D(dfwwx0cat[x].Filter("ngood_jetsJes4Down==1")   ,"mll{0}".format(altMass),"theGenCat",theCat,startF,x,BinXF1,minXF1,maxXF1,BinYF,minYF,maxYF,175)
                histo2D[startF+176][x]    = makeFinalVariable2D(dfwwx0cat[x].Filter("ngood_jetsJes5Up==1")     ,"mll{0}".format(altMass),"theGenCat",theCat,startF,x,BinXF1,minXF1,maxXF1,BinYF,minYF,maxYF,176)
                histo2D[startF+177][x]    = makeFinalVariable2D(dfwwx0cat[x].Filter("ngood_jetsJes5Down==1")   ,"mll{0}".format(altMass),"theGenCat",theCat,startF,x,BinXF1,minXF1,maxXF1,BinYF,minYF,maxYF,177)
                histo2D[startF+178][x]    = makeFinalVariable2D(dfwwx0cat[x].Filter("ngood_jetsJes6Up==1")     ,"mll{0}".format(altMass),"theGenCat",theCat,startF,x,BinXF1,minXF1,maxXF1,BinYF,minYF,maxYF,178)
                histo2D[startF+179][x]    = makeFinalVariable2D(dfwwx0cat[x].Filter("ngood_jetsJes6Down==1")   ,"mll{0}".format(altMass),"theGenCat",theCat,startF,x,BinXF1,minXF1,maxXF1,BinYF,minYF,maxYF,179)
                if(x == plotCategory("kPlotNonPrompt")):
                    startNonPrompt = 36
                ...
                histo2D[startF+154][x]    = makeFinalVariable2D(dfwwx0cat[x].Filter("ngood_jetsJes0Up>=2")     ,"mll{0}".format(altMass),"theGenCat",theCat,startF,x,BinXF1,minXF1,maxXF1,BinYF,minYF,maxYF,154)
                histo2D[startF+155][x]    = makeFinalVariable2D(dfwwx0cat[x].Filter("ngood_jetsJes0Down>=2")   ,"mll{0}".format(altMass),"theGenCat",theCat,startF,x,BinXF1,minXF1,maxXF1,BinYF,minYF,maxYF,155)
                histo2D[startF+156][x]    = makeFinalVariable2D(dfwwx0cat[x].Filter("ngood_jetsJerUp>=2")      ,"mll{0}".format(altMass),"theGenCat",theCat,startF,x,BinXF1,minXF1,maxXF1,BinYF,minYF,maxYF,156)
                histo2D[startF+157][x]    = makeFinalVariable2D(dfwwx0cat[x].Filter("ngood_jetsJerDown>=2")    ,"mll{0}".format(altMass),"theGenCat",theCat,startF,x,BinXF1,minXF1,maxXF1,BinYF,minYF,maxYF,157)
                histo2D[startF+158][x]    = makeFinalVariable2D(dfwwx0catMuonMomUp	[x].Filter("ngood_jets>=2"),"mllMuonMomUp"	,"theGenCat",theCat,startF,x,BinXF1,minXF1,maxXF1,BinYF,minYF,maxYF,158)
                histo2D[startF+159][x]    = makeFinalVariable2D(dfwwx0catMuonMomDown	[x].Filter("ngood_jets>=2"),"mllMuonMomDown"	,"theGenCat",theCat,startF,x,BinXF1,minXF1,maxXF1,BinYF,minYF,maxYF,159)
                histo2D[startF+160][x]    = makeFinalVariable2D(dfwwx0catElectronMomUp  [x].Filter("ngood_jets>=2"),"mllElectronMomUp"  ,"theGenCat",theCat,startF,x,BinXF1,minXF1,maxXF1,BinYF,minYF,maxYF,160)
                histo2D[startF+161][x]    = makeFinalVariable2D(dfwwx0catElectronMomDown[x].Filter("ngood_jets>=2"),"mllElectronMomDown","theGenCat",theCat,startF,x,BinXF1,minXF1,maxXF1,BinYF,minYF,maxYF,161)
                ...
                histo2D[startF+166][x]    = makeFinalVariable2D(dfwwx0cat[x].Filter("ngood_jets>=2")	       ,"mll{0}".format(altMass),"theGenCat",theCat,startF,x,BinXF1,minXF1,maxXF1,BinYF,minYF,maxYF,166)
                histo2D[startF+167][x]    = makeFinalVariable2D(dfwwx0cat[x].Filter("ngood_jets>=2")	       ,"mll{0}".format(altMass),"theGenCat",theCat,startF,x,BinXF1,minXF1,maxXF1,BinYF,minYF,maxYF,167)
                histo2D[startF+168][x]    = makeFinalVariable2D(dfwwx0cat[x].Filter("ngood_jetsJes1Up>=2")     ,"mll{0}".format(altMass),"theGenCat",theCat,startF,x,BinXF1,minXF1,maxXF1,BinYF,minYF,maxYF,168)
                histo2D[startF+169][x]    = makeFinalVariable2D(dfwwx0cat[x].Filter("ngood_jetsJes1Down>=2")   ,"mll{0}".format(altMass),"theGenCat",theCat,startF,x,BinXF1,minXF1,maxXF1,BinYF,minYF,maxYF,169)
                histo2D[startF+170][x]    = makeFinalVariable2D(dfwwx0cat[x].Filter("ngood_jetsJes2Up>=2")     ,"mll{0}".format(altMass),"theGenCat",theCat,startF,x,BinXF1,minXF1,maxXF1,BinYF,minYF,maxYF,170)
                histo2D[startF+171][x]    = makeFinalVariable2D(dfwwx0cat[x].Filter("ngood_jetsJes2Down>=2")   ,"mll{0}".format(altMass),"theGenCat",theCat,startF,x,BinXF1,minXF1,maxXF1,BinYF,minYF,maxYF,171)
                histo2D[startF+172][x]    = makeFinalVariable2D(dfwwx0cat[x].Filter("ngood_jetsJes3Up>=2")     ,"mll{0}".format(altMass),"theGenCat",theCat,startF,x,BinXF1,minXF1,maxXF1,BinYF,minYF,maxYF,172)
                histo2D[startF+173][x]    = makeFinalVariable2D(dfwwx0cat[x].Filter("ngood_jetsJes3Down>=2")   ,"mll{0}".format(altMass),"theGenCat",theCat,startF,x,BinXF1,minXF1,maxXF1,BinYF,minYF,maxYF,173)
                histo2D[startF+174][x]    = makeFinalVariable2D(dfwwx0cat[x].Filter("ngood_jetsJes4Up>=2")     ,"mll{0}".format(altMass),"theGenCat",theCat,startF,x,BinXF1,minXF1,maxXF1,BinYF,minYF,maxYF,174)
                histo2D[startF+175][x]    = makeFinalVariable2D(dfwwx0cat[x].Filter("ngood_jetsJes4Down>=2")   ,"mll{0}".format(altMass),"theGenCat",theCat,startF,x,BinXF1,minXF1,maxXF1,BinYF,minYF,maxYF,175)
                histo2D[startF+176][x]    = makeFinalVariable2D(dfwwx0cat[x].Filter("ngood_jetsJes5Up>=2")     ,"mll{0}".format(altMass),"theGenCat",theCat,startF,x,BinXF1,minXF1,maxXF1,BinYF,minYF,maxYF,176)
                histo2D[startF+177][x]    = makeFinalVariable2D(dfwwx0cat[x].Filter("ngood_jetsJes5Down>=2")   ,"mll{0}".format(altMass),"theGenCat",theCat,startF,x,BinXF1,minXF1,maxXF1,BinYF,minYF,maxYF,177)
                histo2D[startF+178][x]    = makeFinalVariable2D(dfwwx0cat[x].Filter("ngood_jetsJes6Up>=2")     ,"mll{0}".format(altMass),"theGenCat",theCat,startF,x,BinXF1,minXF1,maxXF1,BinYF,minYF,maxYF,178)
                histo2D[startF+179][x]    = makeFinalVariable2D(dfwwx0cat[x].Filter("ngood_jetsJes6Down>=2")   ,"mll{0}".format(altMass),"theGenCat",theCat,startF,x,BinXF1,minXF1,maxXF1,BinYF,minYF,maxYF,179)
                if(x == plotCategory("kPlotNonPrompt")):
                    startNonPrompt = 42
