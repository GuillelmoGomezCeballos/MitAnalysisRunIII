    ...
    for x in range(nCat):
        ...
        if(makeDataCards >= 1):
            ...
            if(makeDataCards >= 2):
                ...
                histo2D[startF+134][x]    = makeFinalVariable2D(dfwwx0cat[x].Filter("ngood_jetsJes0Up==0")  ,"mll{0}".format(altMass),"theGenCat",theCat,startF,x,BinXF1,minXF1,maxXF1,BinYF,minYF,maxYF,134)
                histo2D[startF+135][x]    = makeFinalVariable2D(dfwwx0cat[x].Filter("ngood_jetsJes0Down==0"),"mll{0}".format(altMass),"theGenCat",theCat,startF,x,BinXF1,minXF1,maxXF1,BinYF,minYF,maxYF,135)
                histo2D[startF+136][x]    = makeFinalVariable2D(dfwwx0cat[x].Filter("ngood_jetsJerUp==0")   ,"mll{0}".format(altMass),"theGenCat",theCat,startF,x,BinXF1,minXF1,maxXF1,BinYF,minYF,maxYF,136)
                histo2D[startF+137][x]    = makeFinalVariable2D(dfwwx0cat[x].Filter("ngood_jetsJerDown==0") ,"mll{0}".format(altMass),"theGenCat",theCat,startF,x,BinXF1,minXF1,maxXF1,BinYF,minYF,maxYF,137)
                ...
                histo2D[startF+142][x]    = makeFinalVariable2D(dfwwx0cat[x].Filter("ngood_jets==0")	    ,"mll{0}".format(altMass),"theGenCat",theCat,startF,x,BinXF1,minXF1,maxXF1,BinYF,minYF,maxYF,142)
                histo2D[startF+143][x]    = makeFinalVariable2D(dfwwx0cat[x].Filter("ngood_jets==0")	    ,"mll{0}".format(altMass),"theGenCat",theCat,startF,x,BinXF1,minXF1,maxXF1,BinYF,minYF,maxYF,143)
                histo2D[startF+144][x]    = makeFinalVariable2D(dfwwx0cat[x].Filter("ngood_jets==0")	    ,"mll{0}".format(altMass),"theGenCat",theCat,startF,x,BinXF1,minXF1,maxXF1,BinYF,minYF,maxYF,144)
                histo2D[startF+145][x]    = makeFinalVariable2D(dfwwx0cat[x].Filter("ngood_jets==0")	    ,"mll{0}".format(altMass),"theGenCat",theCat,startF,x,BinXF1,minXF1,maxXF1,BinYF,minYF,maxYF,145)
                histo2D[startF+146][x]    = makeFinalVariable2D(dfwwx0cat[x].Filter("ngood_jets==0")	    ,"mll{0}".format(altMass),"theGenCat",theCat,startF,x,BinXF1,minXF1,maxXF1,BinYF,minYF,maxYF,146)
                histo2D[startF+147][x]    = makeFinalVariable2D(dfwwx0cat[x].Filter("ngood_jets==0")	    ,"mll{0}".format(altMass),"theGenCat",theCat,startF,x,BinXF1,minXF1,maxXF1,BinYF,minYF,maxYF,147)
                histo2D[startF+148][x]    = makeFinalVariable2D(dfwwx0cat[x].Filter("ngood_jetsJes1Up==0")  ,"mll{0}".format(altMass),"theGenCat",theCat,startF,x,BinXF1,minXF1,maxXF1,BinYF,minYF,maxYF,148)
                histo2D[startF+149][x]    = makeFinalVariable2D(dfwwx0cat[x].Filter("ngood_jetsJes1Down==0"),"mll{0}".format(altMass),"theGenCat",theCat,startF,x,BinXF1,minXF1,maxXF1,BinYF,minYF,maxYF,149)
                histo2D[startF+150][x]    = makeFinalVariable2D(dfwwx0cat[x].Filter("ngood_jetsJes2Up==0")  ,"mll{0}".format(altMass),"theGenCat",theCat,startF,x,BinXF1,minXF1,maxXF1,BinYF,minYF,maxYF,150)
                histo2D[startF+151][x]    = makeFinalVariable2D(dfwwx0cat[x].Filter("ngood_jetsJes2Down==0"),"mll{0}".format(altMass),"theGenCat",theCat,startF,x,BinXF1,minXF1,maxXF1,BinYF,minYF,maxYF,151)
                histo2D[startF+152][x]    = makeFinalVariable2D(dfwwx0cat[x].Filter("ngood_jetsJes3Up==0")  ,"mll{0}".format(altMass),"theGenCat",theCat,startF,x,BinXF1,minXF1,maxXF1,BinYF,minYF,maxYF,152)
                histo2D[startF+153][x]    = makeFinalVariable2D(dfwwx0cat[x].Filter("ngood_jetsJes3Down==0"),"mll{0}".format(altMass),"theGenCat",theCat,startF,x,BinXF1,minXF1,maxXF1,BinYF,minYF,maxYF,153)
                histo2D[startF+154][x]    = makeFinalVariable2D(dfwwx0cat[x].Filter("ngood_jetsJes4Up==0")  ,"mll{0}".format(altMass),"theGenCat",theCat,startF,x,BinXF1,minXF1,maxXF1,BinYF,minYF,maxYF,154)
                histo2D[startF+155][x]    = makeFinalVariable2D(dfwwx0cat[x].Filter("ngood_jetsJes4Down==0"),"mll{0}".format(altMass),"theGenCat",theCat,startF,x,BinXF1,minXF1,maxXF1,BinYF,minYF,maxYF,155)
                histo2D[startF+156][x]    = makeFinalVariable2D(dfwwx0cat[x].Filter("ngood_jetsJes5Up==0")  ,"mll{0}".format(altMass),"theGenCat",theCat,startF,x,BinXF1,minXF1,maxXF1,BinYF,minYF,maxYF,156)
                histo2D[startF+157][x]    = makeFinalVariable2D(dfwwx0cat[x].Filter("ngood_jetsJes5Down==0"),"mll{0}".format(altMass),"theGenCat",theCat,startF,x,BinXF1,minXF1,maxXF1,BinYF,minYF,maxYF,157)
                ...
                histo2D[startF+134][x]    = makeFinalVariable2D(dfwwx0cat[x].Filter("ngood_jetsJes0Up==1")  ,"mll{0}".format(altMass),"theGenCat",theCat,startF,x,BinXF1,minXF1,maxXF1,BinYF,minYF,maxYF,134)
                histo2D[startF+135][x]    = makeFinalVariable2D(dfwwx0cat[x].Filter("ngood_jetsJes0Down==1"),"mll{0}".format(altMass),"theGenCat",theCat,startF,x,BinXF1,minXF1,maxXF1,BinYF,minYF,maxYF,135)
                histo2D[startF+136][x]    = makeFinalVariable2D(dfwwx0cat[x].Filter("ngood_jetsJerUp==1")   ,"mll{0}".format(altMass),"theGenCat",theCat,startF,x,BinXF1,minXF1,maxXF1,BinYF,minYF,maxYF,136)
                histo2D[startF+137][x]    = makeFinalVariable2D(dfwwx0cat[x].Filter("ngood_jetsJerDown==1") ,"mll{0}".format(altMass),"theGenCat",theCat,startF,x,BinXF1,minXF1,maxXF1,BinYF,minYF,maxYF,137)
                ...
                histo2D[startF+142][x]    = makeFinalVariable2D(dfwwx0cat[x].Filter("ngood_jets==1")	    ,"mll{0}".format(altMass),"theGenCat",theCat,startF,x,BinXF1,minXF1,maxXF1,BinYF,minYF,maxYF,142)
                histo2D[startF+143][x]    = makeFinalVariable2D(dfwwx0cat[x].Filter("ngood_jets==1")	    ,"mll{0}".format(altMass),"theGenCat",theCat,startF,x,BinXF1,minXF1,maxXF1,BinYF,minYF,maxYF,143)
                histo2D[startF+144][x]    = makeFinalVariable2D(dfwwx0cat[x].Filter("ngood_jets==1")	    ,"mll{0}".format(altMass),"theGenCat",theCat,startF,x,BinXF1,minXF1,maxXF1,BinYF,minYF,maxYF,144)
                histo2D[startF+145][x]    = makeFinalVariable2D(dfwwx0cat[x].Filter("ngood_jets==1")	    ,"mll{0}".format(altMass),"theGenCat",theCat,startF,x,BinXF1,minXF1,maxXF1,BinYF,minYF,maxYF,145)
                histo2D[startF+146][x]    = makeFinalVariable2D(dfwwx0cat[x].Filter("ngood_jets==1")	    ,"mll{0}".format(altMass),"theGenCat",theCat,startF,x,BinXF1,minXF1,maxXF1,BinYF,minYF,maxYF,146)
                histo2D[startF+147][x]    = makeFinalVariable2D(dfwwx0cat[x].Filter("ngood_jets==1")	    ,"mll{0}".format(altMass),"theGenCat",theCat,startF,x,BinXF1,minXF1,maxXF1,BinYF,minYF,maxYF,147)
                histo2D[startF+148][x]    = makeFinalVariable2D(dfwwx0cat[x].Filter("ngood_jetsJes1Up==1")  ,"mll{0}".format(altMass),"theGenCat",theCat,startF,x,BinXF1,minXF1,maxXF1,BinYF,minYF,maxYF,148)
                histo2D[startF+149][x]    = makeFinalVariable2D(dfwwx0cat[x].Filter("ngood_jetsJes1Down==1"),"mll{0}".format(altMass),"theGenCat",theCat,startF,x,BinXF1,minXF1,maxXF1,BinYF,minYF,maxYF,149)
                histo2D[startF+150][x]    = makeFinalVariable2D(dfwwx0cat[x].Filter("ngood_jetsJes2Up==1")  ,"mll{0}".format(altMass),"theGenCat",theCat,startF,x,BinXF1,minXF1,maxXF1,BinYF,minYF,maxYF,150)
                histo2D[startF+151][x]    = makeFinalVariable2D(dfwwx0cat[x].Filter("ngood_jetsJes2Down==1"),"mll{0}".format(altMass),"theGenCat",theCat,startF,x,BinXF1,minXF1,maxXF1,BinYF,minYF,maxYF,151)
                histo2D[startF+152][x]    = makeFinalVariable2D(dfwwx0cat[x].Filter("ngood_jetsJes3Up==1")  ,"mll{0}".format(altMass),"theGenCat",theCat,startF,x,BinXF1,minXF1,maxXF1,BinYF,minYF,maxYF,152)
                histo2D[startF+153][x]    = makeFinalVariable2D(dfwwx0cat[x].Filter("ngood_jetsJes3Down==1"),"mll{0}".format(altMass),"theGenCat",theCat,startF,x,BinXF1,minXF1,maxXF1,BinYF,minYF,maxYF,153)
                histo2D[startF+154][x]    = makeFinalVariable2D(dfwwx0cat[x].Filter("ngood_jetsJes4Up==1")  ,"mll{0}".format(altMass),"theGenCat",theCat,startF,x,BinXF1,minXF1,maxXF1,BinYF,minYF,maxYF,154)
                histo2D[startF+155][x]    = makeFinalVariable2D(dfwwx0cat[x].Filter("ngood_jetsJes4Down==1"),"mll{0}".format(altMass),"theGenCat",theCat,startF,x,BinXF1,minXF1,maxXF1,BinYF,minYF,maxYF,155)
                histo2D[startF+156][x]    = makeFinalVariable2D(dfwwx0cat[x].Filter("ngood_jetsJes5Up==1")  ,"mll{0}".format(altMass),"theGenCat",theCat,startF,x,BinXF1,minXF1,maxXF1,BinYF,minYF,maxYF,156)
                histo2D[startF+157][x]    = makeFinalVariable2D(dfwwx0cat[x].Filter("ngood_jetsJes5Down==1"),"mll{0}".format(altMass),"theGenCat",theCat,startF,x,BinXF1,minXF1,maxXF1,BinYF,minYF,maxYF,157)
                ...
                histo2D[startF+134][x]    = makeFinalVariable2D(dfwwx0cat[x].Filter("ngood_jetsJes0Up>=2")  ,"mll{0}".format(altMass),"theGenCat",theCat,startF,x,BinXF1,minXF1,maxXF1,BinYF,minYF,maxYF,134)
                histo2D[startF+135][x]    = makeFinalVariable2D(dfwwx0cat[x].Filter("ngood_jetsJes0Down>=2"),"mll{0}".format(altMass),"theGenCat",theCat,startF,x,BinXF1,minXF1,maxXF1,BinYF,minYF,maxYF,135)
                histo2D[startF+136][x]    = makeFinalVariable2D(dfwwx0cat[x].Filter("ngood_jetsJerUp>=2")   ,"mll{0}".format(altMass),"theGenCat",theCat,startF,x,BinXF1,minXF1,maxXF1,BinYF,minYF,maxYF,136)
                histo2D[startF+137][x]    = makeFinalVariable2D(dfwwx0cat[x].Filter("ngood_jetsJerDown>=2") ,"mll{0}".format(altMass),"theGenCat",theCat,startF,x,BinXF1,minXF1,maxXF1,BinYF,minYF,maxYF,137)
                ...
                histo2D[startF+142][x]    = makeFinalVariable2D(dfwwx0cat[x].Filter("ngood_jets>=2")	    ,"mll{0}".format(altMass),"theGenCat",theCat,startF,x,BinXF1,minXF1,maxXF1,BinYF,minYF,maxYF,142)
                histo2D[startF+143][x]    = makeFinalVariable2D(dfwwx0cat[x].Filter("ngood_jets>=2")	    ,"mll{0}".format(altMass),"theGenCat",theCat,startF,x,BinXF1,minXF1,maxXF1,BinYF,minYF,maxYF,143)
                histo2D[startF+144][x]    = makeFinalVariable2D(dfwwx0cat[x].Filter("ngood_jets>=2")	    ,"mll{0}".format(altMass),"theGenCat",theCat,startF,x,BinXF1,minXF1,maxXF1,BinYF,minYF,maxYF,144)
                histo2D[startF+145][x]    = makeFinalVariable2D(dfwwx0cat[x].Filter("ngood_jets>=2")	    ,"mll{0}".format(altMass),"theGenCat",theCat,startF,x,BinXF1,minXF1,maxXF1,BinYF,minYF,maxYF,145)
                histo2D[startF+146][x]    = makeFinalVariable2D(dfwwx0cat[x].Filter("ngood_jets>=2")	    ,"mll{0}".format(altMass),"theGenCat",theCat,startF,x,BinXF1,minXF1,maxXF1,BinYF,minYF,maxYF,146)
                histo2D[startF+147][x]    = makeFinalVariable2D(dfwwx0cat[x].Filter("ngood_jets>=2")	    ,"mll{0}".format(altMass),"theGenCat",theCat,startF,x,BinXF1,minXF1,maxXF1,BinYF,minYF,maxYF,147)
                histo2D[startF+148][x]    = makeFinalVariable2D(dfwwx0cat[x].Filter("ngood_jetsJes1Up>=2")  ,"mll{0}".format(altMass),"theGenCat",theCat,startF,x,BinXF1,minXF1,maxXF1,BinYF,minYF,maxYF,148)
                histo2D[startF+149][x]    = makeFinalVariable2D(dfwwx0cat[x].Filter("ngood_jetsJes1Down>=2"),"mll{0}".format(altMass),"theGenCat",theCat,startF,x,BinXF1,minXF1,maxXF1,BinYF,minYF,maxYF,149)
                histo2D[startF+150][x]    = makeFinalVariable2D(dfwwx0cat[x].Filter("ngood_jetsJes2Up>=2")  ,"mll{0}".format(altMass),"theGenCat",theCat,startF,x,BinXF1,minXF1,maxXF1,BinYF,minYF,maxYF,150)
                histo2D[startF+151][x]    = makeFinalVariable2D(dfwwx0cat[x].Filter("ngood_jetsJes2Down>=2"),"mll{0}".format(altMass),"theGenCat",theCat,startF,x,BinXF1,minXF1,maxXF1,BinYF,minYF,maxYF,151)
                histo2D[startF+152][x]    = makeFinalVariable2D(dfwwx0cat[x].Filter("ngood_jetsJes3Up>=2")  ,"mll{0}".format(altMass),"theGenCat",theCat,startF,x,BinXF1,minXF1,maxXF1,BinYF,minYF,maxYF,152)
                histo2D[startF+153][x]    = makeFinalVariable2D(dfwwx0cat[x].Filter("ngood_jetsJes3Down>=2"),"mll{0}".format(altMass),"theGenCat",theCat,startF,x,BinXF1,minXF1,maxXF1,BinYF,minYF,maxYF,153)
                histo2D[startF+154][x]    = makeFinalVariable2D(dfwwx0cat[x].Filter("ngood_jetsJes4Up>=2")  ,"mll{0}".format(altMass),"theGenCat",theCat,startF,x,BinXF1,minXF1,maxXF1,BinYF,minYF,maxYF,154)
                histo2D[startF+155][x]    = makeFinalVariable2D(dfwwx0cat[x].Filter("ngood_jetsJes4Down>=2"),"mll{0}".format(altMass),"theGenCat",theCat,startF,x,BinXF1,minXF1,maxXF1,BinYF,minYF,maxYF,155)
                histo2D[startF+156][x]    = makeFinalVariable2D(dfwwx0cat[x].Filter("ngood_jetsJes5Up>=2")  ,"mll{0}".format(altMass),"theGenCat",theCat,startF,x,BinXF1,minXF1,maxXF1,BinYF,minYF,maxYF,156)
                histo2D[startF+157][x]    = makeFinalVariable2D(dfwwx0cat[x].Filter("ngood_jetsJes5Down>=2"),"mll{0}".format(altMass),"theGenCat",theCat,startF,x,BinXF1,minXF1,maxXF1,BinYF,minYF,maxYF,157)
