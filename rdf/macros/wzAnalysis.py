...
def analysis(df,count,category,weight,year,PDType,isData,whichJob,nTheoryReplicas,genEventSumLHEScaleRenorm,genEventSumPSRenorm,puWeights,histoBTVEffEtaPtLF,histoBTVEffEtaPtCJ,histoBTVEffEtaPtBJ,histoFakeEtaPt_mu,histoFakeEtaPt_el,histoLepSFEtaPt_mu,histoLepSFEtaPt_el,histoTriggerSFEtaPt_0_0,histoTriggerSFEtaPt_0_1,histoTriggerSFEtaPt_0_2,histoTriggerSFEtaPt_0_3,histoTriggerSFEtaPt_1_0,histoTriggerSFEtaPt_1_1,histoTriggerSFEtaPt_1_2,histoTriggerSFEtaPt_1_3,histoTriggerSFEtaPt_2_0,histoTriggerSFEtaPt_2_1,histoTriggerSFEtaPt_2_2,histoTriggerSFEtaPt_2_3,histoTriggerSFEtaPt_3_0,histoTriggerSFEtaPt_3_1,histoTriggerSFEtaPt_3_2,histoTriggerSFEtaPt_3_3):
	...
	#	                      .Define("bdt_vbfincJes0Up", ROOT.computeModel, ROOT.model.GetVariableNames()))
        ...
        if(makeDataCards == 1):
            ...
            histo[startF+154][x]    = makeFinalVariable(dfwzcat[x]	 ,"ngood_jetsJes0Up"  ,theCat,startF,x,BinXF,minXF,maxXF,154)
            histo[startF+155][x]    = makeFinalVariable(dfwzcat[x]	 ,"ngood_jetsJes0Down",theCat,startF,x,BinXF,minXF,maxXF,155)
            histo[startF+156][x]    = makeFinalVariable(dfwzcat[x]	  ,"ngood_jetsJerUp"  ,theCat,startF,x,BinXF,minXF,maxXF,156)
            histo[startF+157][x]    = makeFinalVariable(dfwzcat[x]	  ,"ngood_jetsJerDown",theCat,startF,x,BinXF,minXF,maxXF,157)
            histo[startF+158][x]    = makeFinalVariable(dfwzcatMuonMomUp      [x],"ngood_jets",theCat,startF,x,BinXF,minXF,maxXF,158)
            histo[startF+159][x]    = makeFinalVariable(dfwzcatMuonMomDown    [x],"ngood_jets",theCat,startF,x,BinXF,minXF,maxXF,159)
            histo[startF+160][x]    = makeFinalVariable(dfwzcatElectronMomUp  [x],"ngood_jets",theCat,startF,x,BinXF,minXF,maxXF,160)
            histo[startF+161][x]    = makeFinalVariable(dfwzcatElectronMomDown[x],"ngood_jets",theCat,startF,x,BinXF,minXF,maxXF,161)
            histo[startF+162][x]    = makeFinalVariable(dfwzcatJERUp	      [x],"ngood_jets",theCat,startF,x,BinXF,minXF,maxXF,162)
            histo[startF+163][x]    = makeFinalVariable(dfwzcatJERDown        [x],"ngood_jets",theCat,startF,x,BinXF,minXF,maxXF,163)
            histo[startF+164][x]    = makeFinalVariable(dfwzcatJESUp	      [x],"ngood_jets",theCat,startF,x,BinXF,minXF,maxXF,164)
            histo[startF+165][x]    = makeFinalVariable(dfwzcatJESDown        [x],"ngood_jets",theCat,startF,x,BinXF,minXF,maxXF,165)
            histo[startF+166][x]    = makeFinalVariable(dfwzcatUnclusteredUp  [x],"ngood_jets",theCat,startF,x,BinXF,minXF,maxXF,166)
            histo[startF+167][x]    = makeFinalVariable(dfwzcatUnclusteredDown[x],"ngood_jets",theCat,startF,x,BinXF,minXF,maxXF,167)
            histo[startF+168][x]    = makeFinalVariable(dfwzcat[x]	 ,"ngood_jetsJes1Up"  ,theCat,startF,x,BinXF,minXF,maxXF,168)
            histo[startF+169][x]    = makeFinalVariable(dfwzcat[x]	 ,"ngood_jetsJes1Down",theCat,startF,x,BinXF,minXF,maxXF,169)
            histo[startF+170][x]    = makeFinalVariable(dfwzcat[x]	 ,"ngood_jetsJes2Up"  ,theCat,startF,x,BinXF,minXF,maxXF,170)
            histo[startF+171][x]    = makeFinalVariable(dfwzcat[x]	 ,"ngood_jetsJes2Down",theCat,startF,x,BinXF,minXF,maxXF,171)
            histo[startF+172][x]    = makeFinalVariable(dfwzcat[x]	 ,"ngood_jetsJes3Up"  ,theCat,startF,x,BinXF,minXF,maxXF,172)
            histo[startF+173][x]    = makeFinalVariable(dfwzcat[x]	 ,"ngood_jetsJes3Down",theCat,startF,x,BinXF,minXF,maxXF,173)
            histo[startF+174][x]    = makeFinalVariable(dfwzcat[x]	 ,"ngood_jetsJes4Up"  ,theCat,startF,x,BinXF,minXF,maxXF,174)
            histo[startF+175][x]    = makeFinalVariable(dfwzcat[x]	 ,"ngood_jetsJes4Down",theCat,startF,x,BinXF,minXF,maxXF,175)
            histo[startF+176][x]    = makeFinalVariable(dfwzcat[x]	 ,"ngood_jetsJes5Up"  ,theCat,startF,x,BinXF,minXF,maxXF,176)
            histo[startF+177][x]    = makeFinalVariable(dfwzcat[x]	 ,"ngood_jetsJes5Down",theCat,startF,x,BinXF,minXF,maxXF,177)
            histo[startF+178][x]    = makeFinalVariable(dfwzcat[x]	 ,"ngood_jetsJes6Up"  ,theCat,startF,x,BinXF,minXF,maxXF,178)
            histo[startF+179][x]    = makeFinalVariable(dfwzcat[x]	 ,"ngood_jetsJes6Down",theCat,startF,x,BinXF,minXF,maxXF,179)
            ...
            histo[startF+154][x]    = makeFinalVariable(dfwzbcat[x]	  ,"ngood_jetsJes0Up"  ,theCat,startF,x,BinXF,minXF,maxXF,154)
            histo[startF+155][x]    = makeFinalVariable(dfwzbcat[x]	  ,"ngood_jetsJes0Down",theCat,startF,x,BinXF,minXF,maxXF,155)
            histo[startF+156][x]    = makeFinalVariable(dfwzbcat[x]	   ,"ngood_jetsJerUp"  ,theCat,startF,x,BinXF,minXF,maxXF,156)
            histo[startF+157][x]    = makeFinalVariable(dfwzbcat[x]	   ,"ngood_jetsJerDown",theCat,startF,x,BinXF,minXF,maxXF,157)
            histo[startF+158][x]    = makeFinalVariable(dfwzbcatMuonMomUp      [x],"ngood_jets",theCat,startF,x,BinXF,minXF,maxXF,158)
            histo[startF+159][x]    = makeFinalVariable(dfwzbcatMuonMomDown    [x],"ngood_jets",theCat,startF,x,BinXF,minXF,maxXF,159)
            histo[startF+160][x]    = makeFinalVariable(dfwzbcatElectronMomUp  [x],"ngood_jets",theCat,startF,x,BinXF,minXF,maxXF,160)
            histo[startF+161][x]    = makeFinalVariable(dfwzbcatElectronMomDown[x],"ngood_jets",theCat,startF,x,BinXF,minXF,maxXF,161)
            histo[startF+162][x]    = makeFinalVariable(dfwzbcatJERUp	       [x],"ngood_jets",theCat,startF,x,BinXF,minXF,maxXF,162)
            histo[startF+163][x]    = makeFinalVariable(dfwzbcatJERDown        [x],"ngood_jets",theCat,startF,x,BinXF,minXF,maxXF,163)
            histo[startF+164][x]    = makeFinalVariable(dfwzbcatJESUp	       [x],"ngood_jets",theCat,startF,x,BinXF,minXF,maxXF,164)
            histo[startF+165][x]    = makeFinalVariable(dfwzbcatJESDown        [x],"ngood_jets",theCat,startF,x,BinXF,minXF,maxXF,165)
            histo[startF+166][x]    = makeFinalVariable(dfwzbcatUnclusteredUp  [x],"ngood_jets",theCat,startF,x,BinXF,minXF,maxXF,166)
            histo[startF+167][x]    = makeFinalVariable(dfwzbcatUnclusteredDown[x],"ngood_jets",theCat,startF,x,BinXF,minXF,maxXF,167)
            histo[startF+168][x]    = makeFinalVariable(dfwzbcat[x]	  ,"ngood_jetsJes1Up"  ,theCat,startF,x,BinXF,minXF,maxXF,168)
            histo[startF+169][x]    = makeFinalVariable(dfwzbcat[x]	  ,"ngood_jetsJes1Down",theCat,startF,x,BinXF,minXF,maxXF,169)
            histo[startF+170][x]    = makeFinalVariable(dfwzbcat[x]	  ,"ngood_jetsJes2Up"  ,theCat,startF,x,BinXF,minXF,maxXF,170)
            histo[startF+171][x]    = makeFinalVariable(dfwzbcat[x]	  ,"ngood_jetsJes2Down",theCat,startF,x,BinXF,minXF,maxXF,171)
            histo[startF+172][x]    = makeFinalVariable(dfwzbcat[x]	  ,"ngood_jetsJes3Up"  ,theCat,startF,x,BinXF,minXF,maxXF,172)
            histo[startF+173][x]    = makeFinalVariable(dfwzbcat[x]	  ,"ngood_jetsJes3Down",theCat,startF,x,BinXF,minXF,maxXF,173)
            histo[startF+174][x]    = makeFinalVariable(dfwzbcat[x]	  ,"ngood_jetsJes4Up"  ,theCat,startF,x,BinXF,minXF,maxXF,174)
            histo[startF+175][x]    = makeFinalVariable(dfwzbcat[x]	  ,"ngood_jetsJes4Down",theCat,startF,x,BinXF,minXF,maxXF,175)
            histo[startF+176][x]    = makeFinalVariable(dfwzbcat[x]	  ,"ngood_jetsJes5Up"  ,theCat,startF,x,BinXF,minXF,maxXF,176)
            histo[startF+177][x]    = makeFinalVariable(dfwzbcat[x]	  ,"ngood_jetsJes5Down",theCat,startF,x,BinXF,minXF,maxXF,177)
            histo[startF+178][x]    = makeFinalVariable(dfwzbcat[x]	  ,"ngood_jetsJes6Up"  ,theCat,startF,x,BinXF,minXF,maxXF,178)
            histo[startF+179][x]    = makeFinalVariable(dfwzbcat[x]	  ,"ngood_jetsJes6Down",theCat,startF,x,BinXF,minXF,maxXF,179)
            if(x == plotCategory("kPlotNonPrompt")):
                startNonPrompt = 6
            ...
            histo[startF+158][x]    = makeFinalVariable(dfwzcatMuonMomUp      [x],"TriLepton_flavor",theCat,startF,x,BinXF,minXF,maxXF,158)
            histo[startF+159][x]    = makeFinalVariable(dfwzcatMuonMomDown    [x],"TriLepton_flavor",theCat,startF,x,BinXF,minXF,maxXF,159)
            histo[startF+160][x]    = makeFinalVariable(dfwzcatElectronMomUp  [x],"TriLepton_flavor",theCat,startF,x,BinXF,minXF,maxXF,160)
            histo[startF+161][x]    = makeFinalVariable(dfwzcatElectronMomDown[x],"TriLepton_flavor",theCat,startF,x,BinXF,minXF,maxXF,161)
            histo[startF+162][x]    = makeFinalVariable(dfwzcatJERUp	      [x],"TriLepton_flavor",theCat,startF,x,BinXF,minXF,maxXF,162)
            histo[startF+163][x]    = makeFinalVariable(dfwzcatJERDown        [x],"TriLepton_flavor",theCat,startF,x,BinXF,minXF,maxXF,163)
            histo[startF+164][x]    = makeFinalVariable(dfwzcatJESUp	      [x],"TriLepton_flavor",theCat,startF,x,BinXF,minXF,maxXF,164)
            histo[startF+165][x]    = makeFinalVariable(dfwzcatJESDown        [x],"TriLepton_flavor",theCat,startF,x,BinXF,minXF,maxXF,165)
            histo[startF+166][x]    = makeFinalVariable(dfwzcatUnclusteredUp  [x],"TriLepton_flavor",theCat,startF,x,BinXF,minXF,maxXF,166)
            histo[startF+167][x]    = makeFinalVariable(dfwzcatUnclusteredDown[x],"TriLepton_flavor",theCat,startF,x,BinXF,minXF,maxXF,167)
            ...
            histo[startF+178][x]    = makeFinalVariable(dfwzcat[x]		 ,"TriLepton_flavor",theCat,startF,x,BinXF,minXF,maxXF,178)
            histo[startF+179][x]    = makeFinalVariable(dfwzcat[x]		 ,"TriLepton_flavor",theCat,startF,x,BinXF,minXF,maxXF,179)
            if(x == plotCategory("kPlotNonPrompt")):
                startNonPrompt = 0
            ...
            histo[startF+158][x]    = makeFinalVariable(dfwzbcatMuonMomUp      [x],"TriLepton_flavor",theCat,startF,x,BinXF,minXF,maxXF,158)
            histo[startF+159][x]    = makeFinalVariable(dfwzbcatMuonMomDown    [x],"TriLepton_flavor",theCat,startF,x,BinXF,minXF,maxXF,159)
            histo[startF+160][x]    = makeFinalVariable(dfwzbcatElectronMomUp  [x],"TriLepton_flavor",theCat,startF,x,BinXF,minXF,maxXF,160)
            histo[startF+161][x]    = makeFinalVariable(dfwzbcatElectronMomDown[x],"TriLepton_flavor",theCat,startF,x,BinXF,minXF,maxXF,161)
            histo[startF+162][x]    = makeFinalVariable(dfwzbcatJERUp	       [x],"TriLepton_flavor",theCat,startF,x,BinXF,minXF,maxXF,162)
            histo[startF+163][x]    = makeFinalVariable(dfwzbcatJERDown        [x],"TriLepton_flavor",theCat,startF,x,BinXF,minXF,maxXF,163)
            histo[startF+164][x]    = makeFinalVariable(dfwzbcatJESUp	       [x],"TriLepton_flavor",theCat,startF,x,BinXF,minXF,maxXF,164)
            histo[startF+165][x]    = makeFinalVariable(dfwzbcatJESDown        [x],"TriLepton_flavor",theCat,startF,x,BinXF,minXF,maxXF,165)
            histo[startF+166][x]    = makeFinalVariable(dfwzbcatUnclusteredUp  [x],"TriLepton_flavor",theCat,startF,x,BinXF,minXF,maxXF,166)
            histo[startF+167][x]    = makeFinalVariable(dfwzbcatUnclusteredDown[x],"TriLepton_flavor",theCat,startF,x,BinXF,minXF,maxXF,167)
            ...
            histo[startF+178][x]    = makeFinalVariable(dfwzbcat[x]		  ,"TriLepton_flavor",theCat,startF,x,BinXF,minXF,maxXF,178)
            histo[startF+179][x]    = makeFinalVariable(dfwzbcat[x]		  ,"TriLepton_flavor",theCat,startF,x,BinXF,minXF,maxXF,179)
            if(x == plotCategory("kPlotNonPrompt")):
                startNonPrompt = 6
