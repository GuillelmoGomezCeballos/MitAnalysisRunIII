    ...
    for x in range(nCat):
        ...
        if(makeDataCards == 1):
            ...
            if(makeDataCards == 3):
                ...
                dfwzvbscatMuonMomUp    [x] = dfwzvbscatMuonMomUp    [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjj,vbs_detajj,vbs_zepvv,bdt_vbfinc[0],mllMuonMomUp,ngood_jets,{0})".format(varSel))
                dfwzvbscatElectronMomUp[x] = dfwzvbscatElectronMomUp[x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjj,vbs_detajj,vbs_zepvv,bdt_vbfinc[0],mllElectronMomUp,ngood_jets,{0})".format(varSel))
                dfwzvbscatJes00Up      [x] = dfwzvbscatJes00Up      [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjjJes00Up,vbs_detajj,vbs_zepvv,bdt_vbfinc[0],mll,ngood_jetsJes00Up,{0})".format(varSel))
                dfwzvbscatJes01Up      [x] = dfwzvbscatJes01Up      [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjjJes01Up,vbs_detajj,vbs_zepvv,bdt_vbfinc[0],mll,ngood_jetsJes01Up,{0})".format(varSel))
                dfwzvbscatJes02Up      [x] = dfwzvbscatJes02Up      [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjjJes02Up,vbs_detajj,vbs_zepvv,bdt_vbfinc[0],mll,ngood_jetsJes02Up,{0})".format(varSel))
                dfwzvbscatJes03Up      [x] = dfwzvbscatJes03Up      [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjjJes03Up,vbs_detajj,vbs_zepvv,bdt_vbfinc[0],mll,ngood_jetsJes03Up,{0})".format(varSel))
                dfwzvbscatJes04Up      [x] = dfwzvbscatJes04Up      [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjjJes04Up,vbs_detajj,vbs_zepvv,bdt_vbfinc[0],mll,ngood_jetsJes04Up,{0})".format(varSel))
                dfwzvbscatJes05Up      [x] = dfwzvbscatJes05Up      [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjjJes05Up,vbs_detajj,vbs_zepvv,bdt_vbfinc[0],mll,ngood_jetsJes05Up,{0})".format(varSel))
                dfwzvbscatJes06Up      [x] = dfwzvbscatJes06Up      [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjjJes06Up,vbs_detajj,vbs_zepvv,bdt_vbfinc[0],mll,ngood_jetsJes06Up,{0})".format(varSel))
                dfwzvbscatJes07Up      [x] = dfwzvbscatJes07Up      [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjjJes07Up,vbs_detajj,vbs_zepvv,bdt_vbfinc[0],mll,ngood_jetsJes07Up,{0})".format(varSel))
                dfwzvbscatJes08Up      [x] = dfwzvbscatJes08Up      [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjjJes08Up,vbs_detajj,vbs_zepvv,bdt_vbfinc[0],mll,ngood_jetsJes08Up,{0})".format(varSel))
                dfwzvbscatJes09Up      [x] = dfwzvbscatJes09Up      [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjjJes09Up,vbs_detajj,vbs_zepvv,bdt_vbfinc[0],mll,ngood_jetsJes09Up,{0})".format(varSel))
                dfwzvbscatJes10Up      [x] = dfwzvbscatJes10Up      [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjjJes10Up,vbs_detajj,vbs_zepvv,bdt_vbfinc[0],mll,ngood_jetsJes10Up,{0})".format(varSel))
                dfwzvbscatJes11Up      [x] = dfwzvbscatJes11Up      [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjjJes11Up,vbs_detajj,vbs_zepvv,bdt_vbfinc[0],mll,ngood_jetsJes11Up,{0})".format(varSel))
                dfwzvbscatJes12Up      [x] = dfwzvbscatJes12Up      [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjjJes12Up,vbs_detajj,vbs_zepvv,bdt_vbfinc[0],mll,ngood_jetsJes12Up,{0})".format(varSel))
                dfwzvbscatJes13Up      [x] = dfwzvbscatJes13Up      [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjjJes13Up,vbs_detajj,vbs_zepvv,bdt_vbfinc[0],mll,ngood_jetsJes13Up,{0})".format(varSel))
                dfwzvbscatJes14Up      [x] = dfwzvbscatJes14Up      [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjjJes14Up,vbs_detajj,vbs_zepvv,bdt_vbfinc[0],mll,ngood_jetsJes14Up,{0})".format(varSel))
                dfwzvbscatJes15Up      [x] = dfwzvbscatJes15Up      [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjjJes15Up,vbs_detajj,vbs_zepvv,bdt_vbfinc[0],mll,ngood_jetsJes15Up,{0})".format(varSel))
                dfwzvbscatJes16Up      [x] = dfwzvbscatJes16Up      [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjjJes16Up,vbs_detajj,vbs_zepvv,bdt_vbfinc[0],mll,ngood_jetsJes16Up,{0})".format(varSel))
                dfwzvbscatJes17Up      [x] = dfwzvbscatJes17Up      [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjjJes17Up,vbs_detajj,vbs_zepvv,bdt_vbfinc[0],mll,ngood_jetsJes17Up,{0})".format(varSel))
                dfwzvbscatJes18Up      [x] = dfwzvbscatJes18Up      [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjjJes18Up,vbs_detajj,vbs_zepvv,bdt_vbfinc[0],mll,ngood_jetsJes18Up,{0})".format(varSel))
                dfwzvbscatJes19Up      [x] = dfwzvbscatJes19Up      [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjjJes19Up,vbs_detajj,vbs_zepvv,bdt_vbfinc[0],mll,ngood_jetsJes19Up,{0})".format(varSel))
                dfwzvbscatJes20Up      [x] = dfwzvbscatJes20Up      [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjjJes20Up,vbs_detajj,vbs_zepvv,bdt_vbfinc[0],mll,ngood_jetsJes20Up,{0})".format(varSel))
                dfwzvbscatJes21Up      [x] = dfwzvbscatJes21Up      [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjjJes21Up,vbs_detajj,vbs_zepvv,bdt_vbfinc[0],mll,ngood_jetsJes21Up,{0})".format(varSel))
                dfwzvbscatJes22Up      [x] = dfwzvbscatJes22Up      [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjjJes22Up,vbs_detajj,vbs_zepvv,bdt_vbfinc[0],mll,ngood_jetsJes22Up,{0})".format(varSel))
                dfwzvbscatJes23Up      [x] = dfwzvbscatJes23Up      [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjjJes23Up,vbs_detajj,vbs_zepvv,bdt_vbfinc[0],mll,ngood_jetsJes23Up,{0})".format(varSel))
                dfwzvbscatJes24Up      [x] = dfwzvbscatJes24Up      [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjjJes24Up,vbs_detajj,vbs_zepvv,bdt_vbfinc[0],mll,ngood_jetsJes24Up,{0})".format(varSel))
                dfwzvbscatJes25Up      [x] = dfwzvbscatJes25Up      [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjjJes25Up,vbs_detajj,vbs_zepvv,bdt_vbfinc[0],mll,ngood_jetsJes25Up,{0})".format(varSel))
                dfwzvbscatJes26Up      [x] = dfwzvbscatJes26Up      [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjjJes26Up,vbs_detajj,vbs_zepvv,bdt_vbfinc[0],mll,ngood_jetsJes26Up,{0})".format(varSel))
                dfwzvbscatJes27Up      [x] = dfwzvbscatJes27Up      [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjjJes27Up,vbs_detajj,vbs_zepvv,bdt_vbfinc[0],mll,ngood_jetsJes27Up,{0})".format(varSel))
                dfwzvbscatJerUp        [x] = dfwzvbscatJerUp        [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjjJerUp,vbs_detajj,vbs_zepvv,bdt_vbfinc[0],mll,ngood_jetsJerUp,{0})".format(varSel))
                dfwzvbscatJERUp        [x] = dfwzvbscatJERUp        [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjj,vbs_detajj,vbs_zepvv,bdt_vbfinc[0],mll,ngood_jets,{0})".format(varSel))
                dfwzvbscatJESUp        [x] = dfwzvbscatJESUp        [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjj,vbs_detajj,vbs_zepvv,bdt_vbfinc[0],mll,ngood_jets,{0})".format(varSel))
                dfwzvbscatUnclusteredUp[x] = dfwzvbscatUnclusteredUp[x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjj,vbs_detajj,vbs_zepvv,bdt_vbfinc[0],mll,ngood_jets,{0})".format(varSel))

                dfwzbvbscat             [x] = dfwzbvbscat             [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjj,vbs_detajj,vbs_zepvv,bdt_vbfinc[0],mll,ngood_jets,{0})".format(varSel))
                dfwzbvbscatMuonMomUp    [x] = dfwzbvbscatMuonMomUp    [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjj,vbs_detajj,vbs_zepvv,bdt_vbfinc[0],mllMuonMomUp,ngood_jets,{0})".format(varSel))
                dfwzbvbscatElectronMomUp[x] = dfwzbvbscatElectronMomUp[x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjj,vbs_detajj,vbs_zepvv,bdt_vbfinc[0],mllElectronMomUp,ngood_jets,{0})".format(varSel))
                dfwzbvbscatJes00Up      [x] = dfwzbvbscatJes00Up      [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjjJes00Up,vbs_detajj,vbs_zepvv,bdt_vbfinc[0],mll,ngood_jetsJes00Up,{0})".format(varSel))
                dfwzbvbscatJes01Up      [x] = dfwzbvbscatJes01Up      [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjjJes01Up,vbs_detajj,vbs_zepvv,bdt_vbfinc[0],mll,ngood_jetsJes01Up,{0})".format(varSel))
                dfwzbvbscatJes02Up      [x] = dfwzbvbscatJes02Up      [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjjJes02Up,vbs_detajj,vbs_zepvv,bdt_vbfinc[0],mll,ngood_jetsJes02Up,{0})".format(varSel))
                dfwzbvbscatJes03Up      [x] = dfwzbvbscatJes03Up      [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjjJes03Up,vbs_detajj,vbs_zepvv,bdt_vbfinc[0],mll,ngood_jetsJes03Up,{0})".format(varSel))
                dfwzbvbscatJes04Up      [x] = dfwzbvbscatJes04Up      [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjjJes04Up,vbs_detajj,vbs_zepvv,bdt_vbfinc[0],mll,ngood_jetsJes04Up,{0})".format(varSel))
                dfwzbvbscatJes05Up      [x] = dfwzbvbscatJes05Up      [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjjJes05Up,vbs_detajj,vbs_zepvv,bdt_vbfinc[0],mll,ngood_jetsJes05Up,{0})".format(varSel))
                dfwzbvbscatJes06Up      [x] = dfwzbvbscatJes06Up      [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjjJes06Up,vbs_detajj,vbs_zepvv,bdt_vbfinc[0],mll,ngood_jetsJes06Up,{0})".format(varSel))
                dfwzbvbscatJes07Up      [x] = dfwzbvbscatJes07Up      [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjjJes07Up,vbs_detajj,vbs_zepvv,bdt_vbfinc[0],mll,ngood_jetsJes07Up,{0})".format(varSel))
                dfwzbvbscatJes08Up      [x] = dfwzbvbscatJes08Up      [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjjJes08Up,vbs_detajj,vbs_zepvv,bdt_vbfinc[0],mll,ngood_jetsJes08Up,{0})".format(varSel))
                dfwzbvbscatJes09Up      [x] = dfwzbvbscatJes09Up      [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjjJes09Up,vbs_detajj,vbs_zepvv,bdt_vbfinc[0],mll,ngood_jetsJes09Up,{0})".format(varSel))
                dfwzbvbscatJes10Up      [x] = dfwzbvbscatJes10Up      [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjjJes10Up,vbs_detajj,vbs_zepvv,bdt_vbfinc[0],mll,ngood_jetsJes10Up,{0})".format(varSel))
                dfwzbvbscatJes11Up      [x] = dfwzbvbscatJes11Up      [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjjJes11Up,vbs_detajj,vbs_zepvv,bdt_vbfinc[0],mll,ngood_jetsJes11Up,{0})".format(varSel))
                dfwzbvbscatJes12Up      [x] = dfwzbvbscatJes12Up      [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjjJes12Up,vbs_detajj,vbs_zepvv,bdt_vbfinc[0],mll,ngood_jetsJes12Up,{0})".format(varSel))
                dfwzbvbscatJes13Up      [x] = dfwzbvbscatJes13Up      [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjjJes13Up,vbs_detajj,vbs_zepvv,bdt_vbfinc[0],mll,ngood_jetsJes13Up,{0})".format(varSel))
                dfwzbvbscatJes14Up      [x] = dfwzbvbscatJes14Up      [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjjJes14Up,vbs_detajj,vbs_zepvv,bdt_vbfinc[0],mll,ngood_jetsJes14Up,{0})".format(varSel))
                dfwzbvbscatJes15Up      [x] = dfwzbvbscatJes15Up      [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjjJes15Up,vbs_detajj,vbs_zepvv,bdt_vbfinc[0],mll,ngood_jetsJes15Up,{0})".format(varSel))
                dfwzbvbscatJes16Up      [x] = dfwzbvbscatJes16Up      [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjjJes16Up,vbs_detajj,vbs_zepvv,bdt_vbfinc[0],mll,ngood_jetsJes16Up,{0})".format(varSel))
                dfwzbvbscatJes17Up      [x] = dfwzbvbscatJes17Up      [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjjJes17Up,vbs_detajj,vbs_zepvv,bdt_vbfinc[0],mll,ngood_jetsJes17Up,{0})".format(varSel))
                dfwzbvbscatJes18Up      [x] = dfwzbvbscatJes18Up      [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjjJes18Up,vbs_detajj,vbs_zepvv,bdt_vbfinc[0],mll,ngood_jetsJes18Up,{0})".format(varSel))
                dfwzbvbscatJes19Up      [x] = dfwzbvbscatJes19Up      [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjjJes19Up,vbs_detajj,vbs_zepvv,bdt_vbfinc[0],mll,ngood_jetsJes19Up,{0})".format(varSel))
                dfwzbvbscatJes20Up      [x] = dfwzbvbscatJes20Up      [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjjJes20Up,vbs_detajj,vbs_zepvv,bdt_vbfinc[0],mll,ngood_jetsJes20Up,{0})".format(varSel))
                dfwzbvbscatJes21Up      [x] = dfwzbvbscatJes21Up      [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjjJes21Up,vbs_detajj,vbs_zepvv,bdt_vbfinc[0],mll,ngood_jetsJes21Up,{0})".format(varSel))
                dfwzbvbscatJes22Up      [x] = dfwzbvbscatJes22Up      [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjjJes22Up,vbs_detajj,vbs_zepvv,bdt_vbfinc[0],mll,ngood_jetsJes22Up,{0})".format(varSel))
                dfwzbvbscatJes23Up      [x] = dfwzbvbscatJes23Up      [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjjJes23Up,vbs_detajj,vbs_zepvv,bdt_vbfinc[0],mll,ngood_jetsJes23Up,{0})".format(varSel))
                dfwzbvbscatJes24Up      [x] = dfwzbvbscatJes24Up      [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjjJes24Up,vbs_detajj,vbs_zepvv,bdt_vbfinc[0],mll,ngood_jetsJes24Up,{0})".format(varSel))
                dfwzbvbscatJes25Up      [x] = dfwzbvbscatJes25Up      [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjjJes25Up,vbs_detajj,vbs_zepvv,bdt_vbfinc[0],mll,ngood_jetsJes25Up,{0})".format(varSel))
                dfwzbvbscatJes26Up      [x] = dfwzbvbscatJes26Up      [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjjJes26Up,vbs_detajj,vbs_zepvv,bdt_vbfinc[0],mll,ngood_jetsJes26Up,{0})".format(varSel))
                dfwzbvbscatJes27Up      [x] = dfwzbvbscatJes27Up      [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjjJes27Up,vbs_detajj,vbs_zepvv,bdt_vbfinc[0],mll,ngood_jetsJes27Up,{0})".format(varSel))
                dfwzbvbscatJerUp        [x] = dfwzbvbscatJerUp        [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjjJerUp,vbs_detajj,vbs_zepvv,bdt_vbfinc[0],mll,ngood_jetsJerUp,{0})".format(varSel))
                dfwzbvbscatJERUp        [x] = dfwzbvbscatJERUp        [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjj,vbs_detajj,vbs_zepvv,bdt_vbfinc[0],mll,ngood_jets,{0})".format(varSel))
                dfwzbvbscatJESUp        [x] = dfwzbvbscatJESUp        [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjj,vbs_detajj,vbs_zepvv,bdt_vbfinc[0],mll,ngood_jets,{0})".format(varSel))
                dfwzbvbscatUnclusteredUp[x] = dfwzbvbscatUnclusteredUp[x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjj,vbs_detajj,vbs_zepvv,bdt_vbfinc[0],mll,ngood_jets,{0})".format(varSel))
