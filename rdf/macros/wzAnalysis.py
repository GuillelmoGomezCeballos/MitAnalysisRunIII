...
def analysis(df,count,category,weight,year,PDType,isData,whichJob,nTheoryReplicas,genEventSumLHEScaleRenorm,genEventSumPSRenorm,puWeights,histoBTVEffEtaPtLF,histoBTVEffEtaPtCJ,histoBTVEffEtaPtBJ,histoFakeEtaPt_mu,histoFakeEtaPt_el,histoLepSFEtaPt_mu,histoLepSFEtaPt_el,histoTriggerSFEtaPt_0_0,histoTriggerSFEtaPt_0_1,histoTriggerSFEtaPt_0_2,histoTriggerSFEtaPt_0_3,histoTriggerSFEtaPt_1_0,histoTriggerSFEtaPt_1_1,histoTriggerSFEtaPt_1_2,histoTriggerSFEtaPt_1_3,histoTriggerSFEtaPt_2_0,histoTriggerSFEtaPt_2_1,histoTriggerSFEtaPt_2_2,histoTriggerSFEtaPt_2_3,histoTriggerSFEtaPt_3_0,histoTriggerSFEtaPt_3_1,histoTriggerSFEtaPt_3_2,histoTriggerSFEtaPt_3_3):
    ...
    for x in range(nCat):
        ...
        dfwzvbscatJes00Up       [x] = dfwzvbscatJes00Up       [x].Filter("mllZ{0}           < 15 && m3l{0}           > 100 && ptlW{0}           > 20 && nbtag_goodbtag_Jet_bjet == 0 && nvbs_jetsJes00Up >= 2 && vbs_mjjJes00Up > 500 && vbs_detajj > 2.5 && vbs_zepvv < 1.0 && thePuppiMET_pt              > {1}".format(altMass,metCut))
        dfwzvbscatJes01Up       [x] = dfwzvbscatJes01Up       [x].Filter("mllZ{0}           < 15 && m3l{0}           > 100 && ptlW{0}           > 20 && nbtag_goodbtag_Jet_bjet == 0 && nvbs_jetsJes01Up >= 2 && vbs_mjjJes01Up > 500 && vbs_detajj > 2.5 && vbs_zepvv < 1.0 && thePuppiMET_pt              > {1}".format(altMass,metCut))
        dfwzvbscatJes02Up       [x] = dfwzvbscatJes02Up       [x].Filter("mllZ{0}           < 15 && m3l{0}           > 100 && ptlW{0}           > 20 && nbtag_goodbtag_Jet_bjet == 0 && nvbs_jetsJes02Up >= 2 && vbs_mjjJes02Up > 500 && vbs_detajj > 2.5 && vbs_zepvv < 1.0 && thePuppiMET_pt              > {1}".format(altMass,metCut))
        dfwzvbscatJes03Up       [x] = dfwzvbscatJes03Up       [x].Filter("mllZ{0}           < 15 && m3l{0}           > 100 && ptlW{0}           > 20 && nbtag_goodbtag_Jet_bjet == 0 && nvbs_jetsJes03Up >= 2 && vbs_mjjJes03Up > 500 && vbs_detajj > 2.5 && vbs_zepvv < 1.0 && thePuppiMET_pt              > {1}".format(altMass,metCut))
        dfwzvbscatJes04Up       [x] = dfwzvbscatJes04Up       [x].Filter("mllZ{0}           < 15 && m3l{0}           > 100 && ptlW{0}           > 20 && nbtag_goodbtag_Jet_bjet == 0 && nvbs_jetsJes04Up >= 2 && vbs_mjjJes04Up > 500 && vbs_detajj > 2.5 && vbs_zepvv < 1.0 && thePuppiMET_pt              > {1}".format(altMass,metCut))
        dfwzvbscatJes05Up       [x] = dfwzvbscatJes05Up       [x].Filter("mllZ{0}           < 15 && m3l{0}           > 100 && ptlW{0}           > 20 && nbtag_goodbtag_Jet_bjet == 0 && nvbs_jetsJes05Up >= 2 && vbs_mjjJes05Up > 500 && vbs_detajj > 2.5 && vbs_zepvv < 1.0 && thePuppiMET_pt              > {1}".format(altMass,metCut))
        dfwzvbscatJes06Up       [x] = dfwzvbscatJes06Up       [x].Filter("mllZ{0}           < 15 && m3l{0}           > 100 && ptlW{0}           > 20 && nbtag_goodbtag_Jet_bjet == 0 && nvbs_jetsJes06Up >= 2 && vbs_mjjJes06Up > 500 && vbs_detajj > 2.5 && vbs_zepvv < 1.0 && thePuppiMET_pt              > {1}".format(altMass,metCut))
        dfwzvbscatJes07Up       [x] = dfwzvbscatJes07Up       [x].Filter("mllZ{0}           < 15 && m3l{0}           > 100 && ptlW{0}           > 20 && nbtag_goodbtag_Jet_bjet == 0 && nvbs_jetsJes07Up >= 2 && vbs_mjjJes07Up > 500 && vbs_detajj > 2.5 && vbs_zepvv < 1.0 && thePuppiMET_pt              > {1}".format(altMass,metCut))
        dfwzvbscatJes08Up       [x] = dfwzvbscatJes08Up       [x].Filter("mllZ{0}           < 15 && m3l{0}           > 100 && ptlW{0}           > 20 && nbtag_goodbtag_Jet_bjet == 0 && nvbs_jetsJes08Up >= 2 && vbs_mjjJes08Up > 500 && vbs_detajj > 2.5 && vbs_zepvv < 1.0 && thePuppiMET_pt              > {1}".format(altMass,metCut))
        dfwzvbscatJes09Up       [x] = dfwzvbscatJes09Up       [x].Filter("mllZ{0}           < 15 && m3l{0}           > 100 && ptlW{0}           > 20 && nbtag_goodbtag_Jet_bjet == 0 && nvbs_jetsJes09Up >= 2 && vbs_mjjJes09Up > 500 && vbs_detajj > 2.5 && vbs_zepvv < 1.0 && thePuppiMET_pt              > {1}".format(altMass,metCut))
        dfwzvbscatJes10Up       [x] = dfwzvbscatJes10Up       [x].Filter("mllZ{0}           < 15 && m3l{0}           > 100 && ptlW{0}           > 20 && nbtag_goodbtag_Jet_bjet == 0 && nvbs_jetsJes10Up >= 2 && vbs_mjjJes10Up > 500 && vbs_detajj > 2.5 && vbs_zepvv < 1.0 && thePuppiMET_pt              > {1}".format(altMass,metCut))
        dfwzvbscatJes11Up       [x] = dfwzvbscatJes11Up       [x].Filter("mllZ{0}           < 15 && m3l{0}           > 100 && ptlW{0}           > 20 && nbtag_goodbtag_Jet_bjet == 0 && nvbs_jetsJes11Up >= 2 && vbs_mjjJes11Up > 500 && vbs_detajj > 2.5 && vbs_zepvv < 1.0 && thePuppiMET_pt              > {1}".format(altMass,metCut))
        dfwzvbscatJes12Up       [x] = dfwzvbscatJes12Up       [x].Filter("mllZ{0}           < 15 && m3l{0}           > 100 && ptlW{0}           > 20 && nbtag_goodbtag_Jet_bjet == 0 && nvbs_jetsJes12Up >= 2 && vbs_mjjJes12Up > 500 && vbs_detajj > 2.5 && vbs_zepvv < 1.0 && thePuppiMET_pt              > {1}".format(altMass,metCut))
        dfwzvbscatJes13Up       [x] = dfwzvbscatJes13Up       [x].Filter("mllZ{0}           < 15 && m3l{0}           > 100 && ptlW{0}           > 20 && nbtag_goodbtag_Jet_bjet == 0 && nvbs_jetsJes13Up >= 2 && vbs_mjjJes13Up > 500 && vbs_detajj > 2.5 && vbs_zepvv < 1.0 && thePuppiMET_pt              > {1}".format(altMass,metCut))
        dfwzvbscatJes14Up       [x] = dfwzvbscatJes14Up       [x].Filter("mllZ{0}           < 15 && m3l{0}           > 100 && ptlW{0}           > 20 && nbtag_goodbtag_Jet_bjet == 0 && nvbs_jetsJes14Up >= 2 && vbs_mjjJes14Up > 500 && vbs_detajj > 2.5 && vbs_zepvv < 1.0 && thePuppiMET_pt              > {1}".format(altMass,metCut))
        dfwzvbscatJes15Up       [x] = dfwzvbscatJes15Up       [x].Filter("mllZ{0}           < 15 && m3l{0}           > 100 && ptlW{0}           > 20 && nbtag_goodbtag_Jet_bjet == 0 && nvbs_jetsJes15Up >= 2 && vbs_mjjJes15Up > 500 && vbs_detajj > 2.5 && vbs_zepvv < 1.0 && thePuppiMET_pt              > {1}".format(altMass,metCut))
        dfwzvbscatJes16Up       [x] = dfwzvbscatJes16Up       [x].Filter("mllZ{0}           < 15 && m3l{0}           > 100 && ptlW{0}           > 20 && nbtag_goodbtag_Jet_bjet == 0 && nvbs_jetsJes16Up >= 2 && vbs_mjjJes16Up > 500 && vbs_detajj > 2.5 && vbs_zepvv < 1.0 && thePuppiMET_pt              > {1}".format(altMass,metCut))
        dfwzvbscatJes17Up       [x] = dfwzvbscatJes17Up       [x].Filter("mllZ{0}           < 15 && m3l{0}           > 100 && ptlW{0}           > 20 && nbtag_goodbtag_Jet_bjet == 0 && nvbs_jetsJes17Up >= 2 && vbs_mjjJes17Up > 500 && vbs_detajj > 2.5 && vbs_zepvv < 1.0 && thePuppiMET_pt              > {1}".format(altMass,metCut))
        dfwzvbscatJes18Up       [x] = dfwzvbscatJes18Up       [x].Filter("mllZ{0}           < 15 && m3l{0}           > 100 && ptlW{0}           > 20 && nbtag_goodbtag_Jet_bjet == 0 && nvbs_jetsJes18Up >= 2 && vbs_mjjJes18Up > 500 && vbs_detajj > 2.5 && vbs_zepvv < 1.0 && thePuppiMET_pt              > {1}".format(altMass,metCut))
        dfwzvbscatJes19Up       [x] = dfwzvbscatJes19Up       [x].Filter("mllZ{0}           < 15 && m3l{0}           > 100 && ptlW{0}           > 20 && nbtag_goodbtag_Jet_bjet == 0 && nvbs_jetsJes19Up >= 2 && vbs_mjjJes19Up > 500 && vbs_detajj > 2.5 && vbs_zepvv < 1.0 && thePuppiMET_pt              > {1}".format(altMass,metCut))
        dfwzvbscatJes20Up       [x] = dfwzvbscatJes20Up       [x].Filter("mllZ{0}           < 15 && m3l{0}           > 100 && ptlW{0}           > 20 && nbtag_goodbtag_Jet_bjet == 0 && nvbs_jetsJes20Up >= 2 && vbs_mjjJes20Up > 500 && vbs_detajj > 2.5 && vbs_zepvv < 1.0 && thePuppiMET_pt              > {1}".format(altMass,metCut))
        dfwzvbscatJes21Up       [x] = dfwzvbscatJes21Up       [x].Filter("mllZ{0}           < 15 && m3l{0}           > 100 && ptlW{0}           > 20 && nbtag_goodbtag_Jet_bjet == 0 && nvbs_jetsJes21Up >= 2 && vbs_mjjJes21Up > 500 && vbs_detajj > 2.5 && vbs_zepvv < 1.0 && thePuppiMET_pt              > {1}".format(altMass,metCut))
        dfwzvbscatJes22Up       [x] = dfwzvbscatJes22Up       [x].Filter("mllZ{0}           < 15 && m3l{0}           > 100 && ptlW{0}           > 20 && nbtag_goodbtag_Jet_bjet == 0 && nvbs_jetsJes22Up >= 2 && vbs_mjjJes22Up > 500 && vbs_detajj > 2.5 && vbs_zepvv < 1.0 && thePuppiMET_pt              > {1}".format(altMass,metCut))
        dfwzvbscatJes23Up       [x] = dfwzvbscatJes23Up       [x].Filter("mllZ{0}           < 15 && m3l{0}           > 100 && ptlW{0}           > 20 && nbtag_goodbtag_Jet_bjet == 0 && nvbs_jetsJes23Up >= 2 && vbs_mjjJes23Up > 500 && vbs_detajj > 2.5 && vbs_zepvv < 1.0 && thePuppiMET_pt              > {1}".format(altMass,metCut))
        dfwzvbscatJes24Up       [x] = dfwzvbscatJes24Up       [x].Filter("mllZ{0}           < 15 && m3l{0}           > 100 && ptlW{0}           > 20 && nbtag_goodbtag_Jet_bjet == 0 && nvbs_jetsJes24Up >= 2 && vbs_mjjJes24Up > 500 && vbs_detajj > 2.5 && vbs_zepvv < 1.0 && thePuppiMET_pt              > {1}".format(altMass,metCut))
        dfwzvbscatJes25Up       [x] = dfwzvbscatJes25Up       [x].Filter("mllZ{0}           < 15 && m3l{0}           > 100 && ptlW{0}           > 20 && nbtag_goodbtag_Jet_bjet == 0 && nvbs_jetsJes25Up >= 2 && vbs_mjjJes25Up > 500 && vbs_detajj > 2.5 && vbs_zepvv < 1.0 && thePuppiMET_pt              > {1}".format(altMass,metCut))
        dfwzvbscatJes26Up       [x] = dfwzvbscatJes26Up       [x].Filter("mllZ{0}           < 15 && m3l{0}           > 100 && ptlW{0}           > 20 && nbtag_goodbtag_Jet_bjet == 0 && nvbs_jetsJes26Up >= 2 && vbs_mjjJes26Up > 500 && vbs_detajj > 2.5 && vbs_zepvv < 1.0 && thePuppiMET_pt              > {1}".format(altMass,metCut))
        dfwzvbscatJes27Up       [x] = dfwzvbscatJes27Up       [x].Filter("mllZ{0}           < 15 && m3l{0}           > 100 && ptlW{0}           > 20 && nbtag_goodbtag_Jet_bjet == 0 && nvbs_jetsJes27Up >= 2 && vbs_mjjJes27Up > 500 && vbs_detajj > 2.5 && vbs_zepvv < 1.0 && thePuppiMET_pt              > {1}".format(altMass,metCut))
        dfwzvbscatJerUp         [x] = dfwzvbscatJerUp         [x].Filter("mllZ{0}           < 15 && m3l{0}           > 100 && ptlW{0}           > 20 && nbtag_goodbtag_Jet_bjet == 0 && nvbs_jetsJerUp   >= 2 && vbs_mjjJerUp   > 500 && vbs_detajj > 2.5 && vbs_zepvv < 1.0 && thePuppiMET_pt              > {1}".format(altMass,metCut))
        ...
        dfwzbvbscatJes00Up      [x] = dfwzbvbscatJes00Up      [x].Filter("mllZ{0}           < 15 && m3l{0}           > 100 && ptlW{0}           > 20 && nbtag_goodbtag_Jet_bjet >  0 && nvbs_jetsJes00Up >= 2 && vbs_mjjJes00Up > 500 && vbs_detajj > 2.5 && vbs_zepvv < 1.0 && thePuppiMET_pt              > {1}".format(altMass,metCut))
        dfwzbvbscatJes01Up      [x] = dfwzbvbscatJes01Up      [x].Filter("mllZ{0}           < 15 && m3l{0}           > 100 && ptlW{0}           > 20 && nbtag_goodbtag_Jet_bjet >  0 && nvbs_jetsJes01Up >= 2 && vbs_mjjJes01Up > 500 && vbs_detajj > 2.5 && vbs_zepvv < 1.0 && thePuppiMET_pt              > {1}".format(altMass,metCut))
        dfwzbvbscatJes02Up      [x] = dfwzbvbscatJes02Up      [x].Filter("mllZ{0}           < 15 && m3l{0}           > 100 && ptlW{0}           > 20 && nbtag_goodbtag_Jet_bjet >  0 && nvbs_jetsJes02Up >= 2 && vbs_mjjJes02Up > 500 && vbs_detajj > 2.5 && vbs_zepvv < 1.0 && thePuppiMET_pt              > {1}".format(altMass,metCut))
        dfwzbvbscatJes03Up      [x] = dfwzbvbscatJes03Up      [x].Filter("mllZ{0}           < 15 && m3l{0}           > 100 && ptlW{0}           > 20 && nbtag_goodbtag_Jet_bjet >  0 && nvbs_jetsJes03Up >= 2 && vbs_mjjJes03Up > 500 && vbs_detajj > 2.5 && vbs_zepvv < 1.0 && thePuppiMET_pt              > {1}".format(altMass,metCut))
        dfwzbvbscatJes04Up      [x] = dfwzbvbscatJes04Up      [x].Filter("mllZ{0}           < 15 && m3l{0}           > 100 && ptlW{0}           > 20 && nbtag_goodbtag_Jet_bjet >  0 && nvbs_jetsJes04Up >= 2 && vbs_mjjJes04Up > 500 && vbs_detajj > 2.5 && vbs_zepvv < 1.0 && thePuppiMET_pt              > {1}".format(altMass,metCut))
        dfwzbvbscatJes05Up      [x] = dfwzbvbscatJes05Up      [x].Filter("mllZ{0}           < 15 && m3l{0}           > 100 && ptlW{0}           > 20 && nbtag_goodbtag_Jet_bjet >  0 && nvbs_jetsJes05Up >= 2 && vbs_mjjJes05Up > 500 && vbs_detajj > 2.5 && vbs_zepvv < 1.0 && thePuppiMET_pt              > {1}".format(altMass,metCut))
        dfwzbvbscatJes06Up      [x] = dfwzbvbscatJes06Up      [x].Filter("mllZ{0}           < 15 && m3l{0}           > 100 && ptlW{0}           > 20 && nbtag_goodbtag_Jet_bjet >  0 && nvbs_jetsJes06Up >= 2 && vbs_mjjJes06Up > 500 && vbs_detajj > 2.5 && vbs_zepvv < 1.0 && thePuppiMET_pt              > {1}".format(altMass,metCut))
        dfwzbvbscatJes07Up      [x] = dfwzbvbscatJes07Up      [x].Filter("mllZ{0}           < 15 && m3l{0}           > 100 && ptlW{0}           > 20 && nbtag_goodbtag_Jet_bjet >  0 && nvbs_jetsJes07Up >= 2 && vbs_mjjJes07Up > 500 && vbs_detajj > 2.5 && vbs_zepvv < 1.0 && thePuppiMET_pt              > {1}".format(altMass,metCut))
        dfwzbvbscatJes08Up      [x] = dfwzbvbscatJes08Up      [x].Filter("mllZ{0}           < 15 && m3l{0}           > 100 && ptlW{0}           > 20 && nbtag_goodbtag_Jet_bjet >  0 && nvbs_jetsJes08Up >= 2 && vbs_mjjJes08Up > 500 && vbs_detajj > 2.5 && vbs_zepvv < 1.0 && thePuppiMET_pt              > {1}".format(altMass,metCut))
        dfwzbvbscatJes09Up      [x] = dfwzbvbscatJes09Up      [x].Filter("mllZ{0}           < 15 && m3l{0}           > 100 && ptlW{0}           > 20 && nbtag_goodbtag_Jet_bjet >  0 && nvbs_jetsJes09Up >= 2 && vbs_mjjJes09Up > 500 && vbs_detajj > 2.5 && vbs_zepvv < 1.0 && thePuppiMET_pt              > {1}".format(altMass,metCut))
        dfwzbvbscatJes10Up      [x] = dfwzbvbscatJes10Up      [x].Filter("mllZ{0}           < 15 && m3l{0}           > 100 && ptlW{0}           > 20 && nbtag_goodbtag_Jet_bjet >  0 && nvbs_jetsJes10Up >= 2 && vbs_mjjJes10Up > 500 && vbs_detajj > 2.5 && vbs_zepvv < 1.0 && thePuppiMET_pt              > {1}".format(altMass,metCut))
        dfwzbvbscatJes11Up      [x] = dfwzbvbscatJes11Up      [x].Filter("mllZ{0}           < 15 && m3l{0}           > 100 && ptlW{0}           > 20 && nbtag_goodbtag_Jet_bjet >  0 && nvbs_jetsJes11Up >= 2 && vbs_mjjJes11Up > 500 && vbs_detajj > 2.5 && vbs_zepvv < 1.0 && thePuppiMET_pt              > {1}".format(altMass,metCut))
        dfwzbvbscatJes12Up      [x] = dfwzbvbscatJes12Up      [x].Filter("mllZ{0}           < 15 && m3l{0}           > 100 && ptlW{0}           > 20 && nbtag_goodbtag_Jet_bjet >  0 && nvbs_jetsJes12Up >= 2 && vbs_mjjJes12Up > 500 && vbs_detajj > 2.5 && vbs_zepvv < 1.0 && thePuppiMET_pt              > {1}".format(altMass,metCut))
        dfwzbvbscatJes13Up      [x] = dfwzbvbscatJes13Up      [x].Filter("mllZ{0}           < 15 && m3l{0}           > 100 && ptlW{0}           > 20 && nbtag_goodbtag_Jet_bjet >  0 && nvbs_jetsJes13Up >= 2 && vbs_mjjJes13Up > 500 && vbs_detajj > 2.5 && vbs_zepvv < 1.0 && thePuppiMET_pt              > {1}".format(altMass,metCut))
        dfwzbvbscatJes14Up      [x] = dfwzbvbscatJes14Up      [x].Filter("mllZ{0}           < 15 && m3l{0}           > 100 && ptlW{0}           > 20 && nbtag_goodbtag_Jet_bjet >  0 && nvbs_jetsJes14Up >= 2 && vbs_mjjJes14Up > 500 && vbs_detajj > 2.5 && vbs_zepvv < 1.0 && thePuppiMET_pt              > {1}".format(altMass,metCut))
        dfwzbvbscatJes15Up      [x] = dfwzbvbscatJes15Up      [x].Filter("mllZ{0}           < 15 && m3l{0}           > 100 && ptlW{0}           > 20 && nbtag_goodbtag_Jet_bjet >  0 && nvbs_jetsJes15Up >= 2 && vbs_mjjJes15Up > 500 && vbs_detajj > 2.5 && vbs_zepvv < 1.0 && thePuppiMET_pt              > {1}".format(altMass,metCut))
        dfwzbvbscatJes16Up      [x] = dfwzbvbscatJes16Up      [x].Filter("mllZ{0}           < 15 && m3l{0}           > 100 && ptlW{0}           > 20 && nbtag_goodbtag_Jet_bjet >  0 && nvbs_jetsJes16Up >= 2 && vbs_mjjJes16Up > 500 && vbs_detajj > 2.5 && vbs_zepvv < 1.0 && thePuppiMET_pt              > {1}".format(altMass,metCut))
        dfwzbvbscatJes17Up      [x] = dfwzbvbscatJes17Up      [x].Filter("mllZ{0}           < 15 && m3l{0}           > 100 && ptlW{0}           > 20 && nbtag_goodbtag_Jet_bjet >  0 && nvbs_jetsJes17Up >= 2 && vbs_mjjJes17Up > 500 && vbs_detajj > 2.5 && vbs_zepvv < 1.0 && thePuppiMET_pt              > {1}".format(altMass,metCut))
        dfwzbvbscatJes18Up      [x] = dfwzbvbscatJes18Up      [x].Filter("mllZ{0}           < 15 && m3l{0}           > 100 && ptlW{0}           > 20 && nbtag_goodbtag_Jet_bjet >  0 && nvbs_jetsJes18Up >= 2 && vbs_mjjJes18Up > 500 && vbs_detajj > 2.5 && vbs_zepvv < 1.0 && thePuppiMET_pt              > {1}".format(altMass,metCut))
        dfwzbvbscatJes19Up      [x] = dfwzbvbscatJes19Up      [x].Filter("mllZ{0}           < 15 && m3l{0}           > 100 && ptlW{0}           > 20 && nbtag_goodbtag_Jet_bjet >  0 && nvbs_jetsJes19Up >= 2 && vbs_mjjJes19Up > 500 && vbs_detajj > 2.5 && vbs_zepvv < 1.0 && thePuppiMET_pt              > {1}".format(altMass,metCut))
        dfwzbvbscatJes20Up      [x] = dfwzbvbscatJes20Up      [x].Filter("mllZ{0}           < 15 && m3l{0}           > 100 && ptlW{0}           > 20 && nbtag_goodbtag_Jet_bjet >  0 && nvbs_jetsJes20Up >= 2 && vbs_mjjJes20Up > 500 && vbs_detajj > 2.5 && vbs_zepvv < 1.0 && thePuppiMET_pt              > {1}".format(altMass,metCut))
        dfwzbvbscatJes21Up      [x] = dfwzbvbscatJes21Up      [x].Filter("mllZ{0}           < 15 && m3l{0}           > 100 && ptlW{0}           > 20 && nbtag_goodbtag_Jet_bjet >  0 && nvbs_jetsJes21Up >= 2 && vbs_mjjJes21Up > 500 && vbs_detajj > 2.5 && vbs_zepvv < 1.0 && thePuppiMET_pt              > {1}".format(altMass,metCut))
        dfwzbvbscatJes22Up      [x] = dfwzbvbscatJes22Up      [x].Filter("mllZ{0}           < 15 && m3l{0}           > 100 && ptlW{0}           > 20 && nbtag_goodbtag_Jet_bjet >  0 && nvbs_jetsJes22Up >= 2 && vbs_mjjJes22Up > 500 && vbs_detajj > 2.5 && vbs_zepvv < 1.0 && thePuppiMET_pt              > {1}".format(altMass,metCut))
        dfwzbvbscatJes23Up      [x] = dfwzbvbscatJes23Up      [x].Filter("mllZ{0}           < 15 && m3l{0}           > 100 && ptlW{0}           > 20 && nbtag_goodbtag_Jet_bjet >  0 && nvbs_jetsJes23Up >= 2 && vbs_mjjJes23Up > 500 && vbs_detajj > 2.5 && vbs_zepvv < 1.0 && thePuppiMET_pt              > {1}".format(altMass,metCut))
        dfwzbvbscatJes24Up      [x] = dfwzbvbscatJes24Up      [x].Filter("mllZ{0}           < 15 && m3l{0}           > 100 && ptlW{0}           > 20 && nbtag_goodbtag_Jet_bjet >  0 && nvbs_jetsJes24Up >= 2 && vbs_mjjJes24Up > 500 && vbs_detajj > 2.5 && vbs_zepvv < 1.0 && thePuppiMET_pt              > {1}".format(altMass,metCut))
        dfwzbvbscatJes25Up      [x] = dfwzbvbscatJes25Up      [x].Filter("mllZ{0}           < 15 && m3l{0}           > 100 && ptlW{0}           > 20 && nbtag_goodbtag_Jet_bjet >  0 && nvbs_jetsJes25Up >= 2 && vbs_mjjJes25Up > 500 && vbs_detajj > 2.5 && vbs_zepvv < 1.0 && thePuppiMET_pt              > {1}".format(altMass,metCut))
        dfwzbvbscatJes26Up      [x] = dfwzbvbscatJes26Up      [x].Filter("mllZ{0}           < 15 && m3l{0}           > 100 && ptlW{0}           > 20 && nbtag_goodbtag_Jet_bjet >  0 && nvbs_jetsJes26Up >= 2 && vbs_mjjJes26Up > 500 && vbs_detajj > 2.5 && vbs_zepvv < 1.0 && thePuppiMET_pt              > {1}".format(altMass,metCut))
        dfwzbvbscatJes27Up      [x] = dfwzbvbscatJes27Up      [x].Filter("mllZ{0}           < 15 && m3l{0}           > 100 && ptlW{0}           > 20 && nbtag_goodbtag_Jet_bjet >  0 && nvbs_jetsJes27Up >= 2 && vbs_mjjJes27Up > 500 && vbs_detajj > 2.5 && vbs_zepvv < 1.0 && thePuppiMET_pt              > {1}".format(altMass,metCut))
        dfwzbvbscatJerUp        [x] = dfwzbvbscatJerUp        [x].Filter("mllZ{0}           < 15 && m3l{0}           > 100 && ptlW{0}           > 20 && nbtag_goodbtag_Jet_bjet >  0 && nvbs_jetsJerUp   >= 2 && vbs_mjjJerUp   > 500 && vbs_detajj > 2.5 && vbs_zepvv < 1.0 && thePuppiMET_pt              > {1}".format(altMass,metCut))
        ...
        if(makeDataCards == 1):
            ...
            if(makeDataCards == 3):
                ...
                maxXF1 = 23.5
                varSel1 = 10
                dfwzvbscat             [x] = dfwzvbscat             [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjj,vbs_detajj,vbs_zepvv,bdt_vbfinc[0],mll{0},ngood_jets,{1})".format(altMass,varSel1))
                dfwzvbscatMuonMomUp    [x] = dfwzvbscatMuonMomUp    [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjj,vbs_detajj,vbs_zepvv,bdt_vbfinc[0],mllMuonMomUp,ngood_jets,{1})".format(altMass,varSel1))
                dfwzvbscatElectronMomUp[x] = dfwzvbscatElectronMomUp[x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjj,vbs_detajj,vbs_zepvv,bdt_vbfinc[0],mllElectronMomUp,ngood_jets,{1})".format(altMass,varSel1))
                dfwzvbscatJes00Up      [x] = dfwzvbscatJes00Up      [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjjJes00Up,vbs_detajj,vbs_zepvv,bdt_vbfinc[0],mll{0},ngood_jetsJes00Up,{1})".format(altMass,varSel1))
                dfwzvbscatJes01Up      [x] = dfwzvbscatJes01Up      [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjjJes01Up,vbs_detajj,vbs_zepvv,bdt_vbfinc[0],mll{0},ngood_jetsJes01Up,{1})".format(altMass,varSel1))
                dfwzvbscatJes02Up      [x] = dfwzvbscatJes02Up      [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjjJes02Up,vbs_detajj,vbs_zepvv,bdt_vbfinc[0],mll{0},ngood_jetsJes02Up,{1})".format(altMass,varSel1))
                dfwzvbscatJes03Up      [x] = dfwzvbscatJes03Up      [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjjJes03Up,vbs_detajj,vbs_zepvv,bdt_vbfinc[0],mll{0},ngood_jetsJes03Up,{1})".format(altMass,varSel1))
                dfwzvbscatJes04Up      [x] = dfwzvbscatJes04Up      [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjjJes04Up,vbs_detajj,vbs_zepvv,bdt_vbfinc[0],mll{0},ngood_jetsJes04Up,{1})".format(altMass,varSel1))
                dfwzvbscatJes05Up      [x] = dfwzvbscatJes05Up      [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjjJes05Up,vbs_detajj,vbs_zepvv,bdt_vbfinc[0],mll{0},ngood_jetsJes05Up,{1})".format(altMass,varSel1))
                dfwzvbscatJes06Up      [x] = dfwzvbscatJes06Up      [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjjJes06Up,vbs_detajj,vbs_zepvv,bdt_vbfinc[0],mll{0},ngood_jetsJes06Up,{1})".format(altMass,varSel1))
                dfwzvbscatJes07Up      [x] = dfwzvbscatJes07Up      [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjjJes07Up,vbs_detajj,vbs_zepvv,bdt_vbfinc[0],mll{0},ngood_jetsJes07Up,{1})".format(altMass,varSel1))
                dfwzvbscatJes08Up      [x] = dfwzvbscatJes08Up      [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjjJes08Up,vbs_detajj,vbs_zepvv,bdt_vbfinc[0],mll{0},ngood_jetsJes08Up,{1})".format(altMass,varSel1))
                dfwzvbscatJes09Up      [x] = dfwzvbscatJes09Up      [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjjJes09Up,vbs_detajj,vbs_zepvv,bdt_vbfinc[0],mll{0},ngood_jetsJes09Up,{1})".format(altMass,varSel1))
                dfwzvbscatJes10Up      [x] = dfwzvbscatJes10Up      [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjjJes10Up,vbs_detajj,vbs_zepvv,bdt_vbfinc[0],mll{0},ngood_jetsJes10Up,{1})".format(altMass,varSel1))
                dfwzvbscatJes11Up      [x] = dfwzvbscatJes11Up      [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjjJes11Up,vbs_detajj,vbs_zepvv,bdt_vbfinc[0],mll{0},ngood_jetsJes11Up,{1})".format(altMass,varSel1))
                dfwzvbscatJes12Up      [x] = dfwzvbscatJes12Up      [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjjJes12Up,vbs_detajj,vbs_zepvv,bdt_vbfinc[0],mll{0},ngood_jetsJes12Up,{1})".format(altMass,varSel1))
                dfwzvbscatJes13Up      [x] = dfwzvbscatJes13Up      [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjjJes13Up,vbs_detajj,vbs_zepvv,bdt_vbfinc[0],mll{0},ngood_jetsJes13Up,{1})".format(altMass,varSel1))
                dfwzvbscatJes14Up      [x] = dfwzvbscatJes14Up      [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjjJes14Up,vbs_detajj,vbs_zepvv,bdt_vbfinc[0],mll{0},ngood_jetsJes14Up,{1})".format(altMass,varSel1))
                dfwzvbscatJes15Up      [x] = dfwzvbscatJes15Up      [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjjJes15Up,vbs_detajj,vbs_zepvv,bdt_vbfinc[0],mll{0},ngood_jetsJes15Up,{1})".format(altMass,varSel1))
                dfwzvbscatJes16Up      [x] = dfwzvbscatJes16Up      [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjjJes16Up,vbs_detajj,vbs_zepvv,bdt_vbfinc[0],mll{0},ngood_jetsJes16Up,{1})".format(altMass,varSel1))
                dfwzvbscatJes17Up      [x] = dfwzvbscatJes17Up      [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjjJes17Up,vbs_detajj,vbs_zepvv,bdt_vbfinc[0],mll{0},ngood_jetsJes17Up,{1})".format(altMass,varSel1))
                dfwzvbscatJes18Up      [x] = dfwzvbscatJes18Up      [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjjJes18Up,vbs_detajj,vbs_zepvv,bdt_vbfinc[0],mll{0},ngood_jetsJes18Up,{1})".format(altMass,varSel1))
                dfwzvbscatJes19Up      [x] = dfwzvbscatJes19Up      [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjjJes19Up,vbs_detajj,vbs_zepvv,bdt_vbfinc[0],mll{0},ngood_jetsJes19Up,{1})".format(altMass,varSel1))
                dfwzvbscatJes20Up      [x] = dfwzvbscatJes20Up      [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjjJes20Up,vbs_detajj,vbs_zepvv,bdt_vbfinc[0],mll{0},ngood_jetsJes20Up,{1})".format(altMass,varSel1))
                dfwzvbscatJes21Up      [x] = dfwzvbscatJes21Up      [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjjJes21Up,vbs_detajj,vbs_zepvv,bdt_vbfinc[0],mll{0},ngood_jetsJes21Up,{1})".format(altMass,varSel1))
                dfwzvbscatJes22Up      [x] = dfwzvbscatJes22Up      [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjjJes22Up,vbs_detajj,vbs_zepvv,bdt_vbfinc[0],mll{0},ngood_jetsJes22Up,{1})".format(altMass,varSel1))
                dfwzvbscatJes23Up      [x] = dfwzvbscatJes23Up      [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjjJes23Up,vbs_detajj,vbs_zepvv,bdt_vbfinc[0],mll{0},ngood_jetsJes23Up,{1})".format(altMass,varSel1))
                dfwzvbscatJes24Up      [x] = dfwzvbscatJes24Up      [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjjJes24Up,vbs_detajj,vbs_zepvv,bdt_vbfinc[0],mll{0},ngood_jetsJes24Up,{1})".format(altMass,varSel1))
                dfwzvbscatJes25Up      [x] = dfwzvbscatJes25Up      [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjjJes25Up,vbs_detajj,vbs_zepvv,bdt_vbfinc[0],mll{0},ngood_jetsJes25Up,{1})".format(altMass,varSel1))
                dfwzvbscatJes26Up      [x] = dfwzvbscatJes26Up      [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjjJes26Up,vbs_detajj,vbs_zepvv,bdt_vbfinc[0],mll{0},ngood_jetsJes26Up,{1})".format(altMass,varSel1))
                dfwzvbscatJes27Up      [x] = dfwzvbscatJes27Up      [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjjJes27Up,vbs_detajj,vbs_zepvv,bdt_vbfinc[0],mll{0},ngood_jetsJes27Up,{1})".format(altMass,varSel1))
                dfwzvbscatJerUp        [x] = dfwzvbscatJerUp        [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjjJerUp,vbs_detajj,vbs_zepvv,bdt_vbfinc[0],mll{0},ngood_jetsJerUp,{1})".format(altMass,varSel1))
                dfwzvbscatJERUp        [x] = dfwzvbscatJERUp        [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjj,vbs_detajj,vbs_zepvv,bdt_vbfinc[0],mll{0},ngood_jets,{1})".format(altMass,varSel1))
                dfwzvbscatJESUp        [x] = dfwzvbscatJESUp        [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjj,vbs_detajj,vbs_zepvv,bdt_vbfinc[0],mll{0},ngood_jets,{1})".format(altMass,varSel1))
                dfwzvbscatUnclusteredUp[x] = dfwzvbscatUnclusteredUp[x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjj,vbs_detajj,vbs_zepvv,bdt_vbfinc[0],mll{0},ngood_jets,{1})".format(altMass,varSel1))

                BinXF2 = 4
                minXF2 = -0.5
                maxXF2 =  3.5
                varSel2 = 11
                dfwzbvbscat             [x] = dfwzbvbscat             [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjj,vbs_detajj,vbs_zepvv,bdt_vbfinc[0],mll{0},ngood_jets,{1})".format(altMass,varSel2))
                dfwzbvbscatMuonMomUp    [x] = dfwzbvbscatMuonMomUp    [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjj,vbs_detajj,vbs_zepvv,bdt_vbfinc[0],mllMuonMomUp,ngood_jets,{1})".format(altMass,varSel2))
                dfwzbvbscatElectronMomUp[x] = dfwzbvbscatElectronMomUp[x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjj,vbs_detajj,vbs_zepvv,bdt_vbfinc[0],mllElectronMomUp,ngood_jets,{1})".format(altMass,varSel2))
                dfwzbvbscatJes00Up      [x] = dfwzbvbscatJes00Up      [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjjJes00Up,vbs_detajj,vbs_zepvv,bdt_vbfinc[0],mll{0},ngood_jetsJes00Up,{1})".format(altMass,varSel2))
                dfwzbvbscatJes01Up      [x] = dfwzbvbscatJes01Up      [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjjJes01Up,vbs_detajj,vbs_zepvv,bdt_vbfinc[0],mll{0},ngood_jetsJes01Up,{1})".format(altMass,varSel2))
                dfwzbvbscatJes02Up      [x] = dfwzbvbscatJes02Up      [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjjJes02Up,vbs_detajj,vbs_zepvv,bdt_vbfinc[0],mll{0},ngood_jetsJes02Up,{1})".format(altMass,varSel2))
                dfwzbvbscatJes03Up      [x] = dfwzbvbscatJes03Up      [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjjJes03Up,vbs_detajj,vbs_zepvv,bdt_vbfinc[0],mll{0},ngood_jetsJes03Up,{1})".format(altMass,varSel2))
                dfwzbvbscatJes04Up      [x] = dfwzbvbscatJes04Up      [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjjJes04Up,vbs_detajj,vbs_zepvv,bdt_vbfinc[0],mll{0},ngood_jetsJes04Up,{1})".format(altMass,varSel2))
                dfwzbvbscatJes05Up      [x] = dfwzbvbscatJes05Up      [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjjJes05Up,vbs_detajj,vbs_zepvv,bdt_vbfinc[0],mll{0},ngood_jetsJes05Up,{1})".format(altMass,varSel2))
                dfwzbvbscatJes06Up      [x] = dfwzbvbscatJes06Up      [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjjJes06Up,vbs_detajj,vbs_zepvv,bdt_vbfinc[0],mll{0},ngood_jetsJes06Up,{1})".format(altMass,varSel2))
                dfwzbvbscatJes07Up      [x] = dfwzbvbscatJes07Up      [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjjJes07Up,vbs_detajj,vbs_zepvv,bdt_vbfinc[0],mll{0},ngood_jetsJes07Up,{1})".format(altMass,varSel2))
                dfwzbvbscatJes08Up      [x] = dfwzbvbscatJes08Up      [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjjJes08Up,vbs_detajj,vbs_zepvv,bdt_vbfinc[0],mll{0},ngood_jetsJes08Up,{1})".format(altMass,varSel2))
                dfwzbvbscatJes09Up      [x] = dfwzbvbscatJes09Up      [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjjJes09Up,vbs_detajj,vbs_zepvv,bdt_vbfinc[0],mll{0},ngood_jetsJes09Up,{1})".format(altMass,varSel2))
                dfwzbvbscatJes10Up      [x] = dfwzbvbscatJes10Up      [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjjJes10Up,vbs_detajj,vbs_zepvv,bdt_vbfinc[0],mll{0},ngood_jetsJes10Up,{1})".format(altMass,varSel2))
                dfwzbvbscatJes11Up      [x] = dfwzbvbscatJes11Up      [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjjJes11Up,vbs_detajj,vbs_zepvv,bdt_vbfinc[0],mll{0},ngood_jetsJes11Up,{1})".format(altMass,varSel2))
                dfwzbvbscatJes12Up      [x] = dfwzbvbscatJes12Up      [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjjJes12Up,vbs_detajj,vbs_zepvv,bdt_vbfinc[0],mll{0},ngood_jetsJes12Up,{1})".format(altMass,varSel2))
                dfwzbvbscatJes13Up      [x] = dfwzbvbscatJes13Up      [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjjJes13Up,vbs_detajj,vbs_zepvv,bdt_vbfinc[0],mll{0},ngood_jetsJes13Up,{1})".format(altMass,varSel2))
                dfwzbvbscatJes14Up      [x] = dfwzbvbscatJes14Up      [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjjJes14Up,vbs_detajj,vbs_zepvv,bdt_vbfinc[0],mll{0},ngood_jetsJes14Up,{1})".format(altMass,varSel2))
                dfwzbvbscatJes15Up      [x] = dfwzbvbscatJes15Up      [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjjJes15Up,vbs_detajj,vbs_zepvv,bdt_vbfinc[0],mll{0},ngood_jetsJes15Up,{1})".format(altMass,varSel2))
                dfwzbvbscatJes16Up      [x] = dfwzbvbscatJes16Up      [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjjJes16Up,vbs_detajj,vbs_zepvv,bdt_vbfinc[0],mll{0},ngood_jetsJes16Up,{1})".format(altMass,varSel2))
                dfwzbvbscatJes17Up      [x] = dfwzbvbscatJes17Up      [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjjJes17Up,vbs_detajj,vbs_zepvv,bdt_vbfinc[0],mll{0},ngood_jetsJes17Up,{1})".format(altMass,varSel2))
                dfwzbvbscatJes18Up      [x] = dfwzbvbscatJes18Up      [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjjJes18Up,vbs_detajj,vbs_zepvv,bdt_vbfinc[0],mll{0},ngood_jetsJes18Up,{1})".format(altMass,varSel2))
                dfwzbvbscatJes19Up      [x] = dfwzbvbscatJes19Up      [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjjJes19Up,vbs_detajj,vbs_zepvv,bdt_vbfinc[0],mll{0},ngood_jetsJes19Up,{1})".format(altMass,varSel2))
                dfwzbvbscatJes20Up      [x] = dfwzbvbscatJes20Up      [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjjJes20Up,vbs_detajj,vbs_zepvv,bdt_vbfinc[0],mll{0},ngood_jetsJes20Up,{1})".format(altMass,varSel2))
                dfwzbvbscatJes21Up      [x] = dfwzbvbscatJes21Up      [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjjJes21Up,vbs_detajj,vbs_zepvv,bdt_vbfinc[0],mll{0},ngood_jetsJes21Up,{1})".format(altMass,varSel2))
                dfwzbvbscatJes22Up      [x] = dfwzbvbscatJes22Up      [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjjJes22Up,vbs_detajj,vbs_zepvv,bdt_vbfinc[0],mll{0},ngood_jetsJes22Up,{1})".format(altMass,varSel2))
                dfwzbvbscatJes23Up      [x] = dfwzbvbscatJes23Up      [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjjJes23Up,vbs_detajj,vbs_zepvv,bdt_vbfinc[0],mll{0},ngood_jetsJes23Up,{1})".format(altMass,varSel2))
                dfwzbvbscatJes24Up      [x] = dfwzbvbscatJes24Up      [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjjJes24Up,vbs_detajj,vbs_zepvv,bdt_vbfinc[0],mll{0},ngood_jetsJes24Up,{1})".format(altMass,varSel2))
                dfwzbvbscatJes25Up      [x] = dfwzbvbscatJes25Up      [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjjJes25Up,vbs_detajj,vbs_zepvv,bdt_vbfinc[0],mll{0},ngood_jetsJes25Up,{1})".format(altMass,varSel2))
                dfwzbvbscatJes26Up      [x] = dfwzbvbscatJes26Up      [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjjJes26Up,vbs_detajj,vbs_zepvv,bdt_vbfinc[0],mll{0},ngood_jetsJes26Up,{1})".format(altMass,varSel2))
                dfwzbvbscatJes27Up      [x] = dfwzbvbscatJes27Up      [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjjJes27Up,vbs_detajj,vbs_zepvv,bdt_vbfinc[0],mll{0},ngood_jetsJes27Up,{1})".format(altMass,varSel2))
                dfwzbvbscatJerUp        [x] = dfwzbvbscatJerUp        [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjjJerUp,vbs_detajj,vbs_zepvv,bdt_vbfinc[0],mll{0},ngood_jetsJerUp,{1})".format(altMass,varSel2))
                dfwzbvbscatJERUp        [x] = dfwzbvbscatJERUp        [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjj,vbs_detajj,vbs_zepvv,bdt_vbfinc[0],mll{0},ngood_jets,{1})".format(altMass,varSel2))
                dfwzbvbscatJESUp        [x] = dfwzbvbscatJESUp        [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjj,vbs_detajj,vbs_zepvv,bdt_vbfinc[0],mll{0},ngood_jets,{1})".format(altMass,varSel2))
                dfwzbvbscatUnclusteredUp[x] = dfwzbvbscatUnclusteredUp[x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjj,vbs_detajj,vbs_zepvv,bdt_vbfinc[0],mll{0},ngood_jets,{1})".format(altMass,varSel2))
            ...
            histo[startF+135][x]    = makeFinalVariable(dfwzvbscatMuonMomUp    [x],"finalVar",theCat,startF,x,BinXF1,minXF1,maxXF1,135)
            histo[startF+136][x]    = makeFinalVariable(dfwzvbscatElectronMomUp[x],"finalVar",theCat,startF,x,BinXF1,minXF1,maxXF1,136)
            histo[startF+137][x]    = makeFinalVariable(dfwzvbscatJes00Up      [x],"finalVar",theCat,startF,x,BinXF1,minXF1,maxXF1,137)
            histo[startF+138][x]    = makeFinalVariable(dfwzvbscatJes01Up      [x],"finalVar",theCat,startF,x,BinXF1,minXF1,maxXF1,138)
            histo[startF+139][x]    = makeFinalVariable(dfwzvbscatJes02Up      [x],"finalVar",theCat,startF,x,BinXF1,minXF1,maxXF1,139)
            histo[startF+140][x]    = makeFinalVariable(dfwzvbscatJes03Up      [x],"finalVar",theCat,startF,x,BinXF1,minXF1,maxXF1,140)
            histo[startF+141][x]    = makeFinalVariable(dfwzvbscatJes04Up      [x],"finalVar",theCat,startF,x,BinXF1,minXF1,maxXF1,141)
            histo[startF+142][x]    = makeFinalVariable(dfwzvbscatJes05Up      [x],"finalVar",theCat,startF,x,BinXF1,minXF1,maxXF1,142)
            histo[startF+143][x]    = makeFinalVariable(dfwzvbscatJes06Up      [x],"finalVar",theCat,startF,x,BinXF1,minXF1,maxXF1,143)
            histo[startF+144][x]    = makeFinalVariable(dfwzvbscatJes07Up      [x],"finalVar",theCat,startF,x,BinXF1,minXF1,maxXF1,144)
            histo[startF+145][x]    = makeFinalVariable(dfwzvbscatJes08Up      [x],"finalVar",theCat,startF,x,BinXF1,minXF1,maxXF1,145)
            histo[startF+146][x]    = makeFinalVariable(dfwzvbscatJes09Up      [x],"finalVar",theCat,startF,x,BinXF1,minXF1,maxXF1,146)
            histo[startF+147][x]    = makeFinalVariable(dfwzvbscatJes10Up      [x],"finalVar",theCat,startF,x,BinXF1,minXF1,maxXF1,147)
            histo[startF+148][x]    = makeFinalVariable(dfwzvbscatJes11Up      [x],"finalVar",theCat,startF,x,BinXF1,minXF1,maxXF1,148)
            histo[startF+149][x]    = makeFinalVariable(dfwzvbscatJes12Up      [x],"finalVar",theCat,startF,x,BinXF1,minXF1,maxXF1,149)
            histo[startF+150][x]    = makeFinalVariable(dfwzvbscatJes13Up      [x],"finalVar",theCat,startF,x,BinXF1,minXF1,maxXF1,150)
            histo[startF+151][x]    = makeFinalVariable(dfwzvbscatJes14Up      [x],"finalVar",theCat,startF,x,BinXF1,minXF1,maxXF1,151)
            histo[startF+152][x]    = makeFinalVariable(dfwzvbscatJes15Up      [x],"finalVar",theCat,startF,x,BinXF1,minXF1,maxXF1,152)
            histo[startF+153][x]    = makeFinalVariable(dfwzvbscatJes16Up      [x],"finalVar",theCat,startF,x,BinXF1,minXF1,maxXF1,153)
            histo[startF+154][x]    = makeFinalVariable(dfwzvbscatJes17Up      [x],"finalVar",theCat,startF,x,BinXF1,minXF1,maxXF1,154)
            histo[startF+155][x]    = makeFinalVariable(dfwzvbscatJes18Up      [x],"finalVar",theCat,startF,x,BinXF1,minXF1,maxXF1,155)
            histo[startF+156][x]    = makeFinalVariable(dfwzvbscatJes19Up      [x],"finalVar",theCat,startF,x,BinXF1,minXF1,maxXF1,156)
            histo[startF+157][x]    = makeFinalVariable(dfwzvbscatJes20Up      [x],"finalVar",theCat,startF,x,BinXF1,minXF1,maxXF1,157)
            histo[startF+158][x]    = makeFinalVariable(dfwzvbscatJes21Up      [x],"finalVar",theCat,startF,x,BinXF1,minXF1,maxXF1,158)
            histo[startF+159][x]    = makeFinalVariable(dfwzvbscatJes22Up      [x],"finalVar",theCat,startF,x,BinXF1,minXF1,maxXF1,159)
            histo[startF+160][x]    = makeFinalVariable(dfwzvbscatJes23Up      [x],"finalVar",theCat,startF,x,BinXF1,minXF1,maxXF1,160)
            histo[startF+161][x]    = makeFinalVariable(dfwzvbscatJes24Up      [x],"finalVar",theCat,startF,x,BinXF1,minXF1,maxXF1,161)
            histo[startF+162][x]    = makeFinalVariable(dfwzvbscatJes25Up      [x],"finalVar",theCat,startF,x,BinXF1,minXF1,maxXF1,162)
            histo[startF+163][x]    = makeFinalVariable(dfwzvbscatJes26Up      [x],"finalVar",theCat,startF,x,BinXF1,minXF1,maxXF1,163)
            histo[startF+164][x]    = makeFinalVariable(dfwzvbscatJes27Up      [x],"finalVar",theCat,startF,x,BinXF1,minXF1,maxXF1,164)
            histo[startF+165][x]    = makeFinalVariable(dfwzvbscatJerUp        [x],"finalVar",theCat,startF,x,BinXF1,minXF1,maxXF1,165)
            histo[startF+166][x]    = makeFinalVariable(dfwzvbscatJERUp        [x],"finalVar",theCat,startF,x,BinXF1,minXF1,maxXF1,166)
            histo[startF+167][x]    = makeFinalVariable(dfwzvbscatJESUp        [x],"finalVar",theCat,startF,x,BinXF1,minXF1,maxXF1,167)
            histo[startF+168][x]    = makeFinalVariable(dfwzvbscatUnclusteredUp[x],"finalVar",theCat,startF,x,BinXF1,minXF1,maxXF1,168)
            if(x == plotCategory("kPlotNonPrompt")):
                startNonPrompt = 0
            ...
            histo[startF+135][x]    = makeFinalVariable(dfwzbvbscatMuonMomUp    [x],"finalVar",theCat,startF,x,BinXF2,minXF2,maxXF2,135)
            histo[startF+136][x]    = makeFinalVariable(dfwzbvbscatElectronMomUp[x],"finalVar",theCat,startF,x,BinXF2,minXF2,maxXF2,136)
            histo[startF+137][x]    = makeFinalVariable(dfwzbvbscatJes00Up      [x],"finalVar",theCat,startF,x,BinXF2,minXF2,maxXF2,137)
            histo[startF+138][x]    = makeFinalVariable(dfwzbvbscatJes01Up      [x],"finalVar",theCat,startF,x,BinXF2,minXF2,maxXF2,138)
            histo[startF+139][x]    = makeFinalVariable(dfwzbvbscatJes02Up      [x],"finalVar",theCat,startF,x,BinXF2,minXF2,maxXF2,139)
            histo[startF+140][x]    = makeFinalVariable(dfwzbvbscatJes03Up      [x],"finalVar",theCat,startF,x,BinXF2,minXF2,maxXF2,140)
            histo[startF+141][x]    = makeFinalVariable(dfwzbvbscatJes04Up      [x],"finalVar",theCat,startF,x,BinXF2,minXF2,maxXF2,141)
            histo[startF+142][x]    = makeFinalVariable(dfwzbvbscatJes05Up      [x],"finalVar",theCat,startF,x,BinXF2,minXF2,maxXF2,142)
            histo[startF+143][x]    = makeFinalVariable(dfwzbvbscatJes06Up      [x],"finalVar",theCat,startF,x,BinXF2,minXF2,maxXF2,143)
            histo[startF+144][x]    = makeFinalVariable(dfwzbvbscatJes07Up      [x],"finalVar",theCat,startF,x,BinXF2,minXF2,maxXF2,144)
            histo[startF+145][x]    = makeFinalVariable(dfwzbvbscatJes08Up      [x],"finalVar",theCat,startF,x,BinXF2,minXF2,maxXF2,145)
            histo[startF+146][x]    = makeFinalVariable(dfwzbvbscatJes09Up      [x],"finalVar",theCat,startF,x,BinXF2,minXF2,maxXF2,146)
            histo[startF+147][x]    = makeFinalVariable(dfwzbvbscatJes10Up      [x],"finalVar",theCat,startF,x,BinXF2,minXF2,maxXF2,147)
            histo[startF+148][x]    = makeFinalVariable(dfwzbvbscatJes11Up      [x],"finalVar",theCat,startF,x,BinXF2,minXF2,maxXF2,148)
            histo[startF+149][x]    = makeFinalVariable(dfwzbvbscatJes12Up      [x],"finalVar",theCat,startF,x,BinXF2,minXF2,maxXF2,149)
            histo[startF+150][x]    = makeFinalVariable(dfwzbvbscatJes13Up      [x],"finalVar",theCat,startF,x,BinXF2,minXF2,maxXF2,150)
            histo[startF+151][x]    = makeFinalVariable(dfwzbvbscatJes14Up      [x],"finalVar",theCat,startF,x,BinXF2,minXF2,maxXF2,151)
            histo[startF+152][x]    = makeFinalVariable(dfwzbvbscatJes15Up      [x],"finalVar",theCat,startF,x,BinXF2,minXF2,maxXF2,152)
            histo[startF+153][x]    = makeFinalVariable(dfwzbvbscatJes16Up      [x],"finalVar",theCat,startF,x,BinXF2,minXF2,maxXF2,153)
            histo[startF+154][x]    = makeFinalVariable(dfwzbvbscatJes17Up      [x],"finalVar",theCat,startF,x,BinXF2,minXF2,maxXF2,154)
            histo[startF+155][x]    = makeFinalVariable(dfwzbvbscatJes18Up      [x],"finalVar",theCat,startF,x,BinXF2,minXF2,maxXF2,155)
            histo[startF+156][x]    = makeFinalVariable(dfwzbvbscatJes19Up      [x],"finalVar",theCat,startF,x,BinXF2,minXF2,maxXF2,156)
            histo[startF+157][x]    = makeFinalVariable(dfwzbvbscatJes20Up      [x],"finalVar",theCat,startF,x,BinXF2,minXF2,maxXF2,157)
            histo[startF+158][x]    = makeFinalVariable(dfwzbvbscatJes21Up      [x],"finalVar",theCat,startF,x,BinXF2,minXF2,maxXF2,158)
            histo[startF+159][x]    = makeFinalVariable(dfwzbvbscatJes22Up      [x],"finalVar",theCat,startF,x,BinXF2,minXF2,maxXF2,159)
            histo[startF+160][x]    = makeFinalVariable(dfwzbvbscatJes23Up      [x],"finalVar",theCat,startF,x,BinXF2,minXF2,maxXF2,160)
            histo[startF+161][x]    = makeFinalVariable(dfwzbvbscatJes24Up      [x],"finalVar",theCat,startF,x,BinXF2,minXF2,maxXF2,161)
            histo[startF+162][x]    = makeFinalVariable(dfwzbvbscatJes25Up      [x],"finalVar",theCat,startF,x,BinXF2,minXF2,maxXF2,162)
            histo[startF+163][x]    = makeFinalVariable(dfwzbvbscatJes26Up      [x],"finalVar",theCat,startF,x,BinXF2,minXF2,maxXF2,163)
            histo[startF+164][x]    = makeFinalVariable(dfwzbvbscatJes27Up      [x],"finalVar",theCat,startF,x,BinXF2,minXF2,maxXF2,164)
            histo[startF+165][x]    = makeFinalVariable(dfwzbvbscatJerUp        [x],"finalVar",theCat,startF,x,BinXF2,minXF2,maxXF2,165)
            histo[startF+166][x]    = makeFinalVariable(dfwzbvbscatJERUp        [x],"finalVar",theCat,startF,x,BinXF2,minXF2,maxXF2,166)
            histo[startF+167][x]    = makeFinalVariable(dfwzbvbscatJESUp        [x],"finalVar",theCat,startF,x,BinXF2,minXF2,maxXF2,167)
            histo[startF+168][x]    = makeFinalVariable(dfwzbvbscatUnclusteredUp[x],"finalVar",theCat,startF,x,BinXF2,minXF2,maxXF2,168)
            if(x == plotCategory("kPlotNonPrompt")):
                startNonPrompt = 6
