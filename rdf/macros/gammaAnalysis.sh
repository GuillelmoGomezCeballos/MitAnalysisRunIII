...
python3 gammaAnalysis.py --process=$1 --year=$2 --whichJob=$3
status=$?

rm -f functions_cc* *.pyc

if [ -f "fillhistoGAMMAAna_sample$1_year$2_job$3.root" ]; then
  mv fillhistoGAMMAAna_sample$1_year$2_job$3.root fillhistoGAMMAAna$4_sample$1_year$2_job$3.root
  echo "DONE"
