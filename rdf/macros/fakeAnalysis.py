...
def selection1L(df,year,PDType,isData,TRIGGERFAKEMU,TRIGGERFAKEEL):
    ...
    dftag =(dftag.Filter("nLoose == 1","Only one loose lepton")
                 ...
                 .Define("ptlcone" ,"compute_lmet_var(fake_Muon_pt, fake_Muon_eta, fake_Muon_phi, fake_Muon_jetRelIso, fake_Electron_pt, fake_Electron_eta, fake_Electron_phi, fake_Electron_jetRelIso, MET_pt, MET_phi,6)")
                )
    ...
    for y in range(nCat):
        for ltype in range(2):
            ...
            for trgfake in range(3):
                ...
                histo[trgfake+3*ltype+124][y] = dftrgcat[6*y+3*ltype+trgfake].Histo1D(("histo_{0}_{1}".format(trgfake+3*ltype+124,y), "histo_{0}_{1}".format(trgfake+3*ltype+124,y),50,0.0,2.5), "etal","weightFakeSel{0}".format(trgfake))
            ...
            histo[ltype+ 2][y] = dfcat[2*y+ltype].Histo1D(("histo_{0}_{1}".format(ltype+ 2,y), "histo_{0}_{1}".format(ltype+ 2,y),32,  0, 3.2), "dphilmet","weight")
            ...
            histo[ltype+10][y] = dfcat[2*y+ltype].Histo1D(("histo_{0}_{1}".format(ltype+10,y), "histo_{0}_{1}".format(ltype+10,y),50,0.0,2.5), "etal","weight")
            ...
            histo[ltype+14][y] = dfcat[2*y+ltype].Filter("{0}".format(tagTriggerSel0)).Histo1D(("histo_{0}_{1}".format(ltype+14,y), "histo_{0}_{1}".format(ltype+14,y),50, 10, 60), "ptl","weight")
            histo[ltype+16][y] = dfcat[2*y+ltype].Filter("{0}".format(tagTriggerSel1)).Histo1D(("histo_{0}_{1}".format(ltype+16,y), "histo_{0}_{1}".format(ltype+16,y),50, 10, 60), "ptl","weight")
            histo[ltype+18][y] = dfcat[2*y+ltype].Filter("{0}".format(tagTriggerSel2)).Histo1D(("histo_{0}_{1}".format(ltype+18,y), "histo_{0}_{1}".format(ltype+18,y),50, 10, 60), "ptl","weight")
            histo[ltype+20][y] = dfcat[2*y+ltype].Filter("{0}".format(tagTriggerSel3)).Histo1D(("histo_{0}_{1}".format(ltype+20,y), "histo_{0}_{1}".format(ltype+20,y),50, 10, 60), "ptl","weight")
            ...
            for ptbin in range(len(xPtbins)-1):
                histo[ltype+22+2*ptbin][y] = dfcat[2*y+ltype].Filter("ptl > {0} && ptl < {1}".format(xPtbins[ptbin],xPtbins[ptbin+1])).Histo1D(("histo_{0}_{1}".format(ltype+22+2*ptbin,y), "histo_{0}_{1}".format(ltype+22+2*ptbin,y),100, 0, 200), "mtfix","weight")
                histo[ltype+32+2*ptbin][y] = dfcat[2*y+ltype].Filter("ptl > {0} && ptl < {1} && Sum(tight_{2}3)==1".format(xPtbins[ptbin],xPtbins[ptbin+1],strLep)).Histo1D(("histo_{0}_{1}".format(ltype+32+2*ptbin,y), "histo_{0}_{1}".format(ltype+32+2*ptbin,y),100, 0, 200), "mtfix","weight")
                histo[ltype+42+2*ptbin][y] = dfcat[2*y+ltype].Filter("ptl > {0} && ptl < {1}".format(xPtbins[ptbin],xPtbins[ptbin+1])).Histo1D(("histo_{0}_{1}".format(ltype+42+2*ptbin,y), "histo_{0}_{1}".format(ltype+42+2*ptbin,y),100, 0, 200), "mtfix","weight")
                histo[ltype+52+2*ptbin][y] = dfcat[2*y+ltype].Filter("ptl > {0} && ptl < {1} && Sum(tight_{2}3)==1".format(xPtbins[ptbin],xPtbins[ptbin+1],strLep)).Histo1D(("histo_{0}_{1}".format(ltype+52+2*ptbin,y), "histo_{0}_{1}".format(ltype+52+2*ptbin,y),100, 0, 200), "mtfix","weight")

            dffakecat.append(dfcat[2*y+ltype].Filter("mtfix < {0}".format(mtfixCut), "mtfix < {0}".format(mtfixCut)))
            dfjetcat.append(dffakecat[2*y+ltype].Filter("ngood_jets > 0","at least one jet").Define("dphiljet","deltaPhi(good_Jet_phi[0],phil)"))
            dfbjetcat.append(dffakecat[2*y+ltype].Filter("nbtag_goodbtag_Jet_bjet > 0","at least one btagjet").Define("dphiljet","deltaPhi(goodbtag_Jet_eta[0],phil)"))

            histo[ltype+62][y] = dfjetcat [2*y+ltype].Histo1D(("histo_{0}_{1}".format(ltype+62,y), "histo_{0}_{1}".format(ltype+62,y),32,0,3.2), "dphiljet","weight")
            histo[ltype+64][y] = dfbjetcat[2*y+ltype].Histo1D(("histo_{0}_{1}".format(ltype+64,y), "histo_{0}_{1}".format(ltype+64,y),32,0,3.2), "dphiljet","weight")

            dfjetcat [2*y+ltype] = dfjetcat [2*y+ltype].Filter("dphiljet > 0.7", "dphiljet > 0.7")
            dfbjetcat[2*y+ltype] = dfbjetcat[2*y+ltype].Filter("dphiljet > 0.7", "dphiljet > 0.7")
            ...
            for ptbin in range(2):
                ...
                if(ptbin == 1):
                    ptVar = "ptlcone"
                histo2D[ltype+nHist+ 0][y] = dffakecat[2*y+ltype]                                            .Histo2D(("histo2d_{0}_{1}".format(ltype+nHist+ 0,y), "histo2d_{0}_{1}".format(ltype+nHist+ 0,y), len(xEtabins)-1, xEtabins, len(xPtbins)-1, xPtbins), "etal", "{0}".format(ptVar),"weight")
                histo2D[ltype+nHist+ 2][y] = dffakecat[2*y+ltype].Filter("Sum(tight_{0}0)==1".format(strLep)).Histo2D(("histo2d_{0}_{1}".format(ltype+nHist+ 2,y), "histo2d_{0}_{1}".format(ltype+nHist+ 2,y), len(xEtabins)-1, xEtabins, len(xPtbins)-1, xPtbins), "etal", "{0}".format(ptVar),"weight")
                histo2D[ltype+nHist+ 4][y] = dffakecat[2*y+ltype].Filter("Sum(tight_{0}1)==1".format(strLep)).Histo2D(("histo2d_{0}_{1}".format(ltype+nHist+ 4,y), "histo2d_{0}_{1}".format(ltype+nHist+ 4,y), len(xEtabins)-1, xEtabins, len(xPtbins)-1, xPtbins), "etal", "{0}".format(ptVar),"weight")
                histo2D[ltype+nHist+ 6][y] = dffakecat[2*y+ltype].Filter("Sum(tight_{0}2)==1".format(strLep)).Histo2D(("histo2d_{0}_{1}".format(ltype+nHist+ 6,y), "histo2d_{0}_{1}".format(ltype+nHist+ 6,y), len(xEtabins)-1, xEtabins, len(xPtbins)-1, xPtbins), "etal", "{0}".format(ptVar),"weight")
                histo2D[ltype+nHist+ 8][y] = dffakecat[2*y+ltype].Filter("Sum(tight_{0}3)==1".format(strLep)).Histo2D(("histo2d_{0}_{1}".format(ltype+nHist+ 8,y), "histo2d_{0}_{1}".format(ltype+nHist+ 8,y), len(xEtabins)-1, xEtabins, len(xPtbins)-1, xPtbins), "etal", "{0}".format(ptVar),"weight")
                histo2D[ltype+nHist+10][y] = dffakecat[2*y+ltype].Filter("Sum(tight_{0}4)==1".format(strLep)).Histo2D(("histo2d_{0}_{1}".format(ltype+nHist+10,y), "histo2d_{0}_{1}".format(ltype+nHist+10,y), len(xEtabins)-1, xEtabins, len(xPtbins)-1, xPtbins), "etal", "{0}".format(ptVar),"weight")
                histo2D[ltype+nHist+12][y] = dffakecat[2*y+ltype].Filter("Sum(tight_{0}5)==1".format(strLep)).Histo2D(("histo2d_{0}_{1}".format(ltype+nHist+12,y), "histo2d_{0}_{1}".format(ltype+nHist+12,y), len(xEtabins)-1, xEtabins, len(xPtbins)-1, xPtbins), "etal", "{0}".format(ptVar),"weight")
                histo2D[ltype+nHist+14][y] = dffakecat[2*y+ltype].Filter("Sum(tight_{0}6)==1".format(strLep)).Histo2D(("histo2d_{0}_{1}".format(ltype+nHist+14,y), "histo2d_{0}_{1}".format(ltype+nHist+14,y), len(xEtabins)-1, xEtabins, len(xPtbins)-1, xPtbins), "etal", "{0}".format(ptVar),"weight")
                histo2D[ltype+nHist+16][y] = dffakecat[2*y+ltype].Filter("Sum(tight_{0}7)==1".format(strLep)).Histo2D(("histo2d_{0}_{1}".format(ltype+nHist+16,y), "histo2d_{0}_{1}".format(ltype+nHist+16,y), len(xEtabins)-1, xEtabins, len(xPtbins)-1, xPtbins), "etal", "{0}".format(ptVar),"weight")

                histo2D[ltype+nHist+18][y] = dfjetcat[2*y+ltype]                                             .Histo2D(("histo2d_{0}_{1}".format(ltype+nHist+18,y), "histo2d_{0}_{1}".format(ltype+nHist+18,y), len(xEtabins)-1, xEtabins, len(xPtbins)-1, xPtbins), "etal", "{0}".format(ptVar),"weight")
                histo2D[ltype+nHist+20][y] = dfjetcat[2*y+ltype] .Filter("Sum(tight_{0}0)==1".format(strLep)).Histo2D(("histo2d_{0}_{1}".format(ltype+nHist+20,y), "histo2d_{0}_{1}".format(ltype+nHist+20,y), len(xEtabins)-1, xEtabins, len(xPtbins)-1, xPtbins), "etal", "{0}".format(ptVar),"weight")
                histo2D[ltype+nHist+22][y] = dfjetcat[2*y+ltype] .Filter("Sum(tight_{0}1)==1".format(strLep)).Histo2D(("histo2d_{0}_{1}".format(ltype+nHist+22,y), "histo2d_{0}_{1}".format(ltype+nHist+22,y), len(xEtabins)-1, xEtabins, len(xPtbins)-1, xPtbins), "etal", "{0}".format(ptVar),"weight")
                histo2D[ltype+nHist+24][y] = dfjetcat[2*y+ltype] .Filter("Sum(tight_{0}2)==1".format(strLep)).Histo2D(("histo2d_{0}_{1}".format(ltype+nHist+24,y), "histo2d_{0}_{1}".format(ltype+nHist+24,y), len(xEtabins)-1, xEtabins, len(xPtbins)-1, xPtbins), "etal", "{0}".format(ptVar),"weight")
                histo2D[ltype+nHist+26][y] = dfjetcat[2*y+ltype] .Filter("Sum(tight_{0}3)==1".format(strLep)).Histo2D(("histo2d_{0}_{1}".format(ltype+nHist+26,y), "histo2d_{0}_{1}".format(ltype+nHist+26,y), len(xEtabins)-1, xEtabins, len(xPtbins)-1, xPtbins), "etal", "{0}".format(ptVar),"weight")
                histo2D[ltype+nHist+28][y] = dfjetcat[2*y+ltype] .Filter("Sum(tight_{0}4)==1".format(strLep)).Histo2D(("histo2d_{0}_{1}".format(ltype+nHist+28,y), "histo2d_{0}_{1}".format(ltype+nHist+28,y), len(xEtabins)-1, xEtabins, len(xPtbins)-1, xPtbins), "etal", "{0}".format(ptVar),"weight")
                histo2D[ltype+nHist+30][y] = dfjetcat[2*y+ltype] .Filter("Sum(tight_{0}5)==1".format(strLep)).Histo2D(("histo2d_{0}_{1}".format(ltype+nHist+30,y), "histo2d_{0}_{1}".format(ltype+nHist+30,y), len(xEtabins)-1, xEtabins, len(xPtbins)-1, xPtbins), "etal", "{0}".format(ptVar),"weight")
                histo2D[ltype+nHist+32][y] = dfjetcat[2*y+ltype] .Filter("Sum(tight_{0}6)==1".format(strLep)).Histo2D(("histo2d_{0}_{1}".format(ltype+nHist+32,y), "histo2d_{0}_{1}".format(ltype+nHist+32,y), len(xEtabins)-1, xEtabins, len(xPtbins)-1, xPtbins), "etal", "{0}".format(ptVar),"weight")
                histo2D[ltype+nHist+34][y] = dfjetcat[2*y+ltype] .Filter("Sum(tight_{0}7)==1".format(strLep)).Histo2D(("histo2d_{0}_{1}".format(ltype+nHist+34,y), "histo2d_{0}_{1}".format(ltype+nHist+34,y), len(xEtabins)-1, xEtabins, len(xPtbins)-1, xPtbins), "etal", "{0}".format(ptVar),"weight")

                histo2D[ltype+nHist+36][y] = dfbjetcat[2*y+ltype]                                            .Histo2D(("histo2d_{0}_{1}".format(ltype+nHist+36,y), "histo2d_{0}_{1}".format(ltype+nHist+36,y), len(xEtabins)-1, xEtabins, len(xPtbins)-1, xPtbins), "etal", "{0}".format(ptVar),"weight")
                histo2D[ltype+nHist+38][y] = dfbjetcat[2*y+ltype].Filter("Sum(tight_{0}0)==1".format(strLep)).Histo2D(("histo2d_{0}_{1}".format(ltype+nHist+38,y), "histo2d_{0}_{1}".format(ltype+nHist+38,y), len(xEtabins)-1, xEtabins, len(xPtbins)-1, xPtbins), "etal", "{0}".format(ptVar),"weight")
                histo2D[ltype+nHist+40][y] = dfbjetcat[2*y+ltype].Filter("Sum(tight_{0}1)==1".format(strLep)).Histo2D(("histo2d_{0}_{1}".format(ltype+nHist+40,y), "histo2d_{0}_{1}".format(ltype+nHist+40,y), len(xEtabins)-1, xEtabins, len(xPtbins)-1, xPtbins), "etal", "{0}".format(ptVar),"weight")
                histo2D[ltype+nHist+42][y] = dfbjetcat[2*y+ltype].Filter("Sum(tight_{0}2)==1".format(strLep)).Histo2D(("histo2d_{0}_{1}".format(ltype+nHist+42,y), "histo2d_{0}_{1}".format(ltype+nHist+42,y), len(xEtabins)-1, xEtabins, len(xPtbins)-1, xPtbins), "etal", "{0}".format(ptVar),"weight")
                histo2D[ltype+nHist+44][y] = dfbjetcat[2*y+ltype].Filter("Sum(tight_{0}3)==1".format(strLep)).Histo2D(("histo2d_{0}_{1}".format(ltype+nHist+44,y), "histo2d_{0}_{1}".format(ltype+nHist+44,y), len(xEtabins)-1, xEtabins, len(xPtbins)-1, xPtbins), "etal", "{0}".format(ptVar),"weight")
                histo2D[ltype+nHist+46][y] = dfbjetcat[2*y+ltype].Filter("Sum(tight_{0}4)==1".format(strLep)).Histo2D(("histo2d_{0}_{1}".format(ltype+nHist+46,y), "histo2d_{0}_{1}".format(ltype+nHist+46,y), len(xEtabins)-1, xEtabins, len(xPtbins)-1, xPtbins), "etal", "{0}".format(ptVar),"weight")
                histo2D[ltype+nHist+48][y] = dfbjetcat[2*y+ltype].Filter("Sum(tight_{0}5)==1".format(strLep)).Histo2D(("histo2d_{0}_{1}".format(ltype+nHist+48,y), "histo2d_{0}_{1}".format(ltype+nHist+48,y), len(xEtabins)-1, xEtabins, len(xPtbins)-1, xPtbins), "etal", "{0}".format(ptVar),"weight")
                histo2D[ltype+nHist+50][y] = dfbjetcat[2*y+ltype].Filter("Sum(tight_{0}6)==1".format(strLep)).Histo2D(("histo2d_{0}_{1}".format(ltype+nHist+50,y), "histo2d_{0}_{1}".format(ltype+nHist+50,y), len(xEtabins)-1, xEtabins, len(xPtbins)-1, xPtbins), "etal", "{0}".format(ptVar),"weight")
                histo2D[ltype+nHist+52][y] = dfbjetcat[2*y+ltype].Filter("Sum(tight_{0}7)==1".format(strLep)).Histo2D(("histo2d_{0}_{1}".format(ltype+nHist+52,y), "histo2d_{0}_{1}".format(ltype+nHist+52,y), len(xEtabins)-1, xEtabins, len(xPtbins)-1, xPtbins), "etal", "{0}".format(ptVar),"weight")
