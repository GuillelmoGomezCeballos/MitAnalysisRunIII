...
def analysis(df,count,category,weight,year,PDType,isData,whichJob,nTheoryReplicas,genEventSumLHEScaleRenorm,genEventSumPSRenorm,puWeights,histoBTVEffEtaPtLF,histoBTVEffEtaPtCJ,histoBTVEffEtaPtBJ,histoFakeEtaPt_mu,histoFakeEtaPt_el,histoLepSFEtaPt_mu,histoLepSFEtaPt_el,histoTriggerSFEtaPt_0_0,histoTriggerSFEtaPt_0_1,histoTriggerSFEtaPt_0_2,histoTriggerSFEtaPt_0_3,histoTriggerSFEtaPt_1_0,histoTriggerSFEtaPt_1_1,histoTriggerSFEtaPt_1_2,histoTriggerSFEtaPt_1_3,histoTriggerSFEtaPt_2_0,histoTriggerSFEtaPt_2_1,histoTriggerSFEtaPt_2_2,histoTriggerSFEtaPt_2_3,histoTriggerSFEtaPt_3_0,histoTriggerSFEtaPt_3_1,histoTriggerSFEtaPt_3_2,histoTriggerSFEtaPt_3_3):
    ...
    for x in range(nCat):
        ...
        if(makeDataCards == 1):
            ...
            dfzzcat             [x] = dfzzcat             [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjj,vbs_detajj,vbs_zepvv,bdt_vbfinc[0],mllmin{0},ngood_jets,{1})".format(altMass,varSel))
            dfzzcatMuonMomUp    [x] = dfzzcatMuonMomUp    [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjj,vbs_detajj,vbs_zepvv,bdt_vbfinc[0],mllminMuonMomUp,ngood_jets,{1})".format(altMass,varSel))
            dfzzcatElectronMomUp[x] = dfzzcatElectronMomUp[x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjj,vbs_detajj,vbs_zepvv,bdt_vbfinc[0],mllminElectronMomUp,ngood_jets,{1})".format(altMass,varSel))
            dfzzcatJes00Up      [x] = dfzzcatJes00Up      [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjjJes00Up,vbs_detajjJes00Up,vbs_zepvvJes00Up,bdt_vbfincJes00Up[0],mllmin{0},ngood_jetsJes00Up,{1})".format(altMass,varSel))
            dfzzcatJes01Up      [x] = dfzzcatJes01Up      [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjjJes01Up,vbs_detajjJes01Up,vbs_zepvvJes01Up,bdt_vbfincJes01Up[0],mllmin{0},ngood_jetsJes01Up,{1})".format(altMass,varSel))
            dfzzcatJes02Up      [x] = dfzzcatJes02Up      [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjjJes02Up,vbs_detajjJes02Up,vbs_zepvvJes02Up,bdt_vbfincJes02Up[0],mllmin{0},ngood_jetsJes02Up,{1})".format(altMass,varSel))
            dfzzcatJes03Up      [x] = dfzzcatJes03Up      [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjjJes03Up,vbs_detajjJes03Up,vbs_zepvvJes03Up,bdt_vbfincJes03Up[0],mllmin{0},ngood_jetsJes03Up,{1})".format(altMass,varSel))
            dfzzcatJes04Up      [x] = dfzzcatJes04Up      [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjjJes04Up,vbs_detajjJes04Up,vbs_zepvvJes04Up,bdt_vbfincJes04Up[0],mllmin{0},ngood_jetsJes04Up,{1})".format(altMass,varSel))
            dfzzcatJes05Up      [x] = dfzzcatJes05Up      [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjjJes05Up,vbs_detajjJes05Up,vbs_zepvvJes05Up,bdt_vbfincJes05Up[0],mllmin{0},ngood_jetsJes05Up,{1})".format(altMass,varSel))
            dfzzcatJes06Up      [x] = dfzzcatJes06Up      [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjjJes06Up,vbs_detajjJes06Up,vbs_zepvvJes06Up,bdt_vbfincJes06Up[0],mllmin{0},ngood_jetsJes06Up,{1})".format(altMass,varSel))
            dfzzcatJes07Up      [x] = dfzzcatJes07Up      [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjjJes07Up,vbs_detajjJes07Up,vbs_zepvvJes07Up,bdt_vbfincJes07Up[0],mllmin{0},ngood_jetsJes07Up,{1})".format(altMass,varSel))
            dfzzcatJes08Up      [x] = dfzzcatJes08Up      [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjjJes08Up,vbs_detajjJes08Up,vbs_zepvvJes08Up,bdt_vbfincJes08Up[0],mllmin{0},ngood_jetsJes08Up,{1})".format(altMass,varSel))
            dfzzcatJes09Up      [x] = dfzzcatJes09Up      [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjjJes09Up,vbs_detajjJes09Up,vbs_zepvvJes09Up,bdt_vbfincJes09Up[0],mllmin{0},ngood_jetsJes09Up,{1})".format(altMass,varSel))
            dfzzcatJes10Up      [x] = dfzzcatJes10Up      [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjjJes10Up,vbs_detajjJes10Up,vbs_zepvvJes10Up,bdt_vbfincJes10Up[0],mllmin{0},ngood_jetsJes10Up,{1})".format(altMass,varSel))
            dfzzcatJes11Up      [x] = dfzzcatJes11Up      [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjjJes11Up,vbs_detajjJes11Up,vbs_zepvvJes11Up,bdt_vbfincJes11Up[0],mllmin{0},ngood_jetsJes11Up,{1})".format(altMass,varSel))
            dfzzcatJes12Up      [x] = dfzzcatJes12Up      [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjjJes12Up,vbs_detajjJes12Up,vbs_zepvvJes12Up,bdt_vbfincJes12Up[0],mllmin{0},ngood_jetsJes12Up,{1})".format(altMass,varSel))
            dfzzcatJes13Up      [x] = dfzzcatJes13Up      [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjjJes13Up,vbs_detajjJes13Up,vbs_zepvvJes13Up,bdt_vbfincJes13Up[0],mllmin{0},ngood_jetsJes13Up,{1})".format(altMass,varSel))
            dfzzcatJes14Up      [x] = dfzzcatJes14Up      [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjjJes14Up,vbs_detajjJes14Up,vbs_zepvvJes14Up,bdt_vbfincJes14Up[0],mllmin{0},ngood_jetsJes14Up,{1})".format(altMass,varSel))
            dfzzcatJes15Up      [x] = dfzzcatJes15Up      [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjjJes15Up,vbs_detajjJes15Up,vbs_zepvvJes15Up,bdt_vbfincJes15Up[0],mllmin{0},ngood_jetsJes15Up,{1})".format(altMass,varSel))
            dfzzcatJes16Up      [x] = dfzzcatJes16Up      [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjjJes16Up,vbs_detajjJes16Up,vbs_zepvvJes16Up,bdt_vbfincJes16Up[0],mllmin{0},ngood_jetsJes16Up,{1})".format(altMass,varSel))
            dfzzcatJes17Up      [x] = dfzzcatJes17Up      [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjjJes17Up,vbs_detajjJes17Up,vbs_zepvvJes17Up,bdt_vbfincJes17Up[0],mllmin{0},ngood_jetsJes17Up,{1})".format(altMass,varSel))
            dfzzcatJes18Up      [x] = dfzzcatJes18Up      [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjjJes18Up,vbs_detajjJes18Up,vbs_zepvvJes18Up,bdt_vbfincJes18Up[0],mllmin{0},ngood_jetsJes18Up,{1})".format(altMass,varSel))
            dfzzcatJes19Up      [x] = dfzzcatJes19Up      [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjjJes19Up,vbs_detajjJes19Up,vbs_zepvvJes19Up,bdt_vbfincJes19Up[0],mllmin{0},ngood_jetsJes19Up,{1})".format(altMass,varSel))
            dfzzcatJes20Up      [x] = dfzzcatJes20Up      [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjjJes20Up,vbs_detajjJes20Up,vbs_zepvvJes20Up,bdt_vbfincJes20Up[0],mllmin{0},ngood_jetsJes20Up,{1})".format(altMass,varSel))
            dfzzcatJes21Up      [x] = dfzzcatJes21Up      [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjjJes21Up,vbs_detajjJes21Up,vbs_zepvvJes21Up,bdt_vbfincJes21Up[0],mllmin{0},ngood_jetsJes21Up,{1})".format(altMass,varSel))
            dfzzcatJes22Up      [x] = dfzzcatJes22Up      [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjjJes22Up,vbs_detajjJes22Up,vbs_zepvvJes22Up,bdt_vbfincJes22Up[0],mllmin{0},ngood_jetsJes22Up,{1})".format(altMass,varSel))
            dfzzcatJes23Up      [x] = dfzzcatJes23Up      [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjjJes23Up,vbs_detajjJes23Up,vbs_zepvvJes23Up,bdt_vbfincJes23Up[0],mllmin{0},ngood_jetsJes23Up,{1})".format(altMass,varSel))
            dfzzcatJes24Up      [x] = dfzzcatJes24Up      [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjjJes24Up,vbs_detajjJes24Up,vbs_zepvvJes24Up,bdt_vbfincJes24Up[0],mllmin{0},ngood_jetsJes24Up,{1})".format(altMass,varSel))
            dfzzcatJes25Up      [x] = dfzzcatJes25Up      [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjjJes25Up,vbs_detajjJes25Up,vbs_zepvvJes25Up,bdt_vbfincJes25Up[0],mllmin{0},ngood_jetsJes25Up,{1})".format(altMass,varSel))
            dfzzcatJes26Up      [x] = dfzzcatJes26Up      [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjjJes26Up,vbs_detajjJes26Up,vbs_zepvvJes26Up,bdt_vbfincJes26Up[0],mllmin{0},ngood_jetsJes26Up,{1})".format(altMass,varSel))
            dfzzcatJes27Up      [x] = dfzzcatJes27Up      [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjjJes27Up,vbs_detajjJes27Up,vbs_zepvvJes27Up,bdt_vbfincJes27Up[0],mllmin{0},ngood_jetsJes27Up,{1})".format(altMass,varSel))
            dfzzcatJerUp        [x] = dfzzcatJerUp        [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjjJerUp  ,vbs_detajjJerUp  ,vbs_zepvvJerUp  ,bdt_vbfincJerUp  [0],mllmin{0},ngood_jetsJerUp  ,{1})".format(altMass,varSel))
            dfzzcatJERUp        [x] = dfzzcatJERUp        [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjj       ,vbs_detajj       ,vbs_zepvv       ,bdt_vbfinc       [0],mllmin{0},ngood_jets       ,{1})".format(altMass,varSel))
            dfzzcatJESUp        [x] = dfzzcatJESUp        [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjj       ,vbs_detajj       ,vbs_zepvv       ,bdt_vbfinc       [0],mllmin{0},ngood_jets       ,{1})".format(altMass,varSel))
            dfzzcatUnclusteredUp[x] = dfzzcatUnclusteredUp[x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjj       ,vbs_detajj       ,vbs_zepvv       ,bdt_vbfinc       [0],mllmin{0},ngood_jets       ,{1})".format(altMass,varSel))
