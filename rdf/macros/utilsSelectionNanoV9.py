...
def selection2LVar(df,year,isData):
    ...
    dftag =(dftag.Define("ptl3", "0.0f")
                 ...
                 .Define("elid1", "compute_elid_var(fake_Electron_cutBased, fake_Electron_mvaFall17V2noIso_WP80, fake_Electron_mvaFall17V2Iso_WP80, fake_Electron_mvaFall17V2Iso_WP90, fake_Electron_tightCharge, fake_Electron_mvaTTH, fake_Electron_pfRelIso03_chg, fake_Electron_pfRelIso03_all, 0)")
                 .Define("elid2", "compute_elid_var(fake_Electron_cutBased, fake_Electron_mvaFall17V2noIso_WP80, fake_Electron_mvaFall17V2Iso_WP80, fake_Electron_mvaFall17V2Iso_WP90, fake_Electron_tightCharge, fake_Electron_mvaTTH, fake_Electron_pfRelIso03_chg, fake_Electron_pfRelIso03_all, 1)")
                 )
...
def selectionElMu(df,year,fake_mu,tight_mu,fake_el,tight_el):
    dftag =(df.Define("loose_mu"                  ,"abs(Muon_eta) < 2.4 && Muon_pt > 10 && Muon_looseId == true")
             ...
             #.Define("fake_Muon_mvaMuID"         ,"Muon_mvaMuID[fake_mu]")
              ...
              .Define("fake_Electron_mvaFall17V2noIso_WP80"       ,"Electron_mvaFall17V2noIso_WP80[fake_el]")
              .Define("fake_Electron_mvaFall17V2Iso_WP80"         ,"Electron_mvaFall17V2Iso_WP80[fake_el]")
              .Define("fake_Electron_mvaFall17V2Iso_WP90"         ,"Electron_mvaFall17V2Iso_WP90[fake_el]")
              .Define("fake_Electron_mvaFall17V2Iso_WPL" ,"Electron_mvaFall17V2Iso_WPL[fake_el]")
              .Define("fake_Electron_tightCharge"         ,"Electron_tightCharge[fake_el]")
              .Define("fake_Electron_mvaTTH"              ,"Electron_mvaTTH[fake_el]")
              .Define("fake_Electron_mvaFall17V2Iso"              ,"Electron_mvaFall17V2Iso[fake_el]")
              .Define("fake_Electron_mvaFall17V2noIso"            ,"Electron_mvaFall17V2noIso[fake_el]")
