...
def analysis(df,count,category,weight,year,PDType,isData,whichJob,nTheoryReplicas,genEventSumLHEScaleRenorm,genEventSumPSRenorm,wsWeights,puWeights,histoBTVEffEtaPtLF,histoBTVEffEtaPtCJ,histoBTVEffEtaPtBJ,histoFakeEtaPt_mu,histoFakeEtaPt_el,histoLepSFEtaPt_mu,histoLepSFEtaPt_el,histoTriggerSFEtaPt_0_0,histoTriggerSFEtaPt_0_1,histoTriggerSFEtaPt_0_2,histoTriggerSFEtaPt_0_3,histoTriggerSFEtaPt_1_0,histoTriggerSFEtaPt_1_1,histoTriggerSFEtaPt_1_2,histoTriggerSFEtaPt_1_3,histoTriggerSFEtaPt_2_0,histoTriggerSFEtaPt_2_1,histoTriggerSFEtaPt_2_2,histoTriggerSFEtaPt_2_3,histoTriggerSFEtaPt_3_0,histoTriggerSFEtaPt_3_1,histoTriggerSFEtaPt_3_2,histoTriggerSFEtaPt_3_3):
    ...
    for x in range(nCat):
        ...
        if(makeDataCards == 1 or makeDataCards == 2 or makeDataCards == 3):
            ...
            dfwwvbscat             [x] = dfwwvbscat             [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjj,vbs_detajj,0.0,0.0,mll,ngood_jets,{0})".format(makeDataCards))
            dfwwvbscatMuonMomUp    [x] = dfwwvbscatMuonMomUp    [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjj,vbs_detajj,0.0,0.0,mllMuonMomUp,ngood_jets,{0})".format(makeDataCards))
            dfwwvbscatElectronMomUp[x] = dfwwvbscatElectronMomUp[x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjj,vbs_detajj,0.0,0.0,mllElectronMomUp,ngood_jets,{0})".format(makeDataCards))
            dfwwvbscatJes00Up      [x] = dfwwvbscatJes00Up      [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjjJes00Up,vbs_detajj,0.0,0.0,mll,ngood_jetsJes00Up,{0})".format(makeDataCards))
            dfwwvbscatJes01Up      [x] = dfwwvbscatJes01Up      [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjjJes01Up,vbs_detajj,0.0,0.0,mll,ngood_jetsJes01Up,{0})".format(makeDataCards))
            dfwwvbscatJes02Up      [x] = dfwwvbscatJes02Up      [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjjJes02Up,vbs_detajj,0.0,0.0,mll,ngood_jetsJes02Up,{0})".format(makeDataCards))
            dfwwvbscatJes03Up      [x] = dfwwvbscatJes03Up      [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjjJes03Up,vbs_detajj,0.0,0.0,mll,ngood_jetsJes03Up,{0})".format(makeDataCards))
            dfwwvbscatJes04Up      [x] = dfwwvbscatJes04Up      [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjjJes04Up,vbs_detajj,0.0,0.0,mll,ngood_jetsJes04Up,{0})".format(makeDataCards))
            dfwwvbscatJes05Up      [x] = dfwwvbscatJes05Up      [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjjJes05Up,vbs_detajj,0.0,0.0,mll,ngood_jetsJes05Up,{0})".format(makeDataCards))
            dfwwvbscatJes06Up      [x] = dfwwvbscatJes06Up      [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjjJes06Up,vbs_detajj,0.0,0.0,mll,ngood_jetsJes06Up,{0})".format(makeDataCards))
            dfwwvbscatJes07Up      [x] = dfwwvbscatJes07Up      [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjjJes07Up,vbs_detajj,0.0,0.0,mll,ngood_jetsJes07Up,{0})".format(makeDataCards))
            dfwwvbscatJes08Up      [x] = dfwwvbscatJes08Up      [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjjJes08Up,vbs_detajj,0.0,0.0,mll,ngood_jetsJes08Up,{0})".format(makeDataCards))
            dfwwvbscatJes09Up      [x] = dfwwvbscatJes09Up      [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjjJes09Up,vbs_detajj,0.0,0.0,mll,ngood_jetsJes09Up,{0})".format(makeDataCards))
            dfwwvbscatJes10Up      [x] = dfwwvbscatJes10Up      [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjjJes10Up,vbs_detajj,0.0,0.0,mll,ngood_jetsJes10Up,{0})".format(makeDataCards))
            dfwwvbscatJes11Up      [x] = dfwwvbscatJes11Up      [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjjJes11Up,vbs_detajj,0.0,0.0,mll,ngood_jetsJes11Up,{0})".format(makeDataCards))
            dfwwvbscatJes12Up      [x] = dfwwvbscatJes12Up      [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjjJes12Up,vbs_detajj,0.0,0.0,mll,ngood_jetsJes12Up,{0})".format(makeDataCards))
            dfwwvbscatJes13Up      [x] = dfwwvbscatJes13Up      [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjjJes13Up,vbs_detajj,0.0,0.0,mll,ngood_jetsJes13Up,{0})".format(makeDataCards))
            dfwwvbscatJes14Up      [x] = dfwwvbscatJes14Up      [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjjJes14Up,vbs_detajj,0.0,0.0,mll,ngood_jetsJes14Up,{0})".format(makeDataCards))
            dfwwvbscatJes15Up      [x] = dfwwvbscatJes15Up      [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjjJes15Up,vbs_detajj,0.0,0.0,mll,ngood_jetsJes15Up,{0})".format(makeDataCards))
            dfwwvbscatJes16Up      [x] = dfwwvbscatJes16Up      [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjjJes16Up,vbs_detajj,0.0,0.0,mll,ngood_jetsJes16Up,{0})".format(makeDataCards))
            dfwwvbscatJes17Up      [x] = dfwwvbscatJes17Up      [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjjJes17Up,vbs_detajj,0.0,0.0,mll,ngood_jetsJes17Up,{0})".format(makeDataCards))
            dfwwvbscatJes18Up      [x] = dfwwvbscatJes18Up      [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjjJes18Up,vbs_detajj,0.0,0.0,mll,ngood_jetsJes18Up,{0})".format(makeDataCards))
            dfwwvbscatJes19Up      [x] = dfwwvbscatJes19Up      [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjjJes19Up,vbs_detajj,0.0,0.0,mll,ngood_jetsJes19Up,{0})".format(makeDataCards))
            dfwwvbscatJes20Up      [x] = dfwwvbscatJes20Up      [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjjJes20Up,vbs_detajj,0.0,0.0,mll,ngood_jetsJes20Up,{0})".format(makeDataCards))
            dfwwvbscatJes21Up      [x] = dfwwvbscatJes21Up      [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjjJes21Up,vbs_detajj,0.0,0.0,mll,ngood_jetsJes21Up,{0})".format(makeDataCards))
            dfwwvbscatJes22Up      [x] = dfwwvbscatJes22Up      [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjjJes22Up,vbs_detajj,0.0,0.0,mll,ngood_jetsJes22Up,{0})".format(makeDataCards))
            dfwwvbscatJes23Up      [x] = dfwwvbscatJes23Up      [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjjJes23Up,vbs_detajj,0.0,0.0,mll,ngood_jetsJes23Up,{0})".format(makeDataCards))
            dfwwvbscatJes24Up      [x] = dfwwvbscatJes24Up      [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjjJes24Up,vbs_detajj,0.0,0.0,mll,ngood_jetsJes24Up,{0})".format(makeDataCards))
            dfwwvbscatJes25Up      [x] = dfwwvbscatJes25Up      [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjjJes25Up,vbs_detajj,0.0,0.0,mll,ngood_jetsJes25Up,{0})".format(makeDataCards))
            dfwwvbscatJes26Up      [x] = dfwwvbscatJes26Up      [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjjJes26Up,vbs_detajj,0.0,0.0,mll,ngood_jetsJes26Up,{0})".format(makeDataCards))
            dfwwvbscatJes27Up      [x] = dfwwvbscatJes27Up      [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjjJes27Up,vbs_detajj,0.0,0.0,mll,ngood_jetsJes27Up,{0})".format(makeDataCards))
            dfwwvbscatJerUp        [x] = dfwwvbscatJerUp        [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjjJerUp,vbs_detajj,0.0,0.0,mll,ngood_jetsJerUp,{0})".format(makeDataCards))
            dfwwvbscatJERUp        [x] = dfwwvbscatJERUp        [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjj,vbs_detajj,0.0,0.0,mll,ngood_jets,{0})".format(makeDataCards))
            dfwwvbscatJESUp        [x] = dfwwvbscatJESUp        [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjj,vbs_detajj,0.0,0.0,mll,ngood_jets,{0})".format(makeDataCards))
            dfwwvbscatUnclusteredUp[x] = dfwwvbscatUnclusteredUp[x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjj,vbs_detajj,0.0,0.0,mll,ngood_jets,{0})".format(makeDataCards))

            dfwwbvbscat             [x] = dfwwbvbscat             [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjj,vbs_detajj,0.0,0.0,mll,ngood_jets,{0})".format(makeDataCards))
            dfwwbvbscatMuonMomUp    [x] = dfwwbvbscatMuonMomUp    [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjj,vbs_detajj,0.0,0.0,mllMuonMomUp,ngood_jets,{0})".format(makeDataCards))
            dfwwbvbscatElectronMomUp[x] = dfwwbvbscatElectronMomUp[x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjj,vbs_detajj,0.0,0.0,mllElectronMomUp,ngood_jets,{0})".format(makeDataCards))
            dfwwbvbscatJes00Up      [x] = dfwwbvbscatJes00Up      [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjjJes00Up,vbs_detajj,0.0,0.0,mll,ngood_jetsJes00Up,{0})".format(makeDataCards))
            dfwwbvbscatJes01Up      [x] = dfwwbvbscatJes01Up      [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjjJes01Up,vbs_detajj,0.0,0.0,mll,ngood_jetsJes01Up,{0})".format(makeDataCards))
            dfwwbvbscatJes02Up      [x] = dfwwbvbscatJes02Up      [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjjJes02Up,vbs_detajj,0.0,0.0,mll,ngood_jetsJes02Up,{0})".format(makeDataCards))
            dfwwbvbscatJes03Up      [x] = dfwwbvbscatJes03Up      [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjjJes03Up,vbs_detajj,0.0,0.0,mll,ngood_jetsJes03Up,{0})".format(makeDataCards))
            dfwwbvbscatJes04Up      [x] = dfwwbvbscatJes04Up      [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjjJes04Up,vbs_detajj,0.0,0.0,mll,ngood_jetsJes04Up,{0})".format(makeDataCards))
            dfwwbvbscatJes05Up      [x] = dfwwbvbscatJes05Up      [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjjJes05Up,vbs_detajj,0.0,0.0,mll,ngood_jetsJes05Up,{0})".format(makeDataCards))
            dfwwbvbscatJes06Up      [x] = dfwwbvbscatJes06Up      [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjjJes06Up,vbs_detajj,0.0,0.0,mll,ngood_jetsJes06Up,{0})".format(makeDataCards))
            dfwwbvbscatJes07Up      [x] = dfwwbvbscatJes07Up      [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjjJes07Up,vbs_detajj,0.0,0.0,mll,ngood_jetsJes07Up,{0})".format(makeDataCards))
            dfwwbvbscatJes08Up      [x] = dfwwbvbscatJes08Up      [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjjJes08Up,vbs_detajj,0.0,0.0,mll,ngood_jetsJes08Up,{0})".format(makeDataCards))
            dfwwbvbscatJes09Up      [x] = dfwwbvbscatJes09Up      [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjjJes09Up,vbs_detajj,0.0,0.0,mll,ngood_jetsJes09Up,{0})".format(makeDataCards))
            dfwwbvbscatJes10Up      [x] = dfwwbvbscatJes10Up      [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjjJes10Up,vbs_detajj,0.0,0.0,mll,ngood_jetsJes10Up,{0})".format(makeDataCards))
            dfwwbvbscatJes11Up      [x] = dfwwbvbscatJes11Up      [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjjJes11Up,vbs_detajj,0.0,0.0,mll,ngood_jetsJes11Up,{0})".format(makeDataCards))
            dfwwbvbscatJes12Up      [x] = dfwwbvbscatJes12Up      [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjjJes12Up,vbs_detajj,0.0,0.0,mll,ngood_jetsJes12Up,{0})".format(makeDataCards))
            dfwwbvbscatJes13Up      [x] = dfwwbvbscatJes13Up      [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjjJes13Up,vbs_detajj,0.0,0.0,mll,ngood_jetsJes13Up,{0})".format(makeDataCards))
            dfwwbvbscatJes14Up      [x] = dfwwbvbscatJes14Up      [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjjJes14Up,vbs_detajj,0.0,0.0,mll,ngood_jetsJes14Up,{0})".format(makeDataCards))
            dfwwbvbscatJes15Up      [x] = dfwwbvbscatJes15Up      [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjjJes15Up,vbs_detajj,0.0,0.0,mll,ngood_jetsJes15Up,{0})".format(makeDataCards))
            dfwwbvbscatJes16Up      [x] = dfwwbvbscatJes16Up      [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjjJes16Up,vbs_detajj,0.0,0.0,mll,ngood_jetsJes16Up,{0})".format(makeDataCards))
            dfwwbvbscatJes17Up      [x] = dfwwbvbscatJes17Up      [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjjJes17Up,vbs_detajj,0.0,0.0,mll,ngood_jetsJes17Up,{0})".format(makeDataCards))
            dfwwbvbscatJes18Up      [x] = dfwwbvbscatJes18Up      [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjjJes18Up,vbs_detajj,0.0,0.0,mll,ngood_jetsJes18Up,{0})".format(makeDataCards))
            dfwwbvbscatJes19Up      [x] = dfwwbvbscatJes19Up      [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjjJes19Up,vbs_detajj,0.0,0.0,mll,ngood_jetsJes19Up,{0})".format(makeDataCards))
            dfwwbvbscatJes20Up      [x] = dfwwbvbscatJes20Up      [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjjJes20Up,vbs_detajj,0.0,0.0,mll,ngood_jetsJes20Up,{0})".format(makeDataCards))
            dfwwbvbscatJes21Up      [x] = dfwwbvbscatJes21Up      [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjjJes21Up,vbs_detajj,0.0,0.0,mll,ngood_jetsJes21Up,{0})".format(makeDataCards))
            dfwwbvbscatJes22Up      [x] = dfwwbvbscatJes22Up      [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjjJes22Up,vbs_detajj,0.0,0.0,mll,ngood_jetsJes22Up,{0})".format(makeDataCards))
            dfwwbvbscatJes23Up      [x] = dfwwbvbscatJes23Up      [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjjJes23Up,vbs_detajj,0.0,0.0,mll,ngood_jetsJes23Up,{0})".format(makeDataCards))
            dfwwbvbscatJes24Up      [x] = dfwwbvbscatJes24Up      [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjjJes24Up,vbs_detajj,0.0,0.0,mll,ngood_jetsJes24Up,{0})".format(makeDataCards))
            dfwwbvbscatJes25Up      [x] = dfwwbvbscatJes25Up      [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjjJes25Up,vbs_detajj,0.0,0.0,mll,ngood_jetsJes25Up,{0})".format(makeDataCards))
            dfwwbvbscatJes26Up      [x] = dfwwbvbscatJes26Up      [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjjJes26Up,vbs_detajj,0.0,0.0,mll,ngood_jetsJes26Up,{0})".format(makeDataCards))
            dfwwbvbscatJes27Up      [x] = dfwwbvbscatJes27Up      [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjjJes27Up,vbs_detajj,0.0,0.0,mll,ngood_jetsJes27Up,{0})".format(makeDataCards))
            dfwwbvbscatJerUp        [x] = dfwwbvbscatJerUp        [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjjJerUp,vbs_detajj,0.0,0.0,mll,ngood_jetsJerUp,{0})".format(makeDataCards))
            dfwwbvbscatJERUp        [x] = dfwwbvbscatJERUp        [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjj,vbs_detajj,0.0,0.0,mll,ngood_jets,{0})".format(makeDataCards))
            dfwwbvbscatJESUp        [x] = dfwwbvbscatJESUp        [x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjj,vbs_detajj,0.0,0.0,mll,ngood_jets,{0})".format(makeDataCards))
            dfwwbvbscatUnclusteredUp[x] = dfwwbvbscatUnclusteredUp[x].Define("finalVar", "compute_jet_lepton_final_var(vbs_mjj,vbs_detajj,0.0,0.0,mll,ngood_jets,{0})".format(makeDataCards))
