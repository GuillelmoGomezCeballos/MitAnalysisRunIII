...
def analysis(df,count,category,weight,year,PDType,isData,whichJob,nTheoryReplicas,genEventSumLHEScaleRenorm,genEventSumPSRenorm,ewkCorrWeights,wsWeights,puWeights,histoBTVEffEtaPtLF,histoBTVEffEtaPtCJ,histoBTVEffEtaPtBJ,histoFakeEtaPt_mu,histoFakeEtaPt_el,histoLepSFEtaPt_mu,histoLepSFEtaPt_el,histoTriggerSFEtaPt_0_0,histoTriggerSFEtaPt_0_1,histoTriggerSFEtaPt_0_2,histoTriggerSFEtaPt_0_3,histoTriggerSFEtaPt_1_0,histoTriggerSFEtaPt_1_1,histoTriggerSFEtaPt_1_2,histoTriggerSFEtaPt_1_3,histoTriggerSFEtaPt_2_0,histoTriggerSFEtaPt_2_1,histoTriggerSFEtaPt_2_2,histoTriggerSFEtaPt_2_3,histoTriggerSFEtaPt_3_0,histoTriggerSFEtaPt_3_1,histoTriggerSFEtaPt_3_2,histoTriggerSFEtaPt_3_3):
    ...
    for x in range(nCat):
        ...
        dfwwvbscatMuonMomUp     [x] = dfwwvbscatMuonMomUp     [x].Filter("mllMuonMomUp     > 20 && ptl1MuonMomUp     > 25 && ptl2MuonMomUp     > 20 && (DiLepton_flavor != 2 || abs(mllMuonMomUp     -86.1876) > 20) && nbtag_goodbtag_Jet_bjet        == 0 && nvbs_jets        >= 2 && vbs_mjj        > 500 && vbs_detajj        > 2.5 && vbs_zepvv        < 1.0 && (mllMuonMomUp     > 80 || thePuppiMET_pt              > {1}) && thePuppiMET_pt              > {2}".format(altMass,metCutA,metCutB))
        dfwwvbscatElectronMomUp [x] = dfwwvbscatElectronMomUp [x].Filter("mllElectronMomUp > 20 && ptl1ElectronMomUp > 25 && ptl2ElectronMomUp > 20 && (DiLepton_flavor != 2 || abs(mllElectronMomUp -86.1876) > 20) && nbtag_goodbtag_Jet_bjet        == 0 && nvbs_jets        >= 2 && vbs_mjj        > 500 && vbs_detajj        > 2.5 && vbs_zepvv        < 1.0 && (mllElectronMomUp > 80 || thePuppiMET_pt              > {1}) && thePuppiMET_pt              > {2}".format(altMass,metCutA,metCutB))
        dfwwvbscatJes00Up       [x] = dfwwvbscatJes00Up       [x].Filter("mll{0}           > 20 && ptl1{0}           > 25 && ptl2{0}           > 20 && (DiLepton_flavor != 2 || abs(mll{0}           -86.1876) > 20) && nbtag_goodbtag_Jet_bjetJes00Up == 0 && nvbs_jetsJes00Up >= 2 && vbs_mjjJes00Up > 500 && vbs_detajjJes00Up > 2.5 && vbs_zepvvJes00Up < 1.0 && (mll{0}           > 80 || thePuppiMET_pt              > {1}) && thePuppiMET_pt              > {2}".format(altMass,metCutA,metCutB))
        dfwwvbscatJes01Up       [x] = dfwwvbscatJes01Up       [x].Filter("mll{0}           > 20 && ptl1{0}           > 25 && ptl2{0}           > 20 && (DiLepton_flavor != 2 || abs(mll{0}           -86.1876) > 20) && nbtag_goodbtag_Jet_bjetJes01Up == 0 && nvbs_jetsJes01Up >= 2 && vbs_mjjJes01Up > 500 && vbs_detajjJes01Up > 2.5 && vbs_zepvvJes01Up < 1.0 && (mll{0}           > 80 || thePuppiMET_pt              > {1}) && thePuppiMET_pt              > {2}".format(altMass,metCutA,metCutB))
        dfwwvbscatJes02Up       [x] = dfwwvbscatJes02Up       [x].Filter("mll{0}           > 20 && ptl1{0}           > 25 && ptl2{0}           > 20 && (DiLepton_flavor != 2 || abs(mll{0}           -86.1876) > 20) && nbtag_goodbtag_Jet_bjetJes02Up == 0 && nvbs_jetsJes02Up >= 2 && vbs_mjjJes02Up > 500 && vbs_detajjJes02Up > 2.5 && vbs_zepvvJes02Up < 1.0 && (mll{0}           > 80 || thePuppiMET_pt              > {1}) && thePuppiMET_pt              > {2}".format(altMass,metCutA,metCutB))
        dfwwvbscatJes03Up       [x] = dfwwvbscatJes03Up       [x].Filter("mll{0}           > 20 && ptl1{0}           > 25 && ptl2{0}           > 20 && (DiLepton_flavor != 2 || abs(mll{0}           -86.1876) > 20) && nbtag_goodbtag_Jet_bjetJes03Up == 0 && nvbs_jetsJes03Up >= 2 && vbs_mjjJes03Up > 500 && vbs_detajjJes03Up > 2.5 && vbs_zepvvJes03Up < 1.0 && (mll{0}           > 80 || thePuppiMET_pt              > {1}) && thePuppiMET_pt              > {2}".format(altMass,metCutA,metCutB))
        dfwwvbscatJes04Up       [x] = dfwwvbscatJes04Up       [x].Filter("mll{0}           > 20 && ptl1{0}           > 25 && ptl2{0}           > 20 && (DiLepton_flavor != 2 || abs(mll{0}           -86.1876) > 20) && nbtag_goodbtag_Jet_bjetJes04Up == 0 && nvbs_jetsJes04Up >= 2 && vbs_mjjJes04Up > 500 && vbs_detajjJes04Up > 2.5 && vbs_zepvvJes04Up < 1.0 && (mll{0}           > 80 || thePuppiMET_pt              > {1}) && thePuppiMET_pt              > {2}".format(altMass,metCutA,metCutB))
        dfwwvbscatJes05Up       [x] = dfwwvbscatJes05Up       [x].Filter("mll{0}           > 20 && ptl1{0}           > 25 && ptl2{0}           > 20 && (DiLepton_flavor != 2 || abs(mll{0}           -86.1876) > 20) && nbtag_goodbtag_Jet_bjetJes05Up == 0 && nvbs_jetsJes05Up >= 2 && vbs_mjjJes05Up > 500 && vbs_detajjJes05Up > 2.5 && vbs_zepvvJes05Up < 1.0 && (mll{0}           > 80 || thePuppiMET_pt              > {1}) && thePuppiMET_pt              > {2}".format(altMass,metCutA,metCutB))
        dfwwvbscatJes06Up       [x] = dfwwvbscatJes06Up       [x].Filter("mll{0}           > 20 && ptl1{0}           > 25 && ptl2{0}           > 20 && (DiLepton_flavor != 2 || abs(mll{0}           -86.1876) > 20) && nbtag_goodbtag_Jet_bjetJes06Up == 0 && nvbs_jetsJes06Up >= 2 && vbs_mjjJes06Up > 500 && vbs_detajjJes06Up > 2.5 && vbs_zepvvJes06Up < 1.0 && (mll{0}           > 80 || thePuppiMET_pt              > {1}) && thePuppiMET_pt              > {2}".format(altMass,metCutA,metCutB))
        dfwwvbscatJes07Up       [x] = dfwwvbscatJes07Up       [x].Filter("mll{0}           > 20 && ptl1{0}           > 25 && ptl2{0}           > 20 && (DiLepton_flavor != 2 || abs(mll{0}           -86.1876) > 20) && nbtag_goodbtag_Jet_bjetJes07Up == 0 && nvbs_jetsJes07Up >= 2 && vbs_mjjJes07Up > 500 && vbs_detajjJes07Up > 2.5 && vbs_zepvvJes07Up < 1.0 && (mll{0}           > 80 || thePuppiMET_pt              > {1}) && thePuppiMET_pt              > {2}".format(altMass,metCutA,metCutB))
        dfwwvbscatJes08Up       [x] = dfwwvbscatJes08Up       [x].Filter("mll{0}           > 20 && ptl1{0}           > 25 && ptl2{0}           > 20 && (DiLepton_flavor != 2 || abs(mll{0}           -86.1876) > 20) && nbtag_goodbtag_Jet_bjetJes08Up == 0 && nvbs_jetsJes08Up >= 2 && vbs_mjjJes08Up > 500 && vbs_detajjJes08Up > 2.5 && vbs_zepvvJes08Up < 1.0 && (mll{0}           > 80 || thePuppiMET_pt              > {1}) && thePuppiMET_pt		 > {2}".format(altMass,metCutA,metCutB))
        dfwwvbscatJes09Up       [x] = dfwwvbscatJes09Up       [x].Filter("mll{0}           > 20 && ptl1{0}           > 25 && ptl2{0}           > 20 && (DiLepton_flavor != 2 || abs(mll{0}           -86.1876) > 20) && nbtag_goodbtag_Jet_bjetJes09Up == 0 && nvbs_jetsJes09Up >= 2 && vbs_mjjJes09Up > 500 && vbs_detajjJes09Up > 2.5 && vbs_zepvvJes09Up < 1.0 && (mll{0}           > 80 || thePuppiMET_pt              > {1}) && thePuppiMET_pt		 > {2}".format(altMass,metCutA,metCutB))
        dfwwvbscatJes10Up       [x] = dfwwvbscatJes10Up       [x].Filter("mll{0}           > 20 && ptl1{0}           > 25 && ptl2{0}           > 20 && (DiLepton_flavor != 2 || abs(mll{0}           -86.1876) > 20) && nbtag_goodbtag_Jet_bjetJes10Up == 0 && nvbs_jetsJes10Up >= 2 && vbs_mjjJes10Up > 500 && vbs_detajjJes10Up > 2.5 && vbs_zepvvJes10Up < 1.0 && (mll{0}           > 80 || thePuppiMET_pt              > {1}) && thePuppiMET_pt		 > {2}".format(altMass,metCutA,metCutB))
        dfwwvbscatJes11Up       [x] = dfwwvbscatJes11Up       [x].Filter("mll{0}           > 20 && ptl1{0}           > 25 && ptl2{0}           > 20 && (DiLepton_flavor != 2 || abs(mll{0}           -86.1876) > 20) && nbtag_goodbtag_Jet_bjetJes11Up == 0 && nvbs_jetsJes11Up >= 2 && vbs_mjjJes11Up > 500 && vbs_detajjJes11Up > 2.5 && vbs_zepvvJes11Up < 1.0 && (mll{0}           > 80 || thePuppiMET_pt              > {1}) && thePuppiMET_pt		 > {2}".format(altMass,metCutA,metCutB))
        dfwwvbscatJes12Up       [x] = dfwwvbscatJes12Up       [x].Filter("mll{0}           > 20 && ptl1{0}           > 25 && ptl2{0}           > 20 && (DiLepton_flavor != 2 || abs(mll{0}           -86.1876) > 20) && nbtag_goodbtag_Jet_bjetJes12Up == 0 && nvbs_jetsJes12Up >= 2 && vbs_mjjJes12Up > 500 && vbs_detajjJes12Up > 2.5 && vbs_zepvvJes12Up < 1.0 && (mll{0}           > 80 || thePuppiMET_pt              > {1}) && thePuppiMET_pt		 > {2}".format(altMass,metCutA,metCutB))
        dfwwvbscatJes13Up       [x] = dfwwvbscatJes13Up       [x].Filter("mll{0}           > 20 && ptl1{0}           > 25 && ptl2{0}           > 20 && (DiLepton_flavor != 2 || abs(mll{0}           -86.1876) > 20) && nbtag_goodbtag_Jet_bjetJes13Up == 0 && nvbs_jetsJes13Up >= 2 && vbs_mjjJes13Up > 500 && vbs_detajjJes13Up > 2.5 && vbs_zepvvJes13Up < 1.0 && (mll{0}           > 80 || thePuppiMET_pt              > {1}) && thePuppiMET_pt		 > {2}".format(altMass,metCutA,metCutB))
        dfwwvbscatJes14Up       [x] = dfwwvbscatJes14Up       [x].Filter("mll{0}           > 20 && ptl1{0}           > 25 && ptl2{0}           > 20 && (DiLepton_flavor != 2 || abs(mll{0}           -86.1876) > 20) && nbtag_goodbtag_Jet_bjetJes14Up == 0 && nvbs_jetsJes14Up >= 2 && vbs_mjjJes14Up > 500 && vbs_detajjJes14Up > 2.5 && vbs_zepvvJes14Up < 1.0 && (mll{0}           > 80 || thePuppiMET_pt              > {1}) && thePuppiMET_pt		 > {2}".format(altMass,metCutA,metCutB))
        dfwwvbscatJes15Up       [x] = dfwwvbscatJes15Up       [x].Filter("mll{0}           > 20 && ptl1{0}           > 25 && ptl2{0}           > 20 && (DiLepton_flavor != 2 || abs(mll{0}           -86.1876) > 20) && nbtag_goodbtag_Jet_bjetJes15Up == 0 && nvbs_jetsJes15Up >= 2 && vbs_mjjJes15Up > 500 && vbs_detajjJes15Up > 2.5 && vbs_zepvvJes15Up < 1.0 && (mll{0}           > 80 || thePuppiMET_pt              > {1}) && thePuppiMET_pt		 > {2}".format(altMass,metCutA,metCutB))
        dfwwvbscatJes16Up       [x] = dfwwvbscatJes16Up       [x].Filter("mll{0}           > 20 && ptl1{0}           > 25 && ptl2{0}           > 20 && (DiLepton_flavor != 2 || abs(mll{0}           -86.1876) > 20) && nbtag_goodbtag_Jet_bjetJes16Up == 0 && nvbs_jetsJes16Up >= 2 && vbs_mjjJes16Up > 500 && vbs_detajjJes16Up > 2.5 && vbs_zepvvJes16Up < 1.0 && (mll{0}           > 80 || thePuppiMET_pt              > {1}) && thePuppiMET_pt		 > {2}".format(altMass,metCutA,metCutB))
        dfwwvbscatJes17Up       [x] = dfwwvbscatJes17Up       [x].Filter("mll{0}           > 20 && ptl1{0}           > 25 && ptl2{0}           > 20 && (DiLepton_flavor != 2 || abs(mll{0}           -86.1876) > 20) && nbtag_goodbtag_Jet_bjetJes17Up == 0 && nvbs_jetsJes17Up >= 2 && vbs_mjjJes17Up > 500 && vbs_detajjJes17Up > 2.5 && vbs_zepvvJes17Up < 1.0 && (mll{0}           > 80 || thePuppiMET_pt              > {1}) && thePuppiMET_pt		 > {2}".format(altMass,metCutA,metCutB))
        dfwwvbscatJes18Up       [x] = dfwwvbscatJes18Up       [x].Filter("mll{0}           > 20 && ptl1{0}           > 25 && ptl2{0}           > 20 && (DiLepton_flavor != 2 || abs(mll{0}           -86.1876) > 20) && nbtag_goodbtag_Jet_bjetJes18Up == 0 && nvbs_jetsJes18Up >= 2 && vbs_mjjJes18Up > 500 && vbs_detajjJes18Up > 2.5 && vbs_zepvvJes18Up < 1.0 && (mll{0}           > 80 || thePuppiMET_pt              > {1}) && thePuppiMET_pt		 > {2}".format(altMass,metCutA,metCutB))
        dfwwvbscatJes19Up       [x] = dfwwvbscatJes19Up       [x].Filter("mll{0}           > 20 && ptl1{0}           > 25 && ptl2{0}           > 20 && (DiLepton_flavor != 2 || abs(mll{0}           -86.1876) > 20) && nbtag_goodbtag_Jet_bjetJes19Up == 0 && nvbs_jetsJes19Up >= 2 && vbs_mjjJes19Up > 500 && vbs_detajjJes19Up > 2.5 && vbs_zepvvJes19Up < 1.0 && (mll{0}           > 80 || thePuppiMET_pt              > {1}) && thePuppiMET_pt		 > {2}".format(altMass,metCutA,metCutB))
        dfwwvbscatJes20Up       [x] = dfwwvbscatJes20Up       [x].Filter("mll{0}           > 20 && ptl1{0}           > 25 && ptl2{0}           > 20 && (DiLepton_flavor != 2 || abs(mll{0}           -86.1876) > 20) && nbtag_goodbtag_Jet_bjetJes20Up == 0 && nvbs_jetsJes20Up >= 2 && vbs_mjjJes20Up > 500 && vbs_detajjJes20Up > 2.5 && vbs_zepvvJes20Up < 1.0 && (mll{0}           > 80 || thePuppiMET_pt              > {1}) && thePuppiMET_pt		 > {2}".format(altMass,metCutA,metCutB))
        dfwwvbscatJes21Up       [x] = dfwwvbscatJes21Up       [x].Filter("mll{0}           > 20 && ptl1{0}           > 25 && ptl2{0}           > 20 && (DiLepton_flavor != 2 || abs(mll{0}           -86.1876) > 20) && nbtag_goodbtag_Jet_bjetJes21Up == 0 && nvbs_jetsJes21Up >= 2 && vbs_mjjJes21Up > 500 && vbs_detajjJes21Up > 2.5 && vbs_zepvvJes21Up < 1.0 && (mll{0}           > 80 || thePuppiMET_pt              > {1}) && thePuppiMET_pt		 > {2}".format(altMass,metCutA,metCutB))
        dfwwvbscatJes22Up       [x] = dfwwvbscatJes22Up       [x].Filter("mll{0}           > 20 && ptl1{0}           > 25 && ptl2{0}           > 20 && (DiLepton_flavor != 2 || abs(mll{0}           -86.1876) > 20) && nbtag_goodbtag_Jet_bjetJes22Up == 0 && nvbs_jetsJes22Up >= 2 && vbs_mjjJes22Up > 500 && vbs_detajjJes22Up > 2.5 && vbs_zepvvJes22Up < 1.0 && (mll{0}           > 80 || thePuppiMET_pt              > {1}) && thePuppiMET_pt		 > {2}".format(altMass,metCutA,metCutB))
        dfwwvbscatJes23Up       [x] = dfwwvbscatJes23Up       [x].Filter("mll{0}           > 20 && ptl1{0}           > 25 && ptl2{0}           > 20 && (DiLepton_flavor != 2 || abs(mll{0}           -86.1876) > 20) && nbtag_goodbtag_Jet_bjetJes23Up == 0 && nvbs_jetsJes23Up >= 2 && vbs_mjjJes23Up > 500 && vbs_detajjJes23Up > 2.5 && vbs_zepvvJes23Up < 1.0 && (mll{0}           > 80 || thePuppiMET_pt              > {1}) && thePuppiMET_pt		 > {2}".format(altMass,metCutA,metCutB))
        dfwwvbscatJes24Up       [x] = dfwwvbscatJes24Up       [x].Filter("mll{0}           > 20 && ptl1{0}           > 25 && ptl2{0}           > 20 && (DiLepton_flavor != 2 || abs(mll{0}           -86.1876) > 20) && nbtag_goodbtag_Jet_bjetJes24Up == 0 && nvbs_jetsJes24Up >= 2 && vbs_mjjJes24Up > 500 && vbs_detajjJes24Up > 2.5 && vbs_zepvvJes24Up < 1.0 && (mll{0}           > 80 || thePuppiMET_pt              > {1}) && thePuppiMET_pt		 > {2}".format(altMass,metCutA,metCutB))
        dfwwvbscatJes25Up       [x] = dfwwvbscatJes25Up       [x].Filter("mll{0}           > 20 && ptl1{0}           > 25 && ptl2{0}           > 20 && (DiLepton_flavor != 2 || abs(mll{0}           -86.1876) > 20) && nbtag_goodbtag_Jet_bjetJes25Up == 0 && nvbs_jetsJes25Up >= 2 && vbs_mjjJes25Up > 500 && vbs_detajjJes25Up > 2.5 && vbs_zepvvJes25Up < 1.0 && (mll{0}           > 80 || thePuppiMET_pt              > {1}) && thePuppiMET_pt		 > {2}".format(altMass,metCutA,metCutB))
        dfwwvbscatJes26Up       [x] = dfwwvbscatJes26Up       [x].Filter("mll{0}           > 20 && ptl1{0}           > 25 && ptl2{0}           > 20 && (DiLepton_flavor != 2 || abs(mll{0}           -86.1876) > 20) && nbtag_goodbtag_Jet_bjetJes26Up == 0 && nvbs_jetsJes26Up >= 2 && vbs_mjjJes26Up > 500 && vbs_detajjJes26Up > 2.5 && vbs_zepvvJes26Up < 1.0 && (mll{0}           > 80 || thePuppiMET_pt              > {1}) && thePuppiMET_pt		 > {2}".format(altMass,metCutA,metCutB))
        dfwwvbscatJes27Up       [x] = dfwwvbscatJes27Up       [x].Filter("mll{0}           > 20 && ptl1{0}           > 25 && ptl2{0}           > 20 && (DiLepton_flavor != 2 || abs(mll{0}           -86.1876) > 20) && nbtag_goodbtag_Jet_bjetJes27Up == 0 && nvbs_jetsJes27Up >= 2 && vbs_mjjJes27Up > 500 && vbs_detajjJes27Up > 2.5 && vbs_zepvvJes27Up < 1.0 && (mll{0}           > 80 || thePuppiMET_pt              > {1}) && thePuppiMET_pt		 > {2}".format(altMass,metCutA,metCutB))
        dfwwvbscatJerUp         [x] = dfwwvbscatJerUp         [x].Filter("mll{0}           > 20 && ptl1{0}           > 25 && ptl2{0}           > 20 && (DiLepton_flavor != 2 || abs(mll{0}           -86.1876) > 20) && nbtag_goodbtag_Jet_bjetJerUp   == 0 && nvbs_jetsJerUp   >= 2 && vbs_mjjJerUp   > 500 && vbs_detajjJerUp   > 2.5 && vbs_zepvvJerUp   < 1.0 && (mll{0}           > 80 || thePuppiMET_pt              > {1}) && thePuppiMET_pt		 > {2}".format(altMass,metCutA,metCutB))
        dfwwvbscatJERUp         [x] = dfwwvbscatJERUp         [x].Filter("mll{0}           > 20 && ptl1{0}           > 25 && ptl2{0}           > 20 && (DiLepton_flavor != 2 || abs(mll{0}           -86.1876) > 20) && nbtag_goodbtag_Jet_bjet        == 0 && nvbs_jets        >= 2 && vbs_mjj        > 500 && vbs_detajj        > 2.5 && vbs_zepvv        < 1.0 && (mll{0}           > 80 || thePuppiMET_ptJERUp	   > {1}) && thePuppiMET_ptJERUp 	 > {2}".format(altMass,metCutA,metCutB))
        dfwwvbscatJESUp         [x] = dfwwvbscatJESUp         [x].Filter("mll{0}           > 20 && ptl1{0}           > 25 && ptl2{0}           > 20 && (DiLepton_flavor != 2 || abs(mll{0}           -86.1876) > 20) && nbtag_goodbtag_Jet_bjet        == 0 && nvbs_jets        >= 2 && vbs_mjj        > 500 && vbs_detajj        > 2.5 && vbs_zepvv        < 1.0 && (mll{0}           > 80 || thePuppiMET_ptJESUp	   > {1}) && thePuppiMET_ptJESUp 	 > {2}".format(altMass,metCutA,metCutB))
        dfwwvbscatUnclusteredUp [x] = dfwwvbscatUnclusteredUp [x].Filter("mll{0}           > 20 && ptl1{0}           > 25 && ptl2{0}           > 20 && (DiLepton_flavor != 2 || abs(mll{0}           -86.1876) > 20) && nbtag_goodbtag_Jet_bjet        == 0 && nvbs_jets        >= 2 && vbs_mjj        > 500 && vbs_detajj        > 2.5 && vbs_zepvv        < 1.0 && (mll{0}           > 80 || thePuppiMET_ptUnclusteredUp > {1}) && thePuppiMET_ptUnclusteredUp > {2}".format(altMass,metCutA,metCutB))

        dfwwbvbscatMuonMomUp    [x] = dfwwbvbscatMuonMomUp    [x].Filter("mllMuonMomUp     > 20 && ptl1MuonMomUp     > 25 && ptl2MuonMomUp     > 20 && (DiLepton_flavor != 2 || abs(mllMuonMomUp     -86.1876) > 20) && nbtag_goodbtag_Jet_bjet        >  0 && nvbs_jets        >= 2 && vbs_mjj        > 500 && vbs_detajj        > 2.5 && vbs_zepvv        < 1.0 && (mllMuonMomUp     > 80 || thePuppiMET_pt		   > {1}) && thePuppiMET_pt		 > {2}".format(altMass,metCutA,metCutB))
        dfwwbvbscatElectronMomUp[x] = dfwwbvbscatElectronMomUp[x].Filter("mllElectronMomUp > 20 && ptl1ElectronMomUp > 25 && ptl2ElectronMomUp > 20 && (DiLepton_flavor != 2 || abs(mllElectronMomUp -86.1876) > 20) && nbtag_goodbtag_Jet_bjet        >  0 && nvbs_jets        >= 2 && vbs_mjj        > 500 && vbs_detajj        > 2.5 && vbs_zepvv        < 1.0 && (mllElectronMomUp > 80 || thePuppiMET_pt		   > {1}) && thePuppiMET_pt		 > {2}".format(altMass,metCutA,metCutB))
        dfwwbvbscatJes00Up      [x] = dfwwbvbscatJes00Up      [x].Filter("mll{0}           > 20 && ptl1{0}           > 25 && ptl2{0}           > 20 && (DiLepton_flavor != 2 || abs(mll{0}           -86.1876) > 20) && nbtag_goodbtag_Jet_bjetJes00Up >  0 && nvbs_jetsJes00Up >= 2 && vbs_mjjJes00Up > 500 && vbs_detajjJes00Up > 2.5 && vbs_zepvvJes00Up < 1.0 && (mll{0}	       > 80 || thePuppiMET_pt		   > {1}) && thePuppiMET_pt		 > {2}".format(altMass,metCutA,metCutB))
        dfwwbvbscatJes01Up      [x] = dfwwbvbscatJes01Up      [x].Filter("mll{0}           > 20 && ptl1{0}           > 25 && ptl2{0}           > 20 && (DiLepton_flavor != 2 || abs(mll{0}           -86.1876) > 20) && nbtag_goodbtag_Jet_bjetJes01Up >  0 && nvbs_jetsJes01Up >= 2 && vbs_mjjJes01Up > 500 && vbs_detajjJes01Up > 2.5 && vbs_zepvvJes01Up < 1.0 && (mll{0}	       > 80 || thePuppiMET_pt		   > {1}) && thePuppiMET_pt		 > {2}".format(altMass,metCutA,metCutB))
        dfwwbvbscatJes02Up      [x] = dfwwbvbscatJes02Up      [x].Filter("mll{0}           > 20 && ptl1{0}           > 25 && ptl2{0}           > 20 && (DiLepton_flavor != 2 || abs(mll{0}           -86.1876) > 20) && nbtag_goodbtag_Jet_bjetJes02Up >  0 && nvbs_jetsJes02Up >= 2 && vbs_mjjJes02Up > 500 && vbs_detajjJes02Up > 2.5 && vbs_zepvvJes02Up < 1.0 && (mll{0}	       > 80 || thePuppiMET_pt		   > {1}) && thePuppiMET_pt		 > {2}".format(altMass,metCutA,metCutB))
        dfwwbvbscatJes03Up      [x] = dfwwbvbscatJes03Up      [x].Filter("mll{0}           > 20 && ptl1{0}           > 25 && ptl2{0}           > 20 && (DiLepton_flavor != 2 || abs(mll{0}           -86.1876) > 20) && nbtag_goodbtag_Jet_bjetJes03Up >  0 && nvbs_jetsJes03Up >= 2 && vbs_mjjJes03Up > 500 && vbs_detajjJes03Up > 2.5 && vbs_zepvvJes03Up < 1.0 && (mll{0}	       > 80 || thePuppiMET_pt		   > {1}) && thePuppiMET_pt		 > {2}".format(altMass,metCutA,metCutB))
        dfwwbvbscatJes04Up      [x] = dfwwbvbscatJes04Up      [x].Filter("mll{0}           > 20 && ptl1{0}           > 25 && ptl2{0}           > 20 && (DiLepton_flavor != 2 || abs(mll{0}           -86.1876) > 20) && nbtag_goodbtag_Jet_bjetJes04Up >  0 && nvbs_jetsJes04Up >= 2 && vbs_mjjJes04Up > 500 && vbs_detajjJes04Up > 2.5 && vbs_zepvvJes04Up < 1.0 && (mll{0}	       > 80 || thePuppiMET_pt		   > {1}) && thePuppiMET_pt		 > {2}".format(altMass,metCutA,metCutB))
        dfwwbvbscatJes05Up      [x] = dfwwbvbscatJes05Up      [x].Filter("mll{0}           > 20 && ptl1{0}           > 25 && ptl2{0}           > 20 && (DiLepton_flavor != 2 || abs(mll{0}           -86.1876) > 20) && nbtag_goodbtag_Jet_bjetJes05Up >  0 && nvbs_jetsJes05Up >= 2 && vbs_mjjJes05Up > 500 && vbs_detajjJes05Up > 2.5 && vbs_zepvvJes05Up < 1.0 && (mll{0}	       > 80 || thePuppiMET_pt		   > {1}) && thePuppiMET_pt		 > {2}".format(altMass,metCutA,metCutB))
        dfwwbvbscatJes06Up      [x] = dfwwbvbscatJes06Up      [x].Filter("mll{0}           > 20 && ptl1{0}           > 25 && ptl2{0}           > 20 && (DiLepton_flavor != 2 || abs(mll{0}           -86.1876) > 20) && nbtag_goodbtag_Jet_bjetJes06Up >  0 && nvbs_jetsJes06Up >= 2 && vbs_mjjJes06Up > 500 && vbs_detajjJes06Up > 2.5 && vbs_zepvvJes06Up < 1.0 && (mll{0}	       > 80 || thePuppiMET_pt		   > {1}) && thePuppiMET_pt		 > {2}".format(altMass,metCutA,metCutB))
        dfwwbvbscatJes07Up      [x] = dfwwbvbscatJes07Up      [x].Filter("mll{0}           > 20 && ptl1{0}           > 25 && ptl2{0}           > 20 && (DiLepton_flavor != 2 || abs(mll{0}           -86.1876) > 20) && nbtag_goodbtag_Jet_bjetJes07Up >  0 && nvbs_jetsJes07Up >= 2 && vbs_mjjJes07Up > 500 && vbs_detajjJes07Up > 2.5 && vbs_zepvvJes07Up < 1.0 && (mll{0}	       > 80 || thePuppiMET_pt		   > {1}) && thePuppiMET_pt		 > {2}".format(altMass,metCutA,metCutB))
        dfwwbvbscatJes08Up      [x] = dfwwbvbscatJes08Up      [x].Filter("mll{0}           > 20 && ptl1{0}           > 25 && ptl2{0}           > 20 && (DiLepton_flavor != 2 || abs(mll{0}           -86.1876) > 20) && nbtag_goodbtag_Jet_bjetJes08Up >  0 && nvbs_jetsJes08Up >= 2 && vbs_mjjJes08Up > 500 && vbs_detajjJes08Up > 2.5 && vbs_zepvvJes08Up < 1.0 && (mll{0}	       > 80 || thePuppiMET_pt		   > {1}) && thePuppiMET_pt		 > {2}".format(altMass,metCutA,metCutB))
        dfwwbvbscatJes09Up      [x] = dfwwbvbscatJes09Up      [x].Filter("mll{0}           > 20 && ptl1{0}           > 25 && ptl2{0}           > 20 && (DiLepton_flavor != 2 || abs(mll{0}           -86.1876) > 20) && nbtag_goodbtag_Jet_bjetJes09Up >  0 && nvbs_jetsJes09Up >= 2 && vbs_mjjJes09Up > 500 && vbs_detajjJes09Up > 2.5 && vbs_zepvvJes09Up < 1.0 && (mll{0}	       > 80 || thePuppiMET_pt		   > {1}) && thePuppiMET_pt		 > {2}".format(altMass,metCutA,metCutB))
        dfwwbvbscatJes10Up      [x] = dfwwbvbscatJes10Up      [x].Filter("mll{0}           > 20 && ptl1{0}           > 25 && ptl2{0}           > 20 && (DiLepton_flavor != 2 || abs(mll{0}           -86.1876) > 20) && nbtag_goodbtag_Jet_bjetJes10Up >  0 && nvbs_jetsJes10Up >= 2 && vbs_mjjJes10Up > 500 && vbs_detajjJes10Up > 2.5 && vbs_zepvvJes10Up < 1.0 && (mll{0}	       > 80 || thePuppiMET_pt		   > {1}) && thePuppiMET_pt		 > {2}".format(altMass,metCutA,metCutB))
        dfwwbvbscatJes11Up      [x] = dfwwbvbscatJes11Up      [x].Filter("mll{0}           > 20 && ptl1{0}           > 25 && ptl2{0}           > 20 && (DiLepton_flavor != 2 || abs(mll{0}           -86.1876) > 20) && nbtag_goodbtag_Jet_bjetJes11Up >  0 && nvbs_jetsJes11Up >= 2 && vbs_mjjJes11Up > 500 && vbs_detajjJes11Up > 2.5 && vbs_zepvvJes11Up < 1.0 && (mll{0}	       > 80 || thePuppiMET_pt		   > {1}) && thePuppiMET_pt		 > {2}".format(altMass,metCutA,metCutB))
        dfwwbvbscatJes12Up      [x] = dfwwbvbscatJes12Up      [x].Filter("mll{0}           > 20 && ptl1{0}           > 25 && ptl2{0}           > 20 && (DiLepton_flavor != 2 || abs(mll{0}           -86.1876) > 20) && nbtag_goodbtag_Jet_bjetJes12Up >  0 && nvbs_jetsJes12Up >= 2 && vbs_mjjJes12Up > 500 && vbs_detajjJes12Up > 2.5 && vbs_zepvvJes12Up < 1.0 && (mll{0}	       > 80 || thePuppiMET_pt		   > {1}) && thePuppiMET_pt		 > {2}".format(altMass,metCutA,metCutB))
        dfwwbvbscatJes13Up      [x] = dfwwbvbscatJes13Up      [x].Filter("mll{0}           > 20 && ptl1{0}           > 25 && ptl2{0}           > 20 && (DiLepton_flavor != 2 || abs(mll{0}           -86.1876) > 20) && nbtag_goodbtag_Jet_bjetJes13Up >  0 && nvbs_jetsJes13Up >= 2 && vbs_mjjJes13Up > 500 && vbs_detajjJes13Up > 2.5 && vbs_zepvvJes13Up < 1.0 && (mll{0}	       > 80 || thePuppiMET_pt		   > {1}) && thePuppiMET_pt		 > {2}".format(altMass,metCutA,metCutB))
        dfwwbvbscatJes14Up      [x] = dfwwbvbscatJes14Up      [x].Filter("mll{0}           > 20 && ptl1{0}           > 25 && ptl2{0}           > 20 && (DiLepton_flavor != 2 || abs(mll{0}           -86.1876) > 20) && nbtag_goodbtag_Jet_bjetJes14Up >  0 && nvbs_jetsJes14Up >= 2 && vbs_mjjJes14Up > 500 && vbs_detajjJes14Up > 2.5 && vbs_zepvvJes14Up < 1.0 && (mll{0}	       > 80 || thePuppiMET_pt		   > {1}) && thePuppiMET_pt		 > {2}".format(altMass,metCutA,metCutB))
        dfwwbvbscatJes15Up      [x] = dfwwbvbscatJes15Up      [x].Filter("mll{0}           > 20 && ptl1{0}           > 25 && ptl2{0}           > 20 && (DiLepton_flavor != 2 || abs(mll{0}           -86.1876) > 20) && nbtag_goodbtag_Jet_bjetJes15Up >  0 && nvbs_jetsJes15Up >= 2 && vbs_mjjJes15Up > 500 && vbs_detajjJes15Up > 2.5 && vbs_zepvvJes15Up < 1.0 && (mll{0}	       > 80 || thePuppiMET_pt		   > {1}) && thePuppiMET_pt		 > {2}".format(altMass,metCutA,metCutB))
        dfwwbvbscatJes16Up      [x] = dfwwbvbscatJes16Up      [x].Filter("mll{0}           > 20 && ptl1{0}           > 25 && ptl2{0}           > 20 && (DiLepton_flavor != 2 || abs(mll{0}           -86.1876) > 20) && nbtag_goodbtag_Jet_bjetJes16Up >  0 && nvbs_jetsJes16Up >= 2 && vbs_mjjJes16Up > 500 && vbs_detajjJes16Up > 2.5 && vbs_zepvvJes16Up < 1.0 && (mll{0}	       > 80 || thePuppiMET_pt		   > {1}) && thePuppiMET_pt		 > {2}".format(altMass,metCutA,metCutB))
        dfwwbvbscatJes17Up      [x] = dfwwbvbscatJes17Up      [x].Filter("mll{0}           > 20 && ptl1{0}           > 25 && ptl2{0}           > 20 && (DiLepton_flavor != 2 || abs(mll{0}           -86.1876) > 20) && nbtag_goodbtag_Jet_bjetJes17Up >  0 && nvbs_jetsJes17Up >= 2 && vbs_mjjJes17Up > 500 && vbs_detajjJes17Up > 2.5 && vbs_zepvvJes17Up < 1.0 && (mll{0}	       > 80 || thePuppiMET_pt		   > {1}) && thePuppiMET_pt		 > {2}".format(altMass,metCutA,metCutB))
        dfwwbvbscatJes18Up      [x] = dfwwbvbscatJes18Up      [x].Filter("mll{0}           > 20 && ptl1{0}           > 25 && ptl2{0}           > 20 && (DiLepton_flavor != 2 || abs(mll{0}           -86.1876) > 20) && nbtag_goodbtag_Jet_bjetJes18Up >  0 && nvbs_jetsJes18Up >= 2 && vbs_mjjJes18Up > 500 && vbs_detajjJes18Up > 2.5 && vbs_zepvvJes18Up < 1.0 && (mll{0}	       > 80 || thePuppiMET_pt		   > {1}) && thePuppiMET_pt		 > {2}".format(altMass,metCutA,metCutB))
        dfwwbvbscatJes19Up      [x] = dfwwbvbscatJes19Up      [x].Filter("mll{0}           > 20 && ptl1{0}           > 25 && ptl2{0}           > 20 && (DiLepton_flavor != 2 || abs(mll{0}           -86.1876) > 20) && nbtag_goodbtag_Jet_bjetJes19Up >  0 && nvbs_jetsJes19Up >= 2 && vbs_mjjJes19Up > 500 && vbs_detajjJes19Up > 2.5 && vbs_zepvvJes19Up < 1.0 && (mll{0}	       > 80 || thePuppiMET_pt		   > {1}) && thePuppiMET_pt		 > {2}".format(altMass,metCutA,metCutB))
        dfwwbvbscatJes20Up      [x] = dfwwbvbscatJes20Up      [x].Filter("mll{0}           > 20 && ptl1{0}           > 25 && ptl2{0}           > 20 && (DiLepton_flavor != 2 || abs(mll{0}           -86.1876) > 20) && nbtag_goodbtag_Jet_bjetJes20Up >  0 && nvbs_jetsJes20Up >= 2 && vbs_mjjJes20Up > 500 && vbs_detajjJes20Up > 2.5 && vbs_zepvvJes20Up < 1.0 && (mll{0}	       > 80 || thePuppiMET_pt		   > {1}) && thePuppiMET_pt		 > {2}".format(altMass,metCutA,metCutB))
        dfwwbvbscatJes21Up      [x] = dfwwbvbscatJes21Up      [x].Filter("mll{0}           > 20 && ptl1{0}           > 25 && ptl2{0}           > 20 && (DiLepton_flavor != 2 || abs(mll{0}           -86.1876) > 20) && nbtag_goodbtag_Jet_bjetJes21Up >  0 && nvbs_jetsJes21Up >= 2 && vbs_mjjJes21Up > 500 && vbs_detajjJes21Up > 2.5 && vbs_zepvvJes21Up < 1.0 && (mll{0}	       > 80 || thePuppiMET_pt		   > {1}) && thePuppiMET_pt		 > {2}".format(altMass,metCutA,metCutB))
        dfwwbvbscatJes22Up      [x] = dfwwbvbscatJes22Up      [x].Filter("mll{0}           > 20 && ptl1{0}           > 25 && ptl2{0}           > 20 && (DiLepton_flavor != 2 || abs(mll{0}           -86.1876) > 20) && nbtag_goodbtag_Jet_bjetJes22Up >  0 && nvbs_jetsJes22Up >= 2 && vbs_mjjJes22Up > 500 && vbs_detajjJes22Up > 2.5 && vbs_zepvvJes22Up < 1.0 && (mll{0}	       > 80 || thePuppiMET_pt		   > {1}) && thePuppiMET_pt		 > {2}".format(altMass,metCutA,metCutB))
        dfwwbvbscatJes23Up      [x] = dfwwbvbscatJes23Up      [x].Filter("mll{0}           > 20 && ptl1{0}           > 25 && ptl2{0}           > 20 && (DiLepton_flavor != 2 || abs(mll{0}           -86.1876) > 20) && nbtag_goodbtag_Jet_bjetJes23Up >  0 && nvbs_jetsJes23Up >= 2 && vbs_mjjJes23Up > 500 && vbs_detajjJes23Up > 2.5 && vbs_zepvvJes23Up < 1.0 && (mll{0}	       > 80 || thePuppiMET_pt		   > {1}) && thePuppiMET_pt		 > {2}".format(altMass,metCutA,metCutB))
        dfwwbvbscatJes24Up      [x] = dfwwbvbscatJes24Up      [x].Filter("mll{0}           > 20 && ptl1{0}           > 25 && ptl2{0}           > 20 && (DiLepton_flavor != 2 || abs(mll{0}           -86.1876) > 20) && nbtag_goodbtag_Jet_bjetJes24Up >  0 && nvbs_jetsJes24Up >= 2 && vbs_mjjJes24Up > 500 && vbs_detajjJes24Up > 2.5 && vbs_zepvvJes24Up < 1.0 && (mll{0}	       > 80 || thePuppiMET_pt		   > {1}) && thePuppiMET_pt		 > {2}".format(altMass,metCutA,metCutB))
        dfwwbvbscatJes25Up      [x] = dfwwbvbscatJes25Up      [x].Filter("mll{0}           > 20 && ptl1{0}           > 25 && ptl2{0}           > 20 && (DiLepton_flavor != 2 || abs(mll{0}           -86.1876) > 20) && nbtag_goodbtag_Jet_bjetJes25Up >  0 && nvbs_jetsJes25Up >= 2 && vbs_mjjJes25Up > 500 && vbs_detajjJes25Up > 2.5 && vbs_zepvvJes25Up < 1.0 && (mll{0}	       > 80 || thePuppiMET_pt		   > {1}) && thePuppiMET_pt		 > {2}".format(altMass,metCutA,metCutB))
        dfwwbvbscatJes26Up      [x] = dfwwbvbscatJes26Up      [x].Filter("mll{0}           > 20 && ptl1{0}           > 25 && ptl2{0}           > 20 && (DiLepton_flavor != 2 || abs(mll{0}           -86.1876) > 20) && nbtag_goodbtag_Jet_bjetJes26Up >  0 && nvbs_jetsJes26Up >= 2 && vbs_mjjJes26Up > 500 && vbs_detajjJes26Up > 2.5 && vbs_zepvvJes26Up < 1.0 && (mll{0}	       > 80 || thePuppiMET_pt		   > {1}) && thePuppiMET_pt		 > {2}".format(altMass,metCutA,metCutB))
        dfwwbvbscatJes27Up      [x] = dfwwbvbscatJes27Up      [x].Filter("mll{0}           > 20 && ptl1{0}           > 25 && ptl2{0}           > 20 && (DiLepton_flavor != 2 || abs(mll{0}           -86.1876) > 20) && nbtag_goodbtag_Jet_bjetJes27Up >  0 && nvbs_jetsJes27Up >= 2 && vbs_mjjJes27Up > 500 && vbs_detajjJes27Up > 2.5 && vbs_zepvvJes27Up < 1.0 && (mll{0}	       > 80 || thePuppiMET_pt		   > {1}) && thePuppiMET_pt		 > {2}".format(altMass,metCutA,metCutB))
        dfwwbvbscatJerUp        [x] = dfwwbvbscatJerUp        [x].Filter("mll{0}           > 20 && ptl1{0}           > 25 && ptl2{0}           > 20 && (DiLepton_flavor != 2 || abs(mll{0}           -86.1876) > 20) && nbtag_goodbtag_Jet_bjetJerUp   >  0 && nvbs_jetsJerUp   >= 2 && vbs_mjjJerUp   > 500 && vbs_detajjJerUp   > 2.5 && vbs_zepvvJerUp   < 1.0 && (mll{0}	       > 80 || thePuppiMET_pt		   > {1}) && thePuppiMET_pt		 > {2}".format(altMass,metCutA,metCutB))
        dfwwbvbscatJERUp        [x] = dfwwbvbscatJERUp        [x].Filter("mll{0}           > 20 && ptl1{0}           > 25 && ptl2{0}           > 20 && (DiLepton_flavor != 2 || abs(mll{0}           -86.1876) > 20) && nbtag_goodbtag_Jet_bjet        >  0 && nvbs_jets        >= 2 && vbs_mjj        > 500 && vbs_detajj        > 2.5 && vbs_zepvv        < 1.0 && (mll{0}	       > 80 || thePuppiMET_ptJERUp	   > {1}) && thePuppiMET_ptJERUp	 > {2}".format(altMass,metCutA,metCutB))
        dfwwbvbscatJESUp        [x] = dfwwbvbscatJESUp        [x].Filter("mll{0}           > 20 && ptl1{0}           > 25 && ptl2{0}           > 20 && (DiLepton_flavor != 2 || abs(mll{0}           -86.1876) > 20) && nbtag_goodbtag_Jet_bjet        >  0 && nvbs_jets        >= 2 && vbs_mjj        > 500 && vbs_detajj        > 2.5 && vbs_zepvv        < 1.0 && (mll{0}	       > 80 || thePuppiMET_ptJESUp	   > {1}) && thePuppiMET_ptJESUp	 > {2}".format(altMass,metCutA,metCutB))
        dfwwbvbscatUnclusteredUp[x] = dfwwbvbscatUnclusteredUp[x].Filter("mll{0}           > 20 && ptl1{0}           > 25 && ptl2{0}           > 20 && (DiLepton_flavor != 2 || abs(mll{0}           -86.1876) > 20) && nbtag_goodbtag_Jet_bjet        >  0 && nvbs_jets        >= 2 && vbs_mjj        > 500 && vbs_detajj        > 2.5 && vbs_zepvv        < 1.0 && (mll{0}	       > 80 || thePuppiMET_ptUnclusteredUp > {1}) && thePuppiMET_ptUnclusteredUp > {2}".format(altMass,metCutA,metCutB))
        ...
        dfwwvbscat[x]  = dfwwvbscat[x] .Filter("(mll{0} > 80 || thePuppiMET_pt > {1}) && thePuppiMET_pt > {2}".format(altMass,metCutA,metCutB), "thePuppiMET_pt > cut")
        dfwwbvbscat[x] = dfwwbvbscat[x].Filter("(mll{0} > 80 || thePuppiMET_pt > {1}) && thePuppiMET_pt > {2}".format(altMass,metCutA,metCutB), "thePuppiMET_pt > cut")
        ...
        histo[92][x] = dfwwvbscat[x].Filter("vbs_mjj < 900 && mll{0} <  80".format(altMass)).Histo1D(("histo_{0}_{1}".format(92,x), "histo_{0}_{1}".format(92,x),20,30, 230), "thePuppiMET_pt","weight")
        histo[93][x] = dfwwvbscat[x].Filter("vbs_mjj > 900 && mll{0} <  80".format(altMass)).Histo1D(("histo_{0}_{1}".format(93,x), "histo_{0}_{1}".format(93,x),20,30, 230), "thePuppiMET_pt","weight")
        ...
        dfwwjjcat .append(dfwwcat[x] .Filter("(mll{0} > 80 || thePuppiMET_pt > {1}) && thePuppiMET_pt > {2}".format(altMass,metCutA,metCutB), "thePuppiMET_pt > cut").Filter(VBSQCDSEL, "dijet non-vbf selection"))
        dfwwbjjcat.append(dfwwbcat[x].Filter("(mll{0} > 80 || thePuppiMET_pt > {1}) && thePuppiMET_pt > {2}".format(altMass,metCutA,metCutB), "thePuppiMET_pt > cut").Filter(VBSQCDSEL, "dijet non-vbf selection"))
