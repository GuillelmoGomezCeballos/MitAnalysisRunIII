...
def analysis(df,count,category,weight,year,PDType,isData,whichJob,nTheoryReplicas,genEventSumLHEScaleRenorm,genEventSumPSRenorm,ewkCorrWeights,wsWeights,puWeights,histoBTVEffEtaPtLF,histoBTVEffEtaPtCJ,histoBTVEffEtaPtBJ,histoFakeEtaPt_mu,histoFakeEtaPt_el,histoLepSFEtaPt_mu,histoLepSFEtaPt_el,histoTriggerSFEtaPt_0_0,histoTriggerSFEtaPt_0_1,histoTriggerSFEtaPt_0_2,histoTriggerSFEtaPt_0_3,histoTriggerSFEtaPt_1_0,histoTriggerSFEtaPt_1_1,histoTriggerSFEtaPt_1_2,histoTriggerSFEtaPt_1_3,histoTriggerSFEtaPt_2_0,histoTriggerSFEtaPt_2_1,histoTriggerSFEtaPt_2_2,histoTriggerSFEtaPt_2_3,histoTriggerSFEtaPt_3_0,histoTriggerSFEtaPt_3_1,histoTriggerSFEtaPt_3_2,histoTriggerSFEtaPt_3_3):
    ...
    for x in range(nCat):
        ...
        dfwwvbscatMuonMomUp     [x] = dfwwvbscatMuonMomUp     [x].Filter("mllMuonMomUp     > 20 && ptl1MuonMomUp     > 25 && ptl2MuonMomUp     > 20 && (DiLepton_flavor != 2 || abs(mllMuonMomUp     -86.1876) > 20) && nbtag_goodbtag_Jet_bjet        == 0 && nvbs_jets        >= 2 && vbs_mjj        > 500 && vbs_detajj        > 2.5 && vbs_zepvv        < 1.0 && thePuppiMET_pt              > {0}".format(metCut))
        dfwwvbscatElectronMomUp [x] = dfwwvbscatElectronMomUp [x].Filter("mllElectronMomUp > 20 && ptl1ElectronMomUp > 25 && ptl2ElectronMomUp > 20 && (DiLepton_flavor != 2 || abs(mllElectronMomUp -86.1876) > 20) && nbtag_goodbtag_Jet_bjet        == 0 && nvbs_jets        >= 2 && vbs_mjj        > 500 && vbs_detajj        > 2.5 && vbs_zepvv        < 1.0 && thePuppiMET_pt              > {0}".format(metCut))
        dfwwvbscatJes00Up       [x] = dfwwvbscatJes00Up       [x].Filter("mll{0}           > 20 && ptl1{0}           > 25 && ptl2{0}           > 20 && (DiLepton_flavor != 2 || abs(mll{0}           -86.1876) > 20) && nbtag_goodbtag_Jet_bjetJes00Up == 0 && nvbs_jetsJes00Up >= 2 && vbs_mjjJes00Up > 500 && vbs_detajjJes00Up > 2.5 && vbs_zepvvJes00Up < 1.0 && thePuppiMET_pt              > {1}".format(altMass,metCut))
        dfwwvbscatJes01Up       [x] = dfwwvbscatJes01Up       [x].Filter("mll{0}           > 20 && ptl1{0}           > 25 && ptl2{0}           > 20 && (DiLepton_flavor != 2 || abs(mll{0}           -86.1876) > 20) && nbtag_goodbtag_Jet_bjetJes01Up == 0 && nvbs_jetsJes01Up >= 2 && vbs_mjjJes01Up > 500 && vbs_detajjJes01Up > 2.5 && vbs_zepvvJes01Up < 1.0 && thePuppiMET_pt              > {1}".format(altMass,metCut))
        dfwwvbscatJes02Up       [x] = dfwwvbscatJes02Up       [x].Filter("mll{0}           > 20 && ptl1{0}           > 25 && ptl2{0}           > 20 && (DiLepton_flavor != 2 || abs(mll{0}           -86.1876) > 20) && nbtag_goodbtag_Jet_bjetJes02Up == 0 && nvbs_jetsJes02Up >= 2 && vbs_mjjJes02Up > 500 && vbs_detajjJes02Up > 2.5 && vbs_zepvvJes02Up < 1.0 && thePuppiMET_pt              > {1}".format(altMass,metCut))
        dfwwvbscatJes03Up       [x] = dfwwvbscatJes03Up       [x].Filter("mll{0}           > 20 && ptl1{0}           > 25 && ptl2{0}           > 20 && (DiLepton_flavor != 2 || abs(mll{0}           -86.1876) > 20) && nbtag_goodbtag_Jet_bjetJes03Up == 0 && nvbs_jetsJes03Up >= 2 && vbs_mjjJes03Up > 500 && vbs_detajjJes03Up > 2.5 && vbs_zepvvJes03Up < 1.0 && thePuppiMET_pt              > {1}".format(altMass,metCut))
        dfwwvbscatJes04Up       [x] = dfwwvbscatJes04Up       [x].Filter("mll{0}           > 20 && ptl1{0}           > 25 && ptl2{0}           > 20 && (DiLepton_flavor != 2 || abs(mll{0}           -86.1876) > 20) && nbtag_goodbtag_Jet_bjetJes04Up == 0 && nvbs_jetsJes04Up >= 2 && vbs_mjjJes04Up > 500 && vbs_detajjJes04Up > 2.5 && vbs_zepvvJes04Up < 1.0 && thePuppiMET_pt              > {1}".format(altMass,metCut))
        dfwwvbscatJes05Up       [x] = dfwwvbscatJes05Up       [x].Filter("mll{0}           > 20 && ptl1{0}           > 25 && ptl2{0}           > 20 && (DiLepton_flavor != 2 || abs(mll{0}           -86.1876) > 20) && nbtag_goodbtag_Jet_bjetJes05Up == 0 && nvbs_jetsJes05Up >= 2 && vbs_mjjJes05Up > 500 && vbs_detajjJes05Up > 2.5 && vbs_zepvvJes05Up < 1.0 && thePuppiMET_pt              > {1}".format(altMass,metCut))
        dfwwvbscatJes06Up       [x] = dfwwvbscatJes06Up       [x].Filter("mll{0}           > 20 && ptl1{0}           > 25 && ptl2{0}           > 20 && (DiLepton_flavor != 2 || abs(mll{0}           -86.1876) > 20) && nbtag_goodbtag_Jet_bjetJes06Up == 0 && nvbs_jetsJes06Up >= 2 && vbs_mjjJes06Up > 500 && vbs_detajjJes06Up > 2.5 && vbs_zepvvJes06Up < 1.0 && thePuppiMET_pt              > {1}".format(altMass,metCut))
        dfwwvbscatJes07Up       [x] = dfwwvbscatJes07Up       [x].Filter("mll{0}           > 20 && ptl1{0}           > 25 && ptl2{0}           > 20 && (DiLepton_flavor != 2 || abs(mll{0}           -86.1876) > 20) && nbtag_goodbtag_Jet_bjetJes07Up == 0 && nvbs_jetsJes07Up >= 2 && vbs_mjjJes07Up > 500 && vbs_detajjJes07Up > 2.5 && vbs_zepvvJes07Up < 1.0 && thePuppiMET_pt              > {1}".format(altMass,metCut))
        dfwwvbscatJes08Up       [x] = dfwwvbscatJes08Up       [x].Filter("mll{0}           > 20 && ptl1{0}           > 25 && ptl2{0}           > 20 && (DiLepton_flavor != 2 || abs(mll{0}           -86.1876) > 20) && nbtag_goodbtag_Jet_bjetJes08Up == 0 && nvbs_jetsJes08Up >= 2 && vbs_mjjJes08Up > 500 && vbs_detajjJes08Up > 2.5 && vbs_zepvvJes08Up < 1.0 && thePuppiMET_pt              > {1}".format(altMass,metCut))
        dfwwvbscatJes09Up       [x] = dfwwvbscatJes09Up       [x].Filter("mll{0}           > 20 && ptl1{0}           > 25 && ptl2{0}           > 20 && (DiLepton_flavor != 2 || abs(mll{0}           -86.1876) > 20) && nbtag_goodbtag_Jet_bjetJes09Up == 0 && nvbs_jetsJes09Up >= 2 && vbs_mjjJes09Up > 500 && vbs_detajjJes09Up > 2.5 && vbs_zepvvJes09Up < 1.0 && thePuppiMET_pt              > {1}".format(altMass,metCut))
        dfwwvbscatJes10Up       [x] = dfwwvbscatJes10Up       [x].Filter("mll{0}           > 20 && ptl1{0}           > 25 && ptl2{0}           > 20 && (DiLepton_flavor != 2 || abs(mll{0}           -86.1876) > 20) && nbtag_goodbtag_Jet_bjetJes10Up == 0 && nvbs_jetsJes10Up >= 2 && vbs_mjjJes10Up > 500 && vbs_detajjJes10Up > 2.5 && vbs_zepvvJes10Up < 1.0 && thePuppiMET_pt              > {1}".format(altMass,metCut))
        dfwwvbscatJes11Up       [x] = dfwwvbscatJes11Up       [x].Filter("mll{0}           > 20 && ptl1{0}           > 25 && ptl2{0}           > 20 && (DiLepton_flavor != 2 || abs(mll{0}           -86.1876) > 20) && nbtag_goodbtag_Jet_bjetJes11Up == 0 && nvbs_jetsJes11Up >= 2 && vbs_mjjJes11Up > 500 && vbs_detajjJes11Up > 2.5 && vbs_zepvvJes11Up < 1.0 && thePuppiMET_pt              > {1}".format(altMass,metCut))
        dfwwvbscatJes12Up       [x] = dfwwvbscatJes12Up       [x].Filter("mll{0}           > 20 && ptl1{0}           > 25 && ptl2{0}           > 20 && (DiLepton_flavor != 2 || abs(mll{0}           -86.1876) > 20) && nbtag_goodbtag_Jet_bjetJes12Up == 0 && nvbs_jetsJes12Up >= 2 && vbs_mjjJes12Up > 500 && vbs_detajjJes12Up > 2.5 && vbs_zepvvJes12Up < 1.0 && thePuppiMET_pt              > {1}".format(altMass,metCut))
        dfwwvbscatJes13Up       [x] = dfwwvbscatJes13Up       [x].Filter("mll{0}           > 20 && ptl1{0}           > 25 && ptl2{0}           > 20 && (DiLepton_flavor != 2 || abs(mll{0}           -86.1876) > 20) && nbtag_goodbtag_Jet_bjetJes13Up == 0 && nvbs_jetsJes13Up >= 2 && vbs_mjjJes13Up > 500 && vbs_detajjJes13Up > 2.5 && vbs_zepvvJes13Up < 1.0 && thePuppiMET_pt              > {1}".format(altMass,metCut))
        dfwwvbscatJes14Up       [x] = dfwwvbscatJes14Up       [x].Filter("mll{0}           > 20 && ptl1{0}           > 25 && ptl2{0}           > 20 && (DiLepton_flavor != 2 || abs(mll{0}           -86.1876) > 20) && nbtag_goodbtag_Jet_bjetJes14Up == 0 && nvbs_jetsJes14Up >= 2 && vbs_mjjJes14Up > 500 && vbs_detajjJes14Up > 2.5 && vbs_zepvvJes14Up < 1.0 && thePuppiMET_pt              > {1}".format(altMass,metCut))
        dfwwvbscatJes15Up       [x] = dfwwvbscatJes15Up       [x].Filter("mll{0}           > 20 && ptl1{0}           > 25 && ptl2{0}           > 20 && (DiLepton_flavor != 2 || abs(mll{0}           -86.1876) > 20) && nbtag_goodbtag_Jet_bjetJes15Up == 0 && nvbs_jetsJes15Up >= 2 && vbs_mjjJes15Up > 500 && vbs_detajjJes15Up > 2.5 && vbs_zepvvJes15Up < 1.0 && thePuppiMET_pt              > {1}".format(altMass,metCut))
        dfwwvbscatJes16Up       [x] = dfwwvbscatJes16Up       [x].Filter("mll{0}           > 20 && ptl1{0}           > 25 && ptl2{0}           > 20 && (DiLepton_flavor != 2 || abs(mll{0}           -86.1876) > 20) && nbtag_goodbtag_Jet_bjetJes16Up == 0 && nvbs_jetsJes16Up >= 2 && vbs_mjjJes16Up > 500 && vbs_detajjJes16Up > 2.5 && vbs_zepvvJes16Up < 1.0 && thePuppiMET_pt              > {1}".format(altMass,metCut))
        dfwwvbscatJes17Up       [x] = dfwwvbscatJes17Up       [x].Filter("mll{0}           > 20 && ptl1{0}           > 25 && ptl2{0}           > 20 && (DiLepton_flavor != 2 || abs(mll{0}           -86.1876) > 20) && nbtag_goodbtag_Jet_bjetJes17Up == 0 && nvbs_jetsJes17Up >= 2 && vbs_mjjJes17Up > 500 && vbs_detajjJes17Up > 2.5 && vbs_zepvvJes17Up < 1.0 && thePuppiMET_pt              > {1}".format(altMass,metCut))
        dfwwvbscatJes18Up       [x] = dfwwvbscatJes18Up       [x].Filter("mll{0}           > 20 && ptl1{0}           > 25 && ptl2{0}           > 20 && (DiLepton_flavor != 2 || abs(mll{0}           -86.1876) > 20) && nbtag_goodbtag_Jet_bjetJes18Up == 0 && nvbs_jetsJes18Up >= 2 && vbs_mjjJes18Up > 500 && vbs_detajjJes18Up > 2.5 && vbs_zepvvJes18Up < 1.0 && thePuppiMET_pt              > {1}".format(altMass,metCut))
        dfwwvbscatJes19Up       [x] = dfwwvbscatJes19Up       [x].Filter("mll{0}           > 20 && ptl1{0}           > 25 && ptl2{0}           > 20 && (DiLepton_flavor != 2 || abs(mll{0}           -86.1876) > 20) && nbtag_goodbtag_Jet_bjetJes19Up == 0 && nvbs_jetsJes19Up >= 2 && vbs_mjjJes19Up > 500 && vbs_detajjJes19Up > 2.5 && vbs_zepvvJes19Up < 1.0 && thePuppiMET_pt              > {1}".format(altMass,metCut))
        dfwwvbscatJes20Up       [x] = dfwwvbscatJes20Up       [x].Filter("mll{0}           > 20 && ptl1{0}           > 25 && ptl2{0}           > 20 && (DiLepton_flavor != 2 || abs(mll{0}           -86.1876) > 20) && nbtag_goodbtag_Jet_bjetJes20Up == 0 && nvbs_jetsJes20Up >= 2 && vbs_mjjJes20Up > 500 && vbs_detajjJes20Up > 2.5 && vbs_zepvvJes20Up < 1.0 && thePuppiMET_pt              > {1}".format(altMass,metCut))
        dfwwvbscatJes21Up       [x] = dfwwvbscatJes21Up       [x].Filter("mll{0}           > 20 && ptl1{0}           > 25 && ptl2{0}           > 20 && (DiLepton_flavor != 2 || abs(mll{0}           -86.1876) > 20) && nbtag_goodbtag_Jet_bjetJes21Up == 0 && nvbs_jetsJes21Up >= 2 && vbs_mjjJes21Up > 500 && vbs_detajjJes21Up > 2.5 && vbs_zepvvJes21Up < 1.0 && thePuppiMET_pt              > {1}".format(altMass,metCut))
        dfwwvbscatJes22Up       [x] = dfwwvbscatJes22Up       [x].Filter("mll{0}           > 20 && ptl1{0}           > 25 && ptl2{0}           > 20 && (DiLepton_flavor != 2 || abs(mll{0}           -86.1876) > 20) && nbtag_goodbtag_Jet_bjetJes22Up == 0 && nvbs_jetsJes22Up >= 2 && vbs_mjjJes22Up > 500 && vbs_detajjJes22Up > 2.5 && vbs_zepvvJes22Up < 1.0 && thePuppiMET_pt              > {1}".format(altMass,metCut))
        dfwwvbscatJes23Up       [x] = dfwwvbscatJes23Up       [x].Filter("mll{0}           > 20 && ptl1{0}           > 25 && ptl2{0}           > 20 && (DiLepton_flavor != 2 || abs(mll{0}           -86.1876) > 20) && nbtag_goodbtag_Jet_bjetJes23Up == 0 && nvbs_jetsJes23Up >= 2 && vbs_mjjJes23Up > 500 && vbs_detajjJes23Up > 2.5 && vbs_zepvvJes23Up < 1.0 && thePuppiMET_pt              > {1}".format(altMass,metCut))
        dfwwvbscatJes24Up       [x] = dfwwvbscatJes24Up       [x].Filter("mll{0}           > 20 && ptl1{0}           > 25 && ptl2{0}           > 20 && (DiLepton_flavor != 2 || abs(mll{0}           -86.1876) > 20) && nbtag_goodbtag_Jet_bjetJes24Up == 0 && nvbs_jetsJes24Up >= 2 && vbs_mjjJes24Up > 500 && vbs_detajjJes24Up > 2.5 && vbs_zepvvJes24Up < 1.0 && thePuppiMET_pt              > {1}".format(altMass,metCut))
        dfwwvbscatJes25Up       [x] = dfwwvbscatJes25Up       [x].Filter("mll{0}           > 20 && ptl1{0}           > 25 && ptl2{0}           > 20 && (DiLepton_flavor != 2 || abs(mll{0}           -86.1876) > 20) && nbtag_goodbtag_Jet_bjetJes25Up == 0 && nvbs_jetsJes25Up >= 2 && vbs_mjjJes25Up > 500 && vbs_detajjJes25Up > 2.5 && vbs_zepvvJes25Up < 1.0 && thePuppiMET_pt              > {1}".format(altMass,metCut))
        dfwwvbscatJes26Up       [x] = dfwwvbscatJes26Up       [x].Filter("mll{0}           > 20 && ptl1{0}           > 25 && ptl2{0}           > 20 && (DiLepton_flavor != 2 || abs(mll{0}           -86.1876) > 20) && nbtag_goodbtag_Jet_bjetJes26Up == 0 && nvbs_jetsJes26Up >= 2 && vbs_mjjJes26Up > 500 && vbs_detajjJes26Up > 2.5 && vbs_zepvvJes26Up < 1.0 && thePuppiMET_pt              > {1}".format(altMass,metCut))
        dfwwvbscatJes27Up       [x] = dfwwvbscatJes27Up       [x].Filter("mll{0}           > 20 && ptl1{0}           > 25 && ptl2{0}           > 20 && (DiLepton_flavor != 2 || abs(mll{0}           -86.1876) > 20) && nbtag_goodbtag_Jet_bjetJes27Up == 0 && nvbs_jetsJes27Up >= 2 && vbs_mjjJes27Up > 500 && vbs_detajjJes27Up > 2.5 && vbs_zepvvJes27Up < 1.0 && thePuppiMET_pt              > {1}".format(altMass,metCut))
        dfwwvbscatJerUp         [x] = dfwwvbscatJerUp         [x].Filter("mll{0}           > 20 && ptl1{0}           > 25 && ptl2{0}           > 20 && (DiLepton_flavor != 2 || abs(mll{0}           -86.1876) > 20) && nbtag_goodbtag_Jet_bjetJerUp   == 0 && nvbs_jetsJerUp   >= 2 && vbs_mjjJerUp   > 500 && vbs_detajjJerUp   > 2.5 && vbs_zepvvJerUp   < 1.0 && thePuppiMET_pt              > {1}".format(altMass,metCut))
        dfwwvbscatJERUp         [x] = dfwwvbscatJERUp         [x].Filter("mll{0}           > 20 && ptl1{0}           > 25 && ptl2{0}           > 20 && (DiLepton_flavor != 2 || abs(mll{0}           -86.1876) > 20) && nbtag_goodbtag_Jet_bjet        == 0 && nvbs_jets        >= 2 && vbs_mjj        > 500 && vbs_detajj        > 2.5 && vbs_zepvv        < 1.0 && thePuppiMET_ptJERUp         > {1}".format(altMass,metCut))
        dfwwvbscatJESUp         [x] = dfwwvbscatJESUp         [x].Filter("mll{0}           > 20 && ptl1{0}           > 25 && ptl2{0}           > 20 && (DiLepton_flavor != 2 || abs(mll{0}           -86.1876) > 20) && nbtag_goodbtag_Jet_bjet        == 0 && nvbs_jets        >= 2 && vbs_mjj        > 500 && vbs_detajj        > 2.5 && vbs_zepvv        < 1.0 && thePuppiMET_ptJESUp         > {1}".format(altMass,metCut))
        dfwwvbscatUnclusteredUp [x] = dfwwvbscatUnclusteredUp [x].Filter("mll{0}           > 20 && ptl1{0}           > 25 && ptl2{0}           > 20 && (DiLepton_flavor != 2 || abs(mll{0}           -86.1876) > 20) && nbtag_goodbtag_Jet_bjet        == 0 && nvbs_jets        >= 2 && vbs_mjj        > 500 && vbs_detajj        > 2.5 && vbs_zepvv        < 1.0 && thePuppiMET_ptUnclusteredUp > {1}".format(altMass,metCut))

        dfwwbvbscatMuonMomUp    [x] = dfwwbvbscatMuonMomUp    [x].Filter("mllMuonMomUp     > 20 && ptl1MuonMomUp     > 25 && ptl2MuonMomUp     > 20 && (DiLepton_flavor != 2 || abs(mllMuonMomUp     -86.1876) > 20) && nbtag_goodbtag_Jet_bjet        >  0 && nvbs_jets        >= 2 && vbs_mjj        > 500 && vbs_detajj        > 2.5 && vbs_zepvv        < 1.0 && thePuppiMET_pt              > {0}".format(metCut))
        dfwwbvbscatElectronMomUp[x] = dfwwbvbscatElectronMomUp[x].Filter("mllElectronMomUp > 20 && ptl1ElectronMomUp > 25 && ptl2ElectronMomUp > 20 && (DiLepton_flavor != 2 || abs(mllElectronMomUp -86.1876) > 20) && nbtag_goodbtag_Jet_bjet        >  0 && nvbs_jets        >= 2 && vbs_mjj        > 500 && vbs_detajj        > 2.5 && vbs_zepvv        < 1.0 && thePuppiMET_pt              > {0}".format(metCut))
        dfwwbvbscatJes00Up      [x] = dfwwbvbscatJes00Up      [x].Filter("mll{0}           > 20 && ptl1{0}           > 25 && ptl2{0}           > 20 && (DiLepton_flavor != 2 || abs(mll{0}           -86.1876) > 20) && nbtag_goodbtag_Jet_bjetJes00Up >  0 && nvbs_jetsJes00Up >= 2 && vbs_mjjJes00Up > 500 && vbs_detajjJes00Up > 2.5 && vbs_zepvvJes00Up < 1.0 && thePuppiMET_pt              > {1}".format(altMass,metCut))
        dfwwbvbscatJes01Up      [x] = dfwwbvbscatJes01Up      [x].Filter("mll{0}           > 20 && ptl1{0}           > 25 && ptl2{0}           > 20 && (DiLepton_flavor != 2 || abs(mll{0}           -86.1876) > 20) && nbtag_goodbtag_Jet_bjetJes01Up >  0 && nvbs_jetsJes01Up >= 2 && vbs_mjjJes01Up > 500 && vbs_detajjJes01Up > 2.5 && vbs_zepvvJes01Up < 1.0 && thePuppiMET_pt              > {1}".format(altMass,metCut))
        dfwwbvbscatJes02Up      [x] = dfwwbvbscatJes02Up      [x].Filter("mll{0}           > 20 && ptl1{0}           > 25 && ptl2{0}           > 20 && (DiLepton_flavor != 2 || abs(mll{0}           -86.1876) > 20) && nbtag_goodbtag_Jet_bjetJes02Up >  0 && nvbs_jetsJes02Up >= 2 && vbs_mjjJes02Up > 500 && vbs_detajjJes02Up > 2.5 && vbs_zepvvJes02Up < 1.0 && thePuppiMET_pt              > {1}".format(altMass,metCut))
        dfwwbvbscatJes03Up      [x] = dfwwbvbscatJes03Up      [x].Filter("mll{0}           > 20 && ptl1{0}           > 25 && ptl2{0}           > 20 && (DiLepton_flavor != 2 || abs(mll{0}           -86.1876) > 20) && nbtag_goodbtag_Jet_bjetJes03Up >  0 && nvbs_jetsJes03Up >= 2 && vbs_mjjJes03Up > 500 && vbs_detajjJes03Up > 2.5 && vbs_zepvvJes03Up < 1.0 && thePuppiMET_pt              > {1}".format(altMass,metCut))
        dfwwbvbscatJes04Up      [x] = dfwwbvbscatJes04Up      [x].Filter("mll{0}           > 20 && ptl1{0}           > 25 && ptl2{0}           > 20 && (DiLepton_flavor != 2 || abs(mll{0}           -86.1876) > 20) && nbtag_goodbtag_Jet_bjetJes04Up >  0 && nvbs_jetsJes04Up >= 2 && vbs_mjjJes04Up > 500 && vbs_detajjJes04Up > 2.5 && vbs_zepvvJes04Up < 1.0 && thePuppiMET_pt              > {1}".format(altMass,metCut))
        dfwwbvbscatJes05Up      [x] = dfwwbvbscatJes05Up      [x].Filter("mll{0}           > 20 && ptl1{0}           > 25 && ptl2{0}           > 20 && (DiLepton_flavor != 2 || abs(mll{0}           -86.1876) > 20) && nbtag_goodbtag_Jet_bjetJes05Up >  0 && nvbs_jetsJes05Up >= 2 && vbs_mjjJes05Up > 500 && vbs_detajjJes05Up > 2.5 && vbs_zepvvJes05Up < 1.0 && thePuppiMET_pt              > {1}".format(altMass,metCut))
        dfwwbvbscatJes06Up      [x] = dfwwbvbscatJes06Up      [x].Filter("mll{0}           > 20 && ptl1{0}           > 25 && ptl2{0}           > 20 && (DiLepton_flavor != 2 || abs(mll{0}           -86.1876) > 20) && nbtag_goodbtag_Jet_bjetJes06Up >  0 && nvbs_jetsJes06Up >= 2 && vbs_mjjJes06Up > 500 && vbs_detajjJes06Up > 2.5 && vbs_zepvvJes06Up < 1.0 && thePuppiMET_pt              > {1}".format(altMass,metCut))
        dfwwbvbscatJes07Up      [x] = dfwwbvbscatJes07Up      [x].Filter("mll{0}           > 20 && ptl1{0}           > 25 && ptl2{0}           > 20 && (DiLepton_flavor != 2 || abs(mll{0}           -86.1876) > 20) && nbtag_goodbtag_Jet_bjetJes07Up >  0 && nvbs_jetsJes07Up >= 2 && vbs_mjjJes07Up > 500 && vbs_detajjJes07Up > 2.5 && vbs_zepvvJes07Up < 1.0 && thePuppiMET_pt              > {1}".format(altMass,metCut))
        dfwwbvbscatJes08Up      [x] = dfwwbvbscatJes08Up      [x].Filter("mll{0}           > 20 && ptl1{0}           > 25 && ptl2{0}           > 20 && (DiLepton_flavor != 2 || abs(mll{0}           -86.1876) > 20) && nbtag_goodbtag_Jet_bjetJes08Up >  0 && nvbs_jetsJes08Up >= 2 && vbs_mjjJes08Up > 500 && vbs_detajjJes08Up > 2.5 && vbs_zepvvJes08Up < 1.0 && thePuppiMET_pt              > {1}".format(altMass,metCut))
        dfwwbvbscatJes09Up      [x] = dfwwbvbscatJes09Up      [x].Filter("mll{0}           > 20 && ptl1{0}           > 25 && ptl2{0}           > 20 && (DiLepton_flavor != 2 || abs(mll{0}           -86.1876) > 20) && nbtag_goodbtag_Jet_bjetJes09Up >  0 && nvbs_jetsJes09Up >= 2 && vbs_mjjJes09Up > 500 && vbs_detajjJes09Up > 2.5 && vbs_zepvvJes09Up < 1.0 && thePuppiMET_pt              > {1}".format(altMass,metCut))
        dfwwbvbscatJes10Up      [x] = dfwwbvbscatJes10Up      [x].Filter("mll{0}           > 20 && ptl1{0}           > 25 && ptl2{0}           > 20 && (DiLepton_flavor != 2 || abs(mll{0}           -86.1876) > 20) && nbtag_goodbtag_Jet_bjetJes10Up >  0 && nvbs_jetsJes10Up >= 2 && vbs_mjjJes10Up > 500 && vbs_detajjJes10Up > 2.5 && vbs_zepvvJes10Up < 1.0 && thePuppiMET_pt              > {1}".format(altMass,metCut))
        dfwwbvbscatJes11Up      [x] = dfwwbvbscatJes11Up      [x].Filter("mll{0}           > 20 && ptl1{0}           > 25 && ptl2{0}           > 20 && (DiLepton_flavor != 2 || abs(mll{0}           -86.1876) > 20) && nbtag_goodbtag_Jet_bjetJes11Up >  0 && nvbs_jetsJes11Up >= 2 && vbs_mjjJes11Up > 500 && vbs_detajjJes11Up > 2.5 && vbs_zepvvJes11Up < 1.0 && thePuppiMET_pt              > {1}".format(altMass,metCut))
        dfwwbvbscatJes12Up      [x] = dfwwbvbscatJes12Up      [x].Filter("mll{0}           > 20 && ptl1{0}           > 25 && ptl2{0}           > 20 && (DiLepton_flavor != 2 || abs(mll{0}           -86.1876) > 20) && nbtag_goodbtag_Jet_bjetJes12Up >  0 && nvbs_jetsJes12Up >= 2 && vbs_mjjJes12Up > 500 && vbs_detajjJes12Up > 2.5 && vbs_zepvvJes12Up < 1.0 && thePuppiMET_pt              > {1}".format(altMass,metCut))
        dfwwbvbscatJes13Up      [x] = dfwwbvbscatJes13Up      [x].Filter("mll{0}           > 20 && ptl1{0}           > 25 && ptl2{0}           > 20 && (DiLepton_flavor != 2 || abs(mll{0}           -86.1876) > 20) && nbtag_goodbtag_Jet_bjetJes13Up >  0 && nvbs_jetsJes13Up >= 2 && vbs_mjjJes13Up > 500 && vbs_detajjJes13Up > 2.5 && vbs_zepvvJes13Up < 1.0 && thePuppiMET_pt              > {1}".format(altMass,metCut))
        dfwwbvbscatJes14Up      [x] = dfwwbvbscatJes14Up      [x].Filter("mll{0}           > 20 && ptl1{0}           > 25 && ptl2{0}           > 20 && (DiLepton_flavor != 2 || abs(mll{0}           -86.1876) > 20) && nbtag_goodbtag_Jet_bjetJes14Up >  0 && nvbs_jetsJes14Up >= 2 && vbs_mjjJes14Up > 500 && vbs_detajjJes14Up > 2.5 && vbs_zepvvJes14Up < 1.0 && thePuppiMET_pt              > {1}".format(altMass,metCut))
        dfwwbvbscatJes15Up      [x] = dfwwbvbscatJes15Up      [x].Filter("mll{0}           > 20 && ptl1{0}           > 25 && ptl2{0}           > 20 && (DiLepton_flavor != 2 || abs(mll{0}           -86.1876) > 20) && nbtag_goodbtag_Jet_bjetJes15Up >  0 && nvbs_jetsJes15Up >= 2 && vbs_mjjJes15Up > 500 && vbs_detajjJes15Up > 2.5 && vbs_zepvvJes15Up < 1.0 && thePuppiMET_pt              > {1}".format(altMass,metCut))
        dfwwbvbscatJes16Up      [x] = dfwwbvbscatJes16Up      [x].Filter("mll{0}           > 20 && ptl1{0}           > 25 && ptl2{0}           > 20 && (DiLepton_flavor != 2 || abs(mll{0}           -86.1876) > 20) && nbtag_goodbtag_Jet_bjetJes16Up >  0 && nvbs_jetsJes16Up >= 2 && vbs_mjjJes16Up > 500 && vbs_detajjJes16Up > 2.5 && vbs_zepvvJes16Up < 1.0 && thePuppiMET_pt              > {1}".format(altMass,metCut))
        dfwwbvbscatJes17Up      [x] = dfwwbvbscatJes17Up      [x].Filter("mll{0}           > 20 && ptl1{0}           > 25 && ptl2{0}           > 20 && (DiLepton_flavor != 2 || abs(mll{0}           -86.1876) > 20) && nbtag_goodbtag_Jet_bjetJes17Up >  0 && nvbs_jetsJes17Up >= 2 && vbs_mjjJes17Up > 500 && vbs_detajjJes17Up > 2.5 && vbs_zepvvJes17Up < 1.0 && thePuppiMET_pt              > {1}".format(altMass,metCut))
        dfwwbvbscatJes18Up      [x] = dfwwbvbscatJes18Up      [x].Filter("mll{0}           > 20 && ptl1{0}           > 25 && ptl2{0}           > 20 && (DiLepton_flavor != 2 || abs(mll{0}           -86.1876) > 20) && nbtag_goodbtag_Jet_bjetJes18Up >  0 && nvbs_jetsJes18Up >= 2 && vbs_mjjJes18Up > 500 && vbs_detajjJes18Up > 2.5 && vbs_zepvvJes18Up < 1.0 && thePuppiMET_pt              > {1}".format(altMass,metCut))
        dfwwbvbscatJes19Up      [x] = dfwwbvbscatJes19Up      [x].Filter("mll{0}           > 20 && ptl1{0}           > 25 && ptl2{0}           > 20 && (DiLepton_flavor != 2 || abs(mll{0}           -86.1876) > 20) && nbtag_goodbtag_Jet_bjetJes19Up >  0 && nvbs_jetsJes19Up >= 2 && vbs_mjjJes19Up > 500 && vbs_detajjJes19Up > 2.5 && vbs_zepvvJes19Up < 1.0 && thePuppiMET_pt              > {1}".format(altMass,metCut))
        dfwwbvbscatJes20Up      [x] = dfwwbvbscatJes20Up      [x].Filter("mll{0}           > 20 && ptl1{0}           > 25 && ptl2{0}           > 20 && (DiLepton_flavor != 2 || abs(mll{0}           -86.1876) > 20) && nbtag_goodbtag_Jet_bjetJes20Up >  0 && nvbs_jetsJes20Up >= 2 && vbs_mjjJes20Up > 500 && vbs_detajjJes20Up > 2.5 && vbs_zepvvJes20Up < 1.0 && thePuppiMET_pt              > {1}".format(altMass,metCut))
        dfwwbvbscatJes21Up      [x] = dfwwbvbscatJes21Up      [x].Filter("mll{0}           > 20 && ptl1{0}           > 25 && ptl2{0}           > 20 && (DiLepton_flavor != 2 || abs(mll{0}           -86.1876) > 20) && nbtag_goodbtag_Jet_bjetJes21Up >  0 && nvbs_jetsJes21Up >= 2 && vbs_mjjJes21Up > 500 && vbs_detajjJes21Up > 2.5 && vbs_zepvvJes21Up < 1.0 && thePuppiMET_pt              > {1}".format(altMass,metCut))
        dfwwbvbscatJes22Up      [x] = dfwwbvbscatJes22Up      [x].Filter("mll{0}           > 20 && ptl1{0}           > 25 && ptl2{0}           > 20 && (DiLepton_flavor != 2 || abs(mll{0}           -86.1876) > 20) && nbtag_goodbtag_Jet_bjetJes22Up >  0 && nvbs_jetsJes22Up >= 2 && vbs_mjjJes22Up > 500 && vbs_detajjJes22Up > 2.5 && vbs_zepvvJes22Up < 1.0 && thePuppiMET_pt              > {1}".format(altMass,metCut))
        dfwwbvbscatJes23Up      [x] = dfwwbvbscatJes23Up      [x].Filter("mll{0}           > 20 && ptl1{0}           > 25 && ptl2{0}           > 20 && (DiLepton_flavor != 2 || abs(mll{0}           -86.1876) > 20) && nbtag_goodbtag_Jet_bjetJes23Up >  0 && nvbs_jetsJes23Up >= 2 && vbs_mjjJes23Up > 500 && vbs_detajjJes23Up > 2.5 && vbs_zepvvJes23Up < 1.0 && thePuppiMET_pt              > {1}".format(altMass,metCut))
        dfwwbvbscatJes24Up      [x] = dfwwbvbscatJes24Up      [x].Filter("mll{0}           > 20 && ptl1{0}           > 25 && ptl2{0}           > 20 && (DiLepton_flavor != 2 || abs(mll{0}           -86.1876) > 20) && nbtag_goodbtag_Jet_bjetJes24Up >  0 && nvbs_jetsJes24Up >= 2 && vbs_mjjJes24Up > 500 && vbs_detajjJes24Up > 2.5 && vbs_zepvvJes24Up < 1.0 && thePuppiMET_pt              > {1}".format(altMass,metCut))
        dfwwbvbscatJes25Up      [x] = dfwwbvbscatJes25Up      [x].Filter("mll{0}           > 20 && ptl1{0}           > 25 && ptl2{0}           > 20 && (DiLepton_flavor != 2 || abs(mll{0}           -86.1876) > 20) && nbtag_goodbtag_Jet_bjetJes25Up >  0 && nvbs_jetsJes25Up >= 2 && vbs_mjjJes25Up > 500 && vbs_detajjJes25Up > 2.5 && vbs_zepvvJes25Up < 1.0 && thePuppiMET_pt              > {1}".format(altMass,metCut))
        dfwwbvbscatJes26Up      [x] = dfwwbvbscatJes26Up      [x].Filter("mll{0}           > 20 && ptl1{0}           > 25 && ptl2{0}           > 20 && (DiLepton_flavor != 2 || abs(mll{0}           -86.1876) > 20) && nbtag_goodbtag_Jet_bjetJes26Up >  0 && nvbs_jetsJes26Up >= 2 && vbs_mjjJes26Up > 500 && vbs_detajjJes26Up > 2.5 && vbs_zepvvJes26Up < 1.0 && thePuppiMET_pt              > {1}".format(altMass,metCut))
        dfwwbvbscatJes27Up      [x] = dfwwbvbscatJes27Up      [x].Filter("mll{0}           > 20 && ptl1{0}           > 25 && ptl2{0}           > 20 && (DiLepton_flavor != 2 || abs(mll{0}           -86.1876) > 20) && nbtag_goodbtag_Jet_bjetJes27Up >  0 && nvbs_jetsJes27Up >= 2 && vbs_mjjJes27Up > 500 && vbs_detajjJes27Up > 2.5 && vbs_zepvvJes27Up < 1.0 && thePuppiMET_pt              > {1}".format(altMass,metCut))
        dfwwbvbscatJerUp        [x] = dfwwbvbscatJerUp        [x].Filter("mll{0}           > 20 && ptl1{0}           > 25 && ptl2{0}           > 20 && (DiLepton_flavor != 2 || abs(mll{0}           -86.1876) > 20) && nbtag_goodbtag_Jet_bjetJerUp   >  0 && nvbs_jetsJerUp   >= 2 && vbs_mjjJerUp   > 500 && vbs_detajjJerUp   > 2.5 && vbs_zepvvJerUp   < 1.0 && thePuppiMET_pt              > {1}".format(altMass,metCut))
        dfwwbvbscatJERUp        [x] = dfwwbvbscatJERUp        [x].Filter("mll{0}           > 20 && ptl1{0}           > 25 && ptl2{0}           > 20 && (DiLepton_flavor != 2 || abs(mll{0}           -86.1876) > 20) && nbtag_goodbtag_Jet_bjet        >  0 && nvbs_jets        >= 2 && vbs_mjj        > 500 && vbs_detajj        > 2.5 && vbs_zepvv        < 1.0 && thePuppiMET_ptJERUp         > {1}".format(altMass,metCut))
        dfwwbvbscatJESUp        [x] = dfwwbvbscatJESUp        [x].Filter("mll{0}           > 20 && ptl1{0}           > 25 && ptl2{0}           > 20 && (DiLepton_flavor != 2 || abs(mll{0}           -86.1876) > 20) && nbtag_goodbtag_Jet_bjet        >  0 && nvbs_jets        >= 2 && vbs_mjj        > 500 && vbs_detajj        > 2.5 && vbs_zepvv        < 1.0 && thePuppiMET_ptJESUp         > {1}".format(altMass,metCut))
        dfwwbvbscatUnclusteredUp[x] = dfwwbvbscatUnclusteredUp[x].Filter("mll{0}           > 20 && ptl1{0}           > 25 && ptl2{0}           > 20 && (DiLepton_flavor != 2 || abs(mll{0}           -86.1876) > 20) && nbtag_goodbtag_Jet_bjet        >  0 && nvbs_jets        >= 2 && vbs_mjj        > 500 && vbs_detajj        > 2.5 && vbs_zepvv        < 1.0 && thePuppiMET_ptUnclusteredUp > {1}".format(altMass,metCut))
        ...
        histo[86][x] = dfwwvbscat[x].Filter("vbs_mjj < 1300 && mll{0} < 160".format(altMass)).Histo1D(("histo_{0}_{1}".format(86,x), "histo_{0}_{1}".format(86,x),28, 20, 160), "mll{0}".format(altMass),"weight")
        histo[87][x] = dfwwvbscat[x].Filter("vbs_mjj > 1300 && mll{0} < 160".format(altMass)).Histo1D(("histo_{0}_{1}".format(87,x), "histo_{0}_{1}".format(87,x),28, 20, 160), "mll{0}".format(altMass),"weight")
        histo[88][x] = dfwwvbscat[x].Filter("vbs_mjj < 1300 && mll{0} <  80".format(altMass)).Histo1D(("histo_{0}_{1}".format(88,x), "histo_{0}_{1}".format(88,x),4,-0.5, 3.5), "ltype","weight")
        histo[89][x] = dfwwvbscat[x].Filter("vbs_mjj > 1300 && mll{0} <  80".format(altMass)).Histo1D(("histo_{0}_{1}".format(89,x), "histo_{0}_{1}".format(89,x),4,-0.5, 3.5), "ltype","weight")
        histo[90][x] = dfwwvbscat[x].Filter("vbs_mjj < 1300 && mll{0} <  80".format(altMass)).Histo1D(("histo_{0}_{1}".format(90,x), "histo_{0}_{1}".format(90,x),20, 0, 200), "ptll{0}".format(altMass),"weight")
        histo[91][x] = dfwwvbscat[x].Filter("vbs_mjj > 1300 && mll{0} <  80".format(altMass)).Histo1D(("histo_{0}_{1}".format(91,x), "histo_{0}_{1}".format(91,x),20, 0, 200), "ptll{0}".format(altMass),"weight")
        histo[92][x] = dfwwvbscat[x].Filter("vbs_mjj < 1300 && mll{0} <  80".format(altMass)).Histo1D(("histo_{0}_{1}".format(92,x), "histo_{0}_{1}".format(92,x),20,30, 230), "thePuppiMET_pt","weight")
        histo[93][x] = dfwwvbscat[x].Filter("vbs_mjj > 1300 && mll{0} <  80".format(altMass)).Histo1D(("histo_{0}_{1}".format(93,x), "histo_{0}_{1}".format(93,x),20,30, 230), "thePuppiMET_pt","weight")
        histo[94][x] = dfwwvbscat[x].Filter("mll{0} < 160 && ltype == 0    ".format(altMass)).Histo1D(("histo_{0}_{1}".format(94,x), "histo_{0}_{1}".format(94,x),28, 20, 160), "mll{0}".format(altMass),"weight")
        histo[95][x] = dfwwvbscat[x].Filter("mll{0} < 160 && ltype == 1    ".format(altMass)).Histo1D(("histo_{0}_{1}".format(95,x), "histo_{0}_{1}".format(95,x),28, 20, 160), "mll{0}".format(altMass),"weight")
        histo[96][x] = dfwwvbscat[x].Filter("mll{0} < 160 && ltype == 2    ".format(altMass)).Histo1D(("histo_{0}_{1}".format(96,x), "histo_{0}_{1}".format(96,x),28, 20, 160), "mll{0}".format(altMass),"weight")
        histo[97][x] = dfwwvbscat[x].Filter("mll{0} < 160 && ltype == 3    ".format(altMass)).Histo1D(("histo_{0}_{1}".format(97,x), "histo_{0}_{1}".format(97,x),28, 20, 160), "mll{0}".format(altMass),"weight")
