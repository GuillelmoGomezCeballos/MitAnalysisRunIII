...
if(year==20220):
    ...
    ROOT.gInterpreter.ProcessLine('corr.eval_electronTRKSF((char*)"2024", (char*)"sf", (char*)"Reco20to75", 1.1, 20.0,0.3)')
    ROOT.gInterpreter.ProcessLine('corr.eval_electronTRKSF((char*)"2024", (char*)"sf", (char*)"RecoAbove75", 1.1, 75.0,0.3)')
