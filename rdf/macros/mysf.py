...
if(year==20220):
    ...
    ROOT.gInterpreter.ProcessLine('corr.eval_electronSF((char*)"2022Re-recoBCD", (char*)"sf", (char*)"wp80iso", 1.1, 34.0,0.3)')
    ROOT.gInterpreter.ProcessLine('corr.eval_electronSF((char*)"2022Re-recoBCD", (char*)"sfup", (char*)"wp80iso", 1.1, 34.0,0.3)')
    ROOT.gInterpreter.ProcessLine('corr.eval_electronSF((char*)"2022Re-recoBCD", (char*)"sfdown", (char*)"Medium", 1.1, 34.0,0.3)')
    ROOT.gInterpreter.ProcessLine('corr.eval_electronSF((char*)"2022Re-recoBCD", (char*)"sf", (char*)"RecoBelow20", 1.1, 19.999,0.3)')
    ROOT.gInterpreter.ProcessLine('corr.eval_electronSF((char*)"2022Re-recoBCD", (char*)"sf", (char*)"Reco20to75", 1.1, 20.0,0.3)')
    ROOT.gInterpreter.ProcessLine('corr.eval_electronSF((char*)"2022Re-recoBCD", (char*)"sf", (char*)"RecoAbove75", 1.1, 75.0,0.3)')
    ...
    ROOT.gInterpreter.ProcessLine('corr.eval_electronSF((char*)"2022Re-recoE+PromptFG", (char*)"sf", (char*)"wp80iso", 1.1, 34.0,0.3)')
    ROOT.gInterpreter.ProcessLine('corr.eval_electronSF((char*)"2022Re-recoE+PromptFG", (char*)"sfup", (char*)"wp80iso", 1.1, 34.0,0.3)')
    ROOT.gInterpreter.ProcessLine('corr.eval_electronSF((char*)"2022Re-recoE+PromptFG", (char*)"sfdown", (char*)"Medium", 1.1, 34.0,0.3)')
    ROOT.gInterpreter.ProcessLine('corr.eval_electronSF((char*)"2022Re-recoE+PromptFG", (char*)"sf", (char*)"RecoBelow20", 1.1, 19.999,0.3)')
    ROOT.gInterpreter.ProcessLine('corr.eval_electronSF((char*)"2022Re-recoE+PromptFG", (char*)"sf", (char*)"Reco20to75", 1.1, 20.0,0.3)')
    ROOT.gInterpreter.ProcessLine('corr.eval_electronSF((char*)"2022Re-recoE+PromptFG", (char*)"sf", (char*)"RecoAbove75", 1.1, 75.0,0.3)')
    ...
    ROOT.gInterpreter.ProcessLine('corr.eval_electronSF((char*)"2023PromptC", (char*)"sf", (char*)"wp80iso", 1.1, 34.0,0.3)')
    ROOT.gInterpreter.ProcessLine('corr.eval_electronSF((char*)"2023PromptC", (char*)"sfup", (char*)"wp80iso", 1.1, 34.0,0.3)')
    ROOT.gInterpreter.ProcessLine('corr.eval_electronSF((char*)"2023PromptC", (char*)"sfdown", (char*)"Medium", 1.1, 34.0,0.3)')
    ROOT.gInterpreter.ProcessLine('corr.eval_electronSF((char*)"2023PromptC", (char*)"sf", (char*)"RecoBelow20", 1.1, 19.999,0.3)')
    ROOT.gInterpreter.ProcessLine('corr.eval_electronSF((char*)"2023PromptC", (char*)"sf", (char*)"Reco20to75", 1.1, 20.0,0.3)')
    ROOT.gInterpreter.ProcessLine('corr.eval_electronSF((char*)"2023PromptC", (char*)"sf", (char*)"RecoAbove75", 1.1, 75.0,0.3)')
