...
rm -rf /scratch/submit/cms/ceballos/analysis/macros1010
...
cp -r ../macros /scratch/submit/cms/ceballos/analysis/macros1010
...
sed -i 's/makeDataCards = 1/makeDataCards = 10/' /scratch/submit/cms/ceballos/analysis/macros1010/sswwAnalysis.py 
...
rm -f /scratch/submit/cms/ceballos/analysis/macros1010/wzAnalysis.py
...
rm -f /scratch/submit/cms/ceballos/analysis/macros1010/zzAnalysis.py

sed -i 's/correctionString = ""/correctionString = "_correction"/'  /scratch/submit/cms/ceballos/analysis/macros1002/zAnalysis.py
sed -i 's/muSelChoice = 0/muSelChoice = 8/'                         /scratch/submit/cms/ceballos/analysis/macros1002/zAnalysis.py
sed -i 's/elSelChoice = 0/elSelChoice = 7/'                         /scratch/submit/cms/ceballos/analysis/macros1002/zAnalysis.py
...
diff -r ../macros /scratch/submit/cms/ceballos/analysis/macros1010
