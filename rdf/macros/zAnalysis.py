...
def analysis(df,count,category,weight,year,PDType,isData,whichJob,nTheoryReplicas,genEventSumLHEScaleRenorm,genEventSumPSRenorm,puWeights,histoBTVEffEtaPtLF,histoBTVEffEtaPtCJ,histoBTVEffEtaPtBJ,histoFakeEtaPt_mu,histoFakeEtaPt_el,histoLepSFEtaPt_mu,histoLepSFEtaPt_el,histoTriggerSFEtaPt_0_0,histoTriggerSFEtaPt_0_1,histoTriggerSFEtaPt_0_2,histoTriggerSFEtaPt_0_3,histoTriggerSFEtaPt_1_0,histoTriggerSFEtaPt_1_1,histoTriggerSFEtaPt_1_2,histoTriggerSFEtaPt_1_3,histoTriggerSFEtaPt_2_0,histoTriggerSFEtaPt_2_1,histoTriggerSFEtaPt_2_2,histoTriggerSFEtaPt_2_3,histoTriggerSFEtaPt_3_0,histoTriggerSFEtaPt_3_1,histoTriggerSFEtaPt_3_2,histoTriggerSFEtaPt_3_3):
    ...
    global useFR
    if(year == 2023): useFR = 0
    dfbase = selectionWeigths(dfbase,isData,year,PDType,weight,useFR,bTagSel,useBTaggingWeights,nTheoryReplicas,genEventSumLHEScaleRenorm,genEventSumPSRenorm,MUOWP,ELEWP,"")
    ...
    for x in range(nCat):
        for ltype in range(3):
            ...
            if(ltype == 0):
                histo[240][x] = dfzllcat[3*x+ltype].Filter("{0} and mll{1} > 83 and mll{1} < 99".format(isBB,altShapes[0])).Histo1D(("histo_{0}_{1}".format(240,x), "histo_{0}_{1}".format(240,x),80, 83, 99), "mll{0}".format(altShapes[0]),"weight")
                histo[241][x] = dfzllcat[3*x+ltype].Filter("{0} and mll{1} > 83 and mll{1} < 99".format(isEB,altShapes[0])).Histo1D(("histo_{0}_{1}".format(241,x), "histo_{0}_{1}".format(241,x),80, 83, 99), "mll{0}".format(altShapes[0]),"weight")
                histo[242][x] = dfzllcat[3*x+ltype].Filter("{0} and mll{1} > 83 and mll{1} < 99".format(isEE,altShapes[0])).Histo1D(("histo_{0}_{1}".format(242,x), "histo_{0}_{1}".format(242,x),80, 83, 99), "mll{0}".format(altShapes[0]),"weight")

                histo[243][x] = dfzllcat[3*x+ltype].Filter("{0} and mll{1} > 83 and mll{1} < 99".format(isBB,altShapes[1])).Histo1D(("histo_{0}_{1}".format(243,x), "histo_{0}_{1}".format(243,x),80, 83, 99), "mll{0}".format(altShapes[1]),"weight")
                histo[244][x] = dfzllcat[3*x+ltype].Filter("{0} and mll{1} > 83 and mll{1} < 99".format(isEB,altShapes[1])).Histo1D(("histo_{0}_{1}".format(244,x), "histo_{0}_{1}".format(244,x),80, 83, 99), "mll{0}".format(altShapes[1]),"weight")
                histo[245][x] = dfzllcat[3*x+ltype].Filter("{0} and mll{1} > 83 and mll{1} < 99".format(isEE,altShapes[1])).Histo1D(("histo_{0}_{1}".format(245,x), "histo_{0}_{1}".format(245,x),80, 83, 99), "mll{0}".format(altShapes[1]),"weight")

                histo[246][x] = dfzllcat[3*x+ltype].Filter("{0} and mll{1} > 83 and mll{1} < 99".format(isBB,altShapes[2])).Histo1D(("histo_{0}_{1}".format(246,x), "histo_{0}_{1}".format(246,x),80, 83, 99), "mll{0}".format(altShapes[2]),"weight")
                histo[247][x] = dfzllcat[3*x+ltype].Filter("{0} and mll{1} > 83 and mll{1} < 99".format(isEB,altShapes[2])).Histo1D(("histo_{0}_{1}".format(247,x), "histo_{0}_{1}".format(247,x),80, 83, 99), "mll{0}".format(altShapes[2]),"weight")
                histo[248][x] = dfzllcat[3*x+ltype].Filter("{0} and mll{1} > 83 and mll{1} < 99".format(isEE,altShapes[2])).Histo1D(("histo_{0}_{1}".format(248,x), "histo_{0}_{1}".format(248,x),80, 83, 99), "mll{0}".format(altShapes[2]),"weight")

                histo[249][x] = dfzllcat[3*x+ltype].Filter("{0} and mll{1} > 83 and mll{1} < 99".format(isBB,altShapes[3])).Histo1D(("histo_{0}_{1}".format(249,x), "histo_{0}_{1}".format(249,x),80, 83, 99), "mll{0}".format(altShapes[3]),"weight")
                histo[250][x] = dfzllcat[3*x+ltype].Filter("{0} and mll{1} > 83 and mll{1} < 99".format(isEB,altShapes[3])).Histo1D(("histo_{0}_{1}".format(250,x), "histo_{0}_{1}".format(250,x),80, 83, 99), "mll{0}".format(altShapes[3]),"weight")
                histo[251][x] = dfzllcat[3*x+ltype].Filter("{0} and mll{1} > 83 and mll{1} < 99".format(isEE,altShapes[3])).Histo1D(("histo_{0}_{1}".format(251,x), "histo_{0}_{1}".format(251,x),80, 83, 99), "mll{0}".format(altShapes[3]),"weight")
            elif(ltype == 2):
                histo[252][x] = dfzllcat[3*x+ltype].Filter("{0} and mll{1} > 83 and mll{1} < 99".format(isBB,altShapes[4])).Histo1D(("histo_{0}_{1}".format(252,x), "histo_{0}_{1}".format(252,x),80, 83, 99), "mll{0}".format(altShapes[4]),"weight")
                histo[253][x] = dfzllcat[3*x+ltype].Filter("{0} and mll{1} > 83 and mll{1} < 99".format(isEB,altShapes[4])).Histo1D(("histo_{0}_{1}".format(253,x), "histo_{0}_{1}".format(253,x),80, 83, 99), "mll{0}".format(altShapes[4]),"weight")
                histo[254][x] = dfzllcat[3*x+ltype].Filter("{0} and mll{1} > 83 and mll{1} < 99".format(isEE,altShapes[4])).Histo1D(("histo_{0}_{1}".format(254,x), "histo_{0}_{1}".format(254,x),80, 83, 99), "mll{0}".format(altShapes[4]),"weight")

                histo[255][x] = dfzllcat[3*x+ltype].Filter("{0} and mll{1} > 83 and mll{1} < 99".format(isBB,altShapes[5])).Histo1D(("histo_{0}_{1}".format(255,x), "histo_{0}_{1}".format(255,x),80, 83, 99), "mll{0}".format(altShapes[5]),"weight")
                histo[256][x] = dfzllcat[3*x+ltype].Filter("{0} and mll{1} > 83 and mll{1} < 99".format(isEB,altShapes[5])).Histo1D(("histo_{0}_{1}".format(256,x), "histo_{0}_{1}".format(256,x),80, 83, 99), "mll{0}".format(altShapes[5]),"weight")
                histo[257][x] = dfzllcat[3*x+ltype].Filter("{0} and mll{1} > 83 and mll{1} < 99".format(isEE,altShapes[5])).Histo1D(("histo_{0}_{1}".format(257,x), "histo_{0}_{1}".format(257,x),80, 83, 99), "mll{0}".format(altShapes[5]),"weight")

                histo[258][x] = dfzllcat[3*x+ltype].Filter("{0} and mll{1} > 83 and mll{1} < 99".format(isBB,altShapes[6])).Histo1D(("histo_{0}_{1}".format(258,x), "histo_{0}_{1}".format(258,x),80, 83, 99), "mll{0}".format(altShapes[6]),"weight")
                histo[259][x] = dfzllcat[3*x+ltype].Filter("{0} and mll{1} > 83 and mll{1} < 99".format(isEB,altShapes[6])).Histo1D(("histo_{0}_{1}".format(259,x), "histo_{0}_{1}".format(259,x),80, 83, 99), "mll{0}".format(altShapes[6]),"weight")
                histo[260][x] = dfzllcat[3*x+ltype].Filter("{0} and mll{1} > 83 and mll{1} < 99".format(isEE,altShapes[6])).Histo1D(("histo_{0}_{1}".format(260,x), "histo_{0}_{1}".format(260,x),80, 83, 99), "mll{0}".format(altShapes[6]),"weight")

                histo[261][x] = dfzllcat[3*x+ltype].Filter("{0} and mll{1} > 83 and mll{1} < 99".format(isBB,altShapes[7])).Histo1D(("histo_{0}_{1}".format(261,x), "histo_{0}_{1}".format(261,x),80, 83, 99), "mll{0}".format(altShapes[7]),"weight")
                histo[262][x] = dfzllcat[3*x+ltype].Filter("{0} and mll{1} > 83 and mll{1} < 99".format(isEB,altShapes[7])).Histo1D(("histo_{0}_{1}".format(262,x), "histo_{0}_{1}".format(262,x),80, 83, 99), "mll{0}".format(altShapes[7]),"weight")
                histo[263][x] = dfzllcat[3*x+ltype].Filter("{0} and mll{1} > 83 and mll{1} < 99".format(isEE,altShapes[7])).Histo1D(("histo_{0}_{1}".format(263,x), "histo_{0}_{1}".format(263,x),80, 83, 99), "mll{0}".format(altShapes[7]),"weight")
