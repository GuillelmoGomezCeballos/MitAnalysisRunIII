...
def getLumi(year):
    lumi = [36.1, 41.5, 60.0, 8.1, 26.7, 17.1, 9.5]
...
def SwitchSample(argument, skimType):
    ...
    switch = {
       ...
       302: (dirT2+"/WWto2L2Nu_TuneCP5_13p6TeV_powheg-pythia8+Run3Summer22NanoAODv12-130X_mcRun3_2022_realistic_v5-v2+NANOAODSIMFAKE",(118.7*1.06-ggWWXS_LO_MCFM)*0.1086*0.1086*9*1000,plotCategory("kPlotqqWW")),
