...
def SwitchSample(argument, skimType):
    ...
    switch = {
       ...
       399:("/data/submit/cms/store/user/ceballos/test/",1.0*1000,plotCategory("kPlotBSM")),
      ...
      #105: (dirT2+"/TTto2L2Nu_TuneCP5CR2_13p6TeV_powheg-pythia8+Run3Summer22EENanoAODv11-126X_mcRun3_2022_realistic_postEE_v1-v1+NANOAODSIM",923.6*0.1086*0.1086*9*1000,plotCategory("kPlotTop")),
       ...
       119: (dirT2+"/ZZto2L2Q_TuneCP5_13p6TeV_powheg-pythia8+Run3Summer22EENanoAODv11-126X_mcRun3_2022_realistic_postEE_v1-v2+NANOAODSIM",6.788*1.10*1000,plotCategory("kPlotZZ")),
       120: (dirT2+"/ZZto2L2Nu_TuneCP5_13p6TeV_powheg-pythia8+Run3Summer22EENanoAODv11-126X_mcRun3_2022_realistic_postEE_v1-v2+NANOAODSIM",1.031*1.10*1000,plotCategory("kPlotZZ")),
       121: (dirT2+"/ZZto4L_TuneCP5_13p6TeV_powheg-pythia8+Run3Summer22EENanoAODv11-126X_mcRun3_2022_realistic_postEE_v1-v2+NANOAODSIM",1.390*1.10*1000,plotCategory("kPlotZZ")),
