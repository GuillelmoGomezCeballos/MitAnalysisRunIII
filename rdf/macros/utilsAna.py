...
def getDATAlist(type, year, skimType):
    ...
    if(year == 2016):
        ...
        jsnName = "Cert_Collisions2024_378981_385863_Golden.json"
    ...
    ##### 2024 ####
    elif(year == 2024 and type == 1020):
        filesL   = findDIR("{0}/MuonEG+Run2024A-PromptReco-v1+NANOAOD".format(dirT2))
    elif(year == 2024 and type == 1021):
        filesL   = findDIR("{0}/MuonEG+Run2024B-PromptReco-v1+NANOAOD".format(dirT2))
        ...
        filesL   = findDIR("{0}/MuonEG+Run2024E-PromptReco-v2+NANOAOD".format(dirT2))
    ...
    elif(year == 2024 and type == 1030):
        filesL   = findDIR("{0}/EGamma0+Run2024A-PromptReco-v1+NANOAOD".format(dirT2))
        filesAux = findDIR("{0}/EGamma1+Run2024A-PromptReco-v1+NANOAOD".format(dirT2))
        for x in filesAux:
            filesL.push_back(x)
    elif(year == 2024 and type == 1031):
        filesL   = findDIR("{0}/EGamma0+Run2024B-PromptReco-v1+NANOAOD".format(dirT2))
        filesAux = findDIR("{0}/EGamma1+Run2024B-PromptReco-v1+NANOAOD".format(dirT2))
        for x in filesAux:
            filesL.push_back(x)
        ...
        filesL   = findDIR("{0}/EGamma0+Run2024E-PromptReco-v2+NANOAOD".format(dirT2))
    ...
    elif(year == 2024 and type == 1040):
        filesL   = findDIR("{0}/Muon0+Run2024A-PromptReco-v1+NANOAOD".format(dirT2))
        filesAux = findDIR("{0}/Muon1+Run2024A-PromptReco-v1+NANOAOD".format(dirT2))
        for x in filesAux:
            filesL.push_back(x)
    elif(year == 2024 and type == 1041):
        filesL   = findDIR("{0}/Muon0+Run2024B-PromptReco-v1+NANOAOD".format(dirT2))
        filesAux = findDIR("{0}/Muon1+Run2024B-PromptReco-v1+NANOAOD".format(dirT2))
        for x in filesAux:
            filesL.push_back(x)
        ...
        filesL   = findDIR("{0}/Muon0+Run2024E-PromptReco-v2+NANOAOD".format(dirT2))
    ...
    elif(year == 2024 and type == 1050):
        filesL   = findDIR("{0}/JetMET0+Run2024A-PromptReco-v1+NANOAOD".format(dirT2))
        filesAux = findDIR("{0}/JetMET1+Run2024A-PromptReco-v1+NANOAOD".format(dirT2))
        for x in filesAux:
            filesL.push_back(x)
    elif(year == 2024 and type == 1051):
        filesL   = findDIR("{0}/JetMET0+Run2024B-PromptReco-v1+NANOAOD".format(dirT2))
        filesAux = findDIR("{0}/JetMET1+Run2024B-PromptReco-v1+NANOAOD".format(dirT2))
        for x in filesAux:
            filesL.push_back(x)
        ...
        filesL   = findDIR("{0}/JetMET0+Run2024E-PromptReco-v2+NANOAOD".format(dirT2))
...
def SwitchSample(argument, skimType):
    ...
    switch = {
       ...
       337: (dirT2+"/GluGluHto2Tau_M-125_TuneCP5_13p6TeV_amcatnloFXFX-pythia8+Run3Summer23NanoAODv12-130X_mcRun3_2023_realistic_v15-v2+NANOAODSIM",52.130*0.06272*1000,plotCategory("kPlotHiggs")),
       338: (dirT2+"/VBFHToTauTau_M125_TuneCP5_13p6TeV_powheg-pythia8+Run3Summer23NanoAODv12-130X_mcRun3_2023_realistic_v15-v2+NANOAODSIM",4.1040*0.06272*1000,plotCategory("kPlotHiggs")),
       ...
       344: (dirT2+"/VH_HtoNonbb_M-125_TuneCP5_13p6TeV_amcatnloFXFX-madspin-pythia8+Run3Summer23NanoAODv12-130X_mcRun3_2023_realistic_v15-v2+NANOAODSIM",(0.9422+1.4530)*(1-0.577)*1000,plotCategory("kPlotHiggs")),
       ...
       349: (dirT2+"/TZQB-ZtoLL-TtoL-CPV_TuneCP5_13p6TeV_madgraph-pythia8+Run3Summer23NanoAODv12-130X_mcRun3_2023_realistic_v15-v2+NANOAODSIM",0.07968*1000,plotCategory("kPlotTVX")),
       ...
       353: (dirT2+"/GluGluHto2Wto2L2Nu_M-125_TuneCP5_13p6TeV_powheg-jhugen752-pythia8+Run3Summer23NanoAODv12-130X_mcRun3_2023_realistic_v15-v2+NANOAODSIM",52.130*0.2137*0.1086*0.1086*9*1000,plotCategory("kPlotHiggs")),
       354: (dirT2+"/VBFHto2Wto2L2Nu_M-125_TuneCP5_13p6TeV_powheg-jhugen752-pythia8+Run3Summer23NanoAODv12-130X_mcRun3_2023_realistic_v15-v2+NANOAODSIM",4.1040*0.2137*0.1086*0.1086*9*1000,plotCategory("kPlotHiggs")),
       ...
       437: (dirT2+"/GluGluHToTauTau_M-125_TuneCP5_13p6TeV_powheg-pythia8+Run3Summer23BPixNanoAODv12-130X_mcRun3_2023_realistic_postBPix_v2-v2+NANOAODSIM",52.130*0.06272*1000,plotCategory("kPlotHiggs")),
       438: (dirT2+"/VBFHToTauTau_M125_TuneCP5_13p6TeV_powheg-pythia8+Run3Summer23BPixNanoAODv12-130X_mcRun3_2023_realistic_postBPix_v6-v2+NANOAODSIM",4.1040*0.06272*1000,plotCategory("kPlotHiggs")),
       ...
       444: (dirT2+"/VH_HtoNonbb_M-125_TuneCP5_13p6TeV_amcatnloFXFX-madspin-pythia8+Run3Summer23BPixNanoAODv12-130X_mcRun3_2023_realistic_postBPix_v6-v2+NANOAODSIM",(0.9422+1.4530)*(1-0.577)*1000,plotCategory("kPlotHiggs")),
       ...
       449: (dirT2+"/TZQB-ZtoLL-TtoL-CPV_TuneCP5_13p6TeV_madgraph-pythia8+Run3Summer23BPixNanoAODv12-130X_mcRun3_2023_realistic_postBPix_v6-v2+NANOAODSIM",0.07968*1000,plotCategory("kPlotTVX")),
       ...
       453: (dirT2+"/GluGluHto2Wto2L2Nu_M-125_TuneCP5_13p6TeV_powheg-jhugen752-pythia8+Run3Summer23BPixNanoAODv12-130X_mcRun3_2023_realistic_postBPix_v6-v2+NANOAODSIM",52.130*0.2137*0.1086*0.1086*9*1000,plotCategory("kPlotHiggs")),
       454: (dirT2+"/VBFHto2Wto2L2Nu_M-125_TuneCP5_13p6TeV_powheg-jhugen752-pythia8+Run3Summer23BPixNanoAODv12-130X_mcRun3_2023_realistic_postBPix_v6-v2+NANOAODSIM",4.1040*0.2137*0.1086*0.1086*9*1000,plotCategory("kPlotHiggs")),
