...
void makeAllPlots(TString nsel, int applyScaling, int year, int whichCondorJob = 1001){
  ...
  if(nsel.Contains(".root") == true){
    ...
    finalPlot(0,1,"X","GeV",Form("anaZ/fillhisto_fakeAnalysis%d_%d_14.root",whichCondorJob,year),"fakemsel_summetmt", 0,year,legendBSM.Data(),SF_DY,isBlinded,"",1,applyScaling,mlfitResult.Data(),channelName.Data());
    finalPlot(0,1,"X","GeV",Form("anaZ/fillhisto_fakeAnalysis%d_%d_15.root",whichCondorJob,year),"fakeesel_summetmt", 0,year,legendBSM.Data(),SF_DY,isBlinded,"",1,applyScaling,mlfitResult.Data(),channelName.Data());
    ...
    finalPlot(0,1,"p_{T}^{l1}","GeV",Form("anaZ/fillhisto_sswwAnalysis%d_%d_50.root",whichCondorJob,year),"sswwmmsel_ptl1", 0,year,legendBSM.Data(),SF_DY,isBlinded,"",1,applyScaling,mlfitResult.Data(),channelName.Data());
    finalPlot(0,1,"p_{T}^{l1}","GeV",Form("anaZ/fillhisto_sswwAnalysis%d_%d_51.root",whichCondorJob,year),"sswweesel_ptl1", 0,year,legendBSM.Data(),SF_DY,isBlinded,"",1,applyScaling,mlfitResult.Data(),channelName.Data());
    finalPlot(0,1,"p_{T}^{l1}","GeV",Form("anaZ/fillhisto_sswwAnalysis%d_%d_52.root",whichCondorJob,year),"sswwmesel_ptl1", 0,year,legendBSM.Data(),SF_DY,isBlinded,"",1,applyScaling,mlfitResult.Data(),channelName.Data());
    finalPlot(0,1,"p_{T}^{l1}","GeV",Form("anaZ/fillhisto_sswwAnalysis%d_%d_53.root",whichCondorJob,year),"sswwemsel_ptl1", 0,year,legendBSM.Data(),SF_DY,isBlinded,"",1,applyScaling,mlfitResult.Data(),channelName.Data());
    finalPlot(0,1,"p_{T}^{l1}","GeV",Form("anaZ/fillhisto_sswwAnalysis%d_%d_54.root",whichCondorJob,year),"sswwbmmsel_ptl1", 0,year,legendBSM.Data(),SF_DY,isBlinded,"",1,applyScaling,mlfitResult.Data(),channelName.Data());
    finalPlot(0,1,"p_{T}^{l1}","GeV",Form("anaZ/fillhisto_sswwAnalysis%d_%d_55.root",whichCondorJob,year),"sswwbeesel_ptl1", 0,year,legendBSM.Data(),SF_DY,isBlinded,"",1,applyScaling,mlfitResult.Data(),channelName.Data());
    finalPlot(0,1,"p_{T}^{l1}","GeV",Form("anaZ/fillhisto_sswwAnalysis%d_%d_56.root",whichCondorJob,year),"sswwbmesel_ptl1", 0,year,legendBSM.Data(),SF_DY,isBlinded,"",1,applyScaling,mlfitResult.Data(),channelName.Data());
    finalPlot(0,1,"p_{T}^{l1}","GeV",Form("anaZ/fillhisto_sswwAnalysis%d_%d_57.root",whichCondorJob,year),"sswwbemsel_ptl1", 0,year,legendBSM.Data(),SF_DY,isBlinded,"",1,applyScaling,mlfitResult.Data(),channelName.Data());
    finalPlot(0,1,"p_{T}^{l2}","GeV",Form("anaZ/fillhisto_sswwAnalysis%d_%d_58.root",whichCondorJob,year),"sswwmmsel_ptl2", 0,year,legendBSM.Data(),SF_DY,isBlinded,"",1,applyScaling,mlfitResult.Data(),channelName.Data());
    finalPlot(0,1,"p_{T}^{l2}","GeV",Form("anaZ/fillhisto_sswwAnalysis%d_%d_59.root",whichCondorJob,year),"sswweesel_ptl2", 0,year,legendBSM.Data(),SF_DY,isBlinded,"",1,applyScaling,mlfitResult.Data(),channelName.Data());
    finalPlot(0,1,"p_{T}^{l2}","GeV",Form("anaZ/fillhisto_sswwAnalysis%d_%d_60.root",whichCondorJob,year),"sswwmesel_ptl2", 0,year,legendBSM.Data(),SF_DY,isBlinded,"",1,applyScaling,mlfitResult.Data(),channelName.Data());
    finalPlot(0,1,"p_{T}^{l2}","GeV",Form("anaZ/fillhisto_sswwAnalysis%d_%d_61.root",whichCondorJob,year),"sswwemsel_ptl2", 0,year,legendBSM.Data(),SF_DY,isBlinded,"",1,applyScaling,mlfitResult.Data(),channelName.Data());
    finalPlot(0,1,"p_{T}^{l2}","GeV",Form("anaZ/fillhisto_sswwAnalysis%d_%d_62.root",whichCondorJob,year),"sswwbmmsel_ptl2", 0,year,legendBSM.Data(),SF_DY,isBlinded,"",1,applyScaling,mlfitResult.Data(),channelName.Data());
    finalPlot(0,1,"p_{T}^{l2}","GeV",Form("anaZ/fillhisto_sswwAnalysis%d_%d_63.root",whichCondorJob,year),"sswwbeesel_ptl2", 0,year,legendBSM.Data(),SF_DY,isBlinded,"",1,applyScaling,mlfitResult.Data(),channelName.Data());
    finalPlot(0,1,"p_{T}^{l2}","GeV",Form("anaZ/fillhisto_sswwAnalysis%d_%d_64.root",whichCondorJob,year),"sswwbmesel_ptl2", 0,year,legendBSM.Data(),SF_DY,isBlinded,"",1,applyScaling,mlfitResult.Data(),channelName.Data());
    finalPlot(0,1,"p_{T}^{l2}","GeV",Form("anaZ/fillhisto_sswwAnalysis%d_%d_65.root",whichCondorJob,year),"sswwbemsel_ptl2", 0,year,legendBSM.Data(),SF_DY,isBlinded,"",1,applyScaling,mlfitResult.Data(),channelName.Data());
    finalPlot(0,1,"#eta_{T}^{l1}","GeV",Form("anaZ/fillhisto_sswwAnalysis%d_%d_66.root",whichCondorJob,year),"sswwmmsel_etal1", 0,year,legendBSM.Data(),SF_DY,isBlinded,"",1,applyScaling,mlfitResult.Data(),channelName.Data());
    finalPlot(0,1,"#eta_{T}^{l1}","GeV",Form("anaZ/fillhisto_sswwAnalysis%d_%d_67.root",whichCondorJob,year),"sswweesel_etal1", 0,year,legendBSM.Data(),SF_DY,isBlinded,"",1,applyScaling,mlfitResult.Data(),channelName.Data());
    finalPlot(0,1,"#eta_{T}^{l1}","GeV",Form("anaZ/fillhisto_sswwAnalysis%d_%d_68.root",whichCondorJob,year),"sswwmesel_etal1", 0,year,legendBSM.Data(),SF_DY,isBlinded,"",1,applyScaling,mlfitResult.Data(),channelName.Data());
    finalPlot(0,1,"#eta_{T}^{l1}","GeV",Form("anaZ/fillhisto_sswwAnalysis%d_%d_69.root",whichCondorJob,year),"sswwemsel_etal1", 0,year,legendBSM.Data(),SF_DY,isBlinded,"",1,applyScaling,mlfitResult.Data(),channelName.Data());
    finalPlot(0,1,"#eta_{T}^{l1}","GeV",Form("anaZ/fillhisto_sswwAnalysis%d_%d_70.root",whichCondorJob,year),"sswwbmmsel_etal1", 0,year,legendBSM.Data(),SF_DY,isBlinded,"",1,applyScaling,mlfitResult.Data(),channelName.Data());
    finalPlot(0,1,"#eta_{T}^{l1}","GeV",Form("anaZ/fillhisto_sswwAnalysis%d_%d_71.root",whichCondorJob,year),"sswwbeesel_etal1", 0,year,legendBSM.Data(),SF_DY,isBlinded,"",1,applyScaling,mlfitResult.Data(),channelName.Data());
    finalPlot(0,1,"#eta_{T}^{l1}","GeV",Form("anaZ/fillhisto_sswwAnalysis%d_%d_72.root",whichCondorJob,year),"sswwbmesel_etal1", 0,year,legendBSM.Data(),SF_DY,isBlinded,"",1,applyScaling,mlfitResult.Data(),channelName.Data());
    finalPlot(0,1,"#eta_{T}^{l1}","GeV",Form("anaZ/fillhisto_sswwAnalysis%d_%d_73.root",whichCondorJob,year),"sswwbemsel_etal1", 0,year,legendBSM.Data(),SF_DY,isBlinded,"",1,applyScaling,mlfitResult.Data(),channelName.Data());
    finalPlot(0,1,"#eta_{T}^{l2}","GeV",Form("anaZ/fillhisto_sswwAnalysis%d_%d_74.root",whichCondorJob,year),"sswwmmsel_etal2", 0,year,legendBSM.Data(),SF_DY,isBlinded,"",1,applyScaling,mlfitResult.Data(),channelName.Data());
    finalPlot(0,1,"#eta_{T}^{l2}","GeV",Form("anaZ/fillhisto_sswwAnalysis%d_%d_75.root",whichCondorJob,year),"sswweesel_etal2", 0,year,legendBSM.Data(),SF_DY,isBlinded,"",1,applyScaling,mlfitResult.Data(),channelName.Data());
    finalPlot(0,1,"#eta_{T}^{l2}","GeV",Form("anaZ/fillhisto_sswwAnalysis%d_%d_76.root",whichCondorJob,year),"sswwmesel_etal2", 0,year,legendBSM.Data(),SF_DY,isBlinded,"",1,applyScaling,mlfitResult.Data(),channelName.Data());
    finalPlot(0,1,"#eta_{T}^{l2}","GeV",Form("anaZ/fillhisto_sswwAnalysis%d_%d_77.root",whichCondorJob,year),"sswwemsel_etal2", 0,year,legendBSM.Data(),SF_DY,isBlinded,"",1,applyScaling,mlfitResult.Data(),channelName.Data());
    finalPlot(0,1,"#eta_{T}^{l2}","GeV",Form("anaZ/fillhisto_sswwAnalysis%d_%d_78.root",whichCondorJob,year),"sswwbmmsel_etal2", 0,year,legendBSM.Data(),SF_DY,isBlinded,"",1,applyScaling,mlfitResult.Data(),channelName.Data());
    finalPlot(0,1,"#eta_{T}^{l2}","GeV",Form("anaZ/fillhisto_sswwAnalysis%d_%d_79.root",whichCondorJob,year),"sswwbeesel_etal2", 0,year,legendBSM.Data(),SF_DY,isBlinded,"",1,applyScaling,mlfitResult.Data(),channelName.Data());
    finalPlot(0,1,"#eta_{T}^{l2}","GeV",Form("anaZ/fillhisto_sswwAnalysis%d_%d_80.root",whichCondorJob,year),"sswwbmesel_etal2", 0,year,legendBSM.Data(),SF_DY,isBlinded,"",1,applyScaling,mlfitResult.Data(),channelName.Data());
    finalPlot(0,1,"#eta_{T}^{l2}","GeV",Form("anaZ/fillhisto_sswwAnalysis%d_%d_81.root",whichCondorJob,year),"sswwbemsel_etal2", 0,year,legendBSM.Data(),SF_DY,isBlinded,"",1,applyScaling,mlfitResult.Data(),channelName.Data());
  }
  else if(nsel == "zmet"){
    legendBSM="";
    isNeverBlinded=0;
    ...
    finalPlot(0,1,"N_{j}","",Form("ww_output_cr1.root"),"ww_output_cr1",0,year,legendBSM.Data(),1.0,isNeverBlinded,"WW region",1,applyScaling,mlfitResult.Data(),channelName.Data());
