...
void makeAllPlots(TString nsel, int applyScaling, int year, int whichCondorJob = 1001, bool doMerging = true){
  if((year == 2022 || year == 2023 || year == 2024 || year == 2025 || year == 2026 || year == 2027) and nsel != "combine" && doMerging == true) {
  ...
  if(nsel.Contains(".root") == true){
    ...
    finalPlot(0,1,"Zep_{VV}","",Form("anaZ/fillhisto_wzAnalysis%d_%d_25.root",whichCondorJob,year),"wzjjsel_zepvv_vbfincl", 0,year,legendBSM.Data(),SF_DY,isNeverBlinded,"",1,applyScaling,mlfitResult.Data(),channelName.Data());
    finalPlot(0,1,"Zep_{VV}","",Form("anaZ/fillhisto_wzAnalysis%d_%d_26.root",whichCondorJob,year),"wzbjjsel_zepvv_vbfincl", 0,year,legendBSM.Data(),SF_DY,isNeverBlinded,"",1,applyScaling,mlfitResult.Data(),channelName.Data());
