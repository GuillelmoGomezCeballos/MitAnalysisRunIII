...
void makeAllPlots(TString nsel, int applyScaling, int year, int whichCondorJob = 1001){
  ...
  if(nsel.Contains(".root") == true){
    ...
    finalPlot(0,1,"m_{jj}","GeV",Form("anaZ/fillhisto_sswwAnalysis%d_%d_10.root",whichCondorJob,year),"sswwnjge2sel_mjj", 0,year,legendBSM.Data(),SF_DY,isNeverBlinded,"",1,applyScaling,mlfitResult.Data(),channelName.Data());
    ...
    finalPlot(0,1,"#Delta#eta_{jj}","",Form("anaZ/fillhisto_sswwAnalysis%d_%d_12.root",whichCondorJob,year),"sswwnjge2sel_detajj", 0,year,legendBSM.Data(),SF_DY,isNeverBlinded,"",1,applyScaling,mlfitResult.Data(),channelName.Data());
    ...
    finalPlot(0,1,"Zep(V)","",Form("anaZ/fillhisto_sswwAnalysis%d_%d_14.root",whichCondorJob,year),"sswwnjge2sel_zepvv", 0,year,legendBSM.Data(),SF_DY,isNeverBlinded,"",1,applyScaling,mlfitResult.Data(),channelName.Data());
