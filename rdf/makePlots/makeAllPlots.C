...
void makeAllPlots(TString nsel, int applyScaling, int year, int whichCondorJob = 1001){
  ...
  if(nsel.Contains(".root") == true){
    ...
    finalPlot(0,1,"#phi(p_{T}^{miss})","",Form("anaZ/fillhisto_zAnalysis%d_%d_53.root",whichCondorJob,year),"dy_zsel_metphiee",0,year,legendBSM.Data(),1.0,isBlinded,"",1,applyScaling,mlfitResult.Data(),channelName.Data());
																												       finalPlot(0,1,"Btag","",Form("anaZ/fillhisto_zAnalysis%d_%d_910.root",whichCondorJob,year),"dy_1jsel_btagDeepBll",0,year,legendBSM.Data(),1.0,isBlinded,"",1,applyScaling,mlfitResult.Data(),channelName.Data());
    ...
    finalPlot(0,1,"PUPPI #phi(p_{T}^{miss})","",Form("anaZ/fillhisto_zAnalysis%d_%d_56.root",whichCondorJob,year),"dy_zsel_puppimetphiee",0,year,legendBSM.Data(),1.0,isBlinded,"",1,applyScaling,mlfitResult.Data(),channelName.Data());    finalPlot(0,1,"N_{bj}","",Form("anaZ/fillhisto_zAnalysis%d_%d_913.root",whichCondorJob,year),"dy_1jsel_nbjetsll",0,year,legendBSM.Data(),1.0,isBlinded,"",1,applyScaling,mlfitResult.Data(),channelName.Data());
																												       finalPlot(0,1,"N_{bj}","",Form("anaZ/fillhisto_zAnalysis%d_%d_114.root",whichCondorJob,year),"dy_1jsel_nbjetsem",0,year,legendBSM.Data(),1.0,isBlinded,"",1,applyScaling,mlfitResult.Data(),channelName.Data());
    ...
    finalPlot(0,1,"Neutral electromagnetic energy fraction","",Form("anaZ/fillhisto_zAnalysis%d_%d_264.root",whichCondorJob,year),"dy_1jsel_eta0p0_1p3_ptgt30_neEmEFmm",1,year,legendBSM.Data(),1.0,isBlinded,"0.0 < |#eta^{j}| < 1.3, p_{T}^{j} > 30 GeV",1,applyScaling,mlfitResult.Data(),channelName.Data());
    finalPlot(0,1,"Neutral electromagnetic energy fraction","",Form("anaZ/fillhisto_zAnalysis%d_%d_265.root",whichCondorJob,year),"dy_1jsel_eta0p0_1p3_ptgt30_neEmEFem",1,year,legendBSM.Data(),1.0,isBlinded,"0.0 < |#eta^{j}| < 1.3, p_{T}^{j} > 30 GeV",1,applyScaling,mlfitResult.Data(),channelName.Data());
    finalPlot(0,1,"Neutral hadronic energy fraction",""       ,Form("anaZ/fillhisto_zAnalysis%d_%d_266.root",whichCondorJob,year),"dy_1jsel_eta0p0_1p3_ptgt30_neHEFmm" ,1,year,legendBSM.Data(),1.0,isBlinded,"0.0 < |#eta^{j}| < 1.3, p_{T}^{j} > 30 GeV",1,applyScaling,mlfitResult.Data(),channelName.Data());
    finalPlot(0,1,"Neutral hadronic energy fraction",""       ,Form("anaZ/fillhisto_zAnalysis%d_%d_267.root",whichCondorJob,year),"dy_1jsel_eta0p0_1p3_ptgt30_neHEFem" ,1,year,legendBSM.Data(),1.0,isBlinded,"0.0 < |#eta^{j}| < 1.3, p_{T}^{j} > 30 GeV",1,applyScaling,mlfitResult.Data(),channelName.Data());
    finalPlot(0,1,"Charged energy fraction",""                ,Form("anaZ/fillhisto_zAnalysis%d_%d_268.root",whichCondorJob,year),"dy_1jsel_eta0p0_1p3_ptgt30_chEFmm"  ,1,year,legendBSM.Data(),1.0,isBlinded,"0.0 < |#eta^{j}| < 1.3, p_{T}^{j} > 30 GeV",1,applyScaling,mlfitResult.Data(),channelName.Data());
    finalPlot(0,1,"Charged energy fraction",""                ,Form("anaZ/fillhisto_zAnalysis%d_%d_269.root",whichCondorJob,year),"dy_1jsel_eta0p0_1p3_ptgt30_chEFem"  ,1,year,legendBSM.Data(),1.0,isBlinded,"0.0 < |#eta^{j}| < 1.3, p_{T}^{j} > 30 GeV",1,applyScaling,mlfitResult.Data(),channelName.Data());

    finalPlot(0,1,"Neutral electromagnetic energy fraction","",Form("anaZ/fillhisto_zAnalysis%d_%d_270.root",whichCondorJob,year),"dy_1jsel_eta1p3_2p5_ptgt30_neEmEFmm",1,year,legendBSM.Data(),1.0,isBlinded,"1.3 < |#eta^{j}| < 2.5, p_{T}^{j} > 30 GeV",1,applyScaling,mlfitResult.Data(),channelName.Data());
    finalPlot(0,1,"Neutral electromagnetic energy fraction","",Form("anaZ/fillhisto_zAnalysis%d_%d_271.root",whichCondorJob,year),"dy_1jsel_eta1p3_2p5_ptgt30_neEmEFem",1,year,legendBSM.Data(),1.0,isBlinded,"1.3 < |#eta^{j}| < 2.5, p_{T}^{j} > 30 GeV",1,applyScaling,mlfitResult.Data(),channelName.Data());
    finalPlot(0,1,"Neutral hadronic energy fraction",""       ,Form("anaZ/fillhisto_zAnalysis%d_%d_272.root",whichCondorJob,year),"dy_1jsel_eta1p3_2p5_ptgt30_neHEFmm" ,1,year,legendBSM.Data(),1.0,isBlinded,"1.3 < |#eta^{j}| < 2.5, p_{T}^{j} > 30 GeV",1,applyScaling,mlfitResult.Data(),channelName.Data());
    finalPlot(0,1,"Neutral hadronic energy fraction",""       ,Form("anaZ/fillhisto_zAnalysis%d_%d_273.root",whichCondorJob,year),"dy_1jsel_eta1p3_2p5_ptgt30_neHEFem" ,1,year,legendBSM.Data(),1.0,isBlinded,"1.3 < |#eta^{j}| < 2.5, p_{T}^{j} > 30 GeV",1,applyScaling,mlfitResult.Data(),channelName.Data());
    finalPlot(0,1,"Charged energy fraction",""                ,Form("anaZ/fillhisto_zAnalysis%d_%d_274.root",whichCondorJob,year),"dy_1jsel_eta1p3_2p5_ptgt30_chEFmm"  ,1,year,legendBSM.Data(),1.0,isBlinded,"1.3 < |#eta^{j}| < 2.5, p_{T}^{j} > 30 GeV",1,applyScaling,mlfitResult.Data(),channelName.Data());
    finalPlot(0,1,"Charged energy fraction",""                ,Form("anaZ/fillhisto_zAnalysis%d_%d_275.root",whichCondorJob,year),"dy_1jsel_eta1p3_2p5_ptgt30_chEFem"  ,1,year,legendBSM.Data(),1.0,isBlinded,"1.3 < |#eta^{j}| < 2.5, p_{T}^{j} > 30 GeV",1,applyScaling,mlfitResult.Data(),channelName.Data());

    finalPlot(0,1,"Neutral electromagnetic energy fraction","",Form("anaZ/fillhisto_zAnalysis%d_%d_276.root",whichCondorJob,year),"dy_1jsel_eta2p5_3p5_ptgt30_neEmEFmm",1,year,legendBSM.Data(),1.0,isBlinded,"2.5 < |#eta^{j}| < 3.5, p_{T}^{j} > 30 GeV",1,applyScaling,mlfitResult.Data(),channelName.Data());
    finalPlot(0,1,"Neutral electromagnetic energy fraction","",Form("anaZ/fillhisto_zAnalysis%d_%d_277.root",whichCondorJob,year),"dy_1jsel_eta2p5_3p5_ptgt30_neEmEFem",1,year,legendBSM.Data(),1.0,isBlinded,"2.5 < |#eta^{j}| < 3.5, p_{T}^{j} > 30 GeV",1,applyScaling,mlfitResult.Data(),channelName.Data());
    finalPlot(0,1,"Neutral hadronic energy fraction",""       ,Form("anaZ/fillhisto_zAnalysis%d_%d_278.root",whichCondorJob,year),"dy_1jsel_eta2p5_3p5_ptgt30_neHEFmm" ,1,year,legendBSM.Data(),1.0,isBlinded,"2.5 < |#eta^{j}| < 3.5, p_{T}^{j} > 30 GeV",1,applyScaling,mlfitResult.Data(),channelName.Data());
    finalPlot(0,1,"Neutral hadronic energy fraction",""       ,Form("anaZ/fillhisto_zAnalysis%d_%d_279.root",whichCondorJob,year),"dy_1jsel_eta2p5_3p5_ptgt30_neHEFem" ,1,year,legendBSM.Data(),1.0,isBlinded,"2.5 < |#eta^{j}| < 3.5, p_{T}^{j} > 30 GeV",1,applyScaling,mlfitResult.Data(),channelName.Data());
    finalPlot(0,1,"Charged energy fraction",""                ,Form("anaZ/fillhisto_zAnalysis%d_%d_280.root",whichCondorJob,year),"dy_1jsel_eta2p5_3p5_ptgt30_chEFmm"  ,1,year,legendBSM.Data(),1.0,isBlinded,"2.5 < |#eta^{j}| < 3.5, p_{T}^{j} > 30 GeV",1,applyScaling,mlfitResult.Data(),channelName.Data());
    finalPlot(0,1,"Charged energy fraction",""                ,Form("anaZ/fillhisto_zAnalysis%d_%d_281.root",whichCondorJob,year),"dy_1jsel_eta2p5_3p5_ptgt30_chEFem"  ,1,year,legendBSM.Data(),1.0,isBlinded,"2.5 < |#eta^{j}| < 3.5, p_{T}^{j} > 30 GeV",1,applyScaling,mlfitResult.Data(),channelName.Data());

    finalPlot(0,1,"Neutral electromagnetic energy fraction","",Form("anaZ/fillhisto_zAnalysis%d_%d_282.root",whichCondorJob,year),"dy_1jsel_eta0p0_1p3_ptgt100_neEmEFmm",1,year,legendBSM.Data(),1.0,isBlinded,"0.0 < |#eta^{j}| < 1.3, p_{T}^{j} > 100 GeV",1,applyScaling,mlfitResult.Data(),channelName.Data());
    finalPlot(0,1,"Neutral electromagnetic energy fraction","",Form("anaZ/fillhisto_zAnalysis%d_%d_283.root",whichCondorJob,year),"dy_1jsel_eta0p0_1p3_ptgt100_neEmEFem",1,year,legendBSM.Data(),1.0,isBlinded,"0.0 < |#eta^{j}| < 1.3, p_{T}^{j} > 100 GeV",1,applyScaling,mlfitResult.Data(),channelName.Data());
    finalPlot(0,1,"Neutral hadronic energy fraction",""       ,Form("anaZ/fillhisto_zAnalysis%d_%d_284.root",whichCondorJob,year),"dy_1jsel_eta0p0_1p3_ptgt100_neHEFmm" ,1,year,legendBSM.Data(),1.0,isBlinded,"0.0 < |#eta^{j}| < 1.3, p_{T}^{j} > 100 GeV",1,applyScaling,mlfitResult.Data(),channelName.Data());
    finalPlot(0,1,"Neutral hadronic energy fraction",""       ,Form("anaZ/fillhisto_zAnalysis%d_%d_285.root",whichCondorJob,year),"dy_1jsel_eta0p0_1p3_ptgt100_neHEFem" ,1,year,legendBSM.Data(),1.0,isBlinded,"0.0 < |#eta^{j}| < 1.3, p_{T}^{j} > 100 GeV",1,applyScaling,mlfitResult.Data(),channelName.Data());
    finalPlot(0,1,"Charged energy fraction",""                ,Form("anaZ/fillhisto_zAnalysis%d_%d_286.root",whichCondorJob,year),"dy_1jsel_eta0p0_1p3_ptgt100_chEFmm"  ,1,year,legendBSM.Data(),1.0,isBlinded,"0.0 < |#eta^{j}| < 1.3, p_{T}^{j} > 100 GeV",1,applyScaling,mlfitResult.Data(),channelName.Data());
    finalPlot(0,1,"Charged energy fraction",""                ,Form("anaZ/fillhisto_zAnalysis%d_%d_287.root",whichCondorJob,year),"dy_1jsel_eta0p0_1p3_ptgt100_chEFem"  ,1,year,legendBSM.Data(),1.0,isBlinded,"0.0 < |#eta^{j}| < 1.3, p_{T}^{j} > 100 GeV",1,applyScaling,mlfitResult.Data(),channelName.Data());

    finalPlot(0,1,"Neutral electromagnetic energy fraction","",Form("anaZ/fillhisto_zAnalysis%d_%d_288.root",whichCondorJob,year),"dy_1jsel_eta1p3_2p5_ptgt100_neEmEFmm",1,year,legendBSM.Data(),1.0,isBlinded,"1.3 < |#eta^{j}| < 2.5, p_{T}^{j} > 100 GeV",1,applyScaling,mlfitResult.Data(),channelName.Data());
    finalPlot(0,1,"Neutral electromagnetic energy fraction","",Form("anaZ/fillhisto_zAnalysis%d_%d_289.root",whichCondorJob,year),"dy_1jsel_eta1p3_2p5_ptgt100_neEmEFem",1,year,legendBSM.Data(),1.0,isBlinded,"1.3 < |#eta^{j}| < 2.5, p_{T}^{j} > 100 GeV",1,applyScaling,mlfitResult.Data(),channelName.Data());
    finalPlot(0,1,"Neutral hadronic energy fraction",""       ,Form("anaZ/fillhisto_zAnalysis%d_%d_290.root",whichCondorJob,year),"dy_1jsel_eta1p3_2p5_ptgt100_neHEFmm" ,1,year,legendBSM.Data(),1.0,isBlinded,"1.3 < |#eta^{j}| < 2.5, p_{T}^{j} > 100 GeV",1,applyScaling,mlfitResult.Data(),channelName.Data());
    finalPlot(0,1,"Neutral hadronic energy fraction",""       ,Form("anaZ/fillhisto_zAnalysis%d_%d_291.root",whichCondorJob,year),"dy_1jsel_eta1p3_2p5_ptgt100_neHEFem" ,1,year,legendBSM.Data(),1.0,isBlinded,"1.3 < |#eta^{j}| < 2.5, p_{T}^{j} > 100 GeV",1,applyScaling,mlfitResult.Data(),channelName.Data());
    finalPlot(0,1,"Charged energy fraction",""                ,Form("anaZ/fillhisto_zAnalysis%d_%d_292.root",whichCondorJob,year),"dy_1jsel_eta1p3_2p5_ptgt100_chEFmm"  ,1,year,legendBSM.Data(),1.0,isBlinded,"1.3 < |#eta^{j}| < 2.5, p_{T}^{j} > 100 GeV",1,applyScaling,mlfitResult.Data(),channelName.Data());
    finalPlot(0,1,"Charged energy fraction",""                ,Form("anaZ/fillhisto_zAnalysis%d_%d_293.root",whichCondorJob,year),"dy_1jsel_eta1p3_2p5_ptgt100_chEFem"  ,1,year,legendBSM.Data(),1.0,isBlinded,"1.3 < |#eta^{j}| < 2.5, p_{T}^{j} > 100 GeV",1,applyScaling,mlfitResult.Data(),channelName.Data());

    finalPlot(0,1,"Neutral electromagnetic energy fraction","",Form("anaZ/fillhisto_zAnalysis%d_%d_294.root",whichCondorJob,year),"dy_1jsel_eta2p5_3p5_ptgt100_neEmEFmm",1,year,legendBSM.Data(),1.0,isBlinded,"2.5 < |#eta^{j}| < 3.5, p_{T}^{j} > 100 GeV",1,applyScaling,mlfitResult.Data(),channelName.Data());
    finalPlot(0,1,"Neutral electromagnetic energy fraction","",Form("anaZ/fillhisto_zAnalysis%d_%d_295.root",whichCondorJob,year),"dy_1jsel_eta2p5_3p5_ptgt100_neEmEFem",1,year,legendBSM.Data(),1.0,isBlinded,"2.5 < |#eta^{j}| < 3.5, p_{T}^{j} > 100 GeV",1,applyScaling,mlfitResult.Data(),channelName.Data());
    finalPlot(0,1,"Neutral hadronic energy fraction",""       ,Form("anaZ/fillhisto_zAnalysis%d_%d_296.root",whichCondorJob,year),"dy_1jsel_eta2p5_3p5_ptgt100_neHEFmm" ,1,year,legendBSM.Data(),1.0,isBlinded,"2.5 < |#eta^{j}| < 3.5, p_{T}^{j} > 100 GeV",1,applyScaling,mlfitResult.Data(),channelName.Data());
    finalPlot(0,1,"Neutral hadronic energy fraction",""       ,Form("anaZ/fillhisto_zAnalysis%d_%d_297.root",whichCondorJob,year),"dy_1jsel_eta2p5_3p5_ptgt100_neHEFem" ,1,year,legendBSM.Data(),1.0,isBlinded,"2.5 < |#eta^{j}| < 3.5, p_{T}^{j} > 100 GeV",1,applyScaling,mlfitResult.Data(),channelName.Data());
    finalPlot(0,1,"Charged energy fraction",""                ,Form("anaZ/fillhisto_zAnalysis%d_%d_299.root",whichCondorJob,year),"dy_1jsel_eta2p5_3p5_ptgt100_chEFmm"  ,1,year,legendBSM.Data(),1.0,isBlinded,"2.5 < |#eta^{j}| < 3.5, p_{T}^{j} > 100 GeV",1,applyScaling,mlfitResult.Data(),channelName.Data());
    finalPlot(0,1,"Charged energy fraction",""                ,Form("anaZ/fillhisto_zAnalysis%d_%d_299.root",whichCondorJob,year),"dy_1jsel_eta2p5_3p5_ptgt100_chEFem"  ,1,year,legendBSM.Data(),1.0,isBlinded,"2.5 < |#eta^{j}| < 3.5, p_{T}^{j} > 100 GeV",1,applyScaling,mlfitResult.Data(),channelName.Data());
    ...
    finalPlot(0,1,"p_{T}^{miss}","GeV",Form("anaZ/fillhisto_sswwAnalysis%d_%d_10.root",whichCondorJob,year),"sswwvbs_ptmiss", 0,year,legendBSM.Data(),SF_DY,isBlinded,"",1,applyScaling,mlfitResult.Data(),channelName.Data());
    finalPlot(0,1,"p_{T}^{miss}","GeV",Form("anaZ/fillhisto_sswwAnalysis%d_%d_11.root",whichCondorJob,year),"sswwbvbs_ptmiss", 0,year,legendBSM.Data(),SF_DY,isNeverBlinded,"",1,applyScaling,mlfitResult.Data(),channelName.Data());

    finalPlot(0,1,"Lepton type","",Form("anaZ/fillhisto_sswwAnalysis%d_%d_12.root",whichCondorJob,year),"sswwvbssel_ltype", 0,year,legendBSM.Data(),SF_DY,isBlinded,"",1,applyScaling,mlfitResult.Data(),channelName.Data());
    finalPlot(0,1,"Lepton type","",Form("anaZ/fillhisto_sswwAnalysis%d_%d_13.root",whichCondorJob,year),"sswwbvbssel_ltype", 0,year,legendBSM.Data(),SF_DY,isNeverBlinded,"",1,applyScaling,mlfitResult.Data(),channelName.Data());
    finalPlot(0,1,"N_{jets}","",Form("anaZ/fillhisto_sswwAnalysis%d_%d_14.root",whichCondorJob,year),"sswwvbssel_njets", 0,year,legendBSM.Data(),SF_DY,isBlinded,"",1,applyScaling,mlfitResult.Data(),channelName.Data());
    finalPlot(0,1,"N_{jets}","",Form("anaZ/fillhisto_sswwAnalysis%d_%d_15.root",whichCondorJob,year),"sswwbvbssel_njets", 0,year,legendBSM.Data(),SF_DY,isNeverBlinded,"",1,applyScaling,mlfitResult.Data(),channelName.Data());
    finalPlot(0,1,"m_{jj}","GeV",Form("anaZ/fillhisto_sswwAnalysis%d_%d_16.root",whichCondorJob,year),"sswwvbssel_mjj", 0,year,legendBSM.Data(),SF_DY,isBlinded,"",1,applyScaling,mlfitResult.Data(),channelName.Data());
    finalPlot(0,1,"m_{jj}","GeV",Form("anaZ/fillhisto_sswwAnalysis%d_%d_17.root",whichCondorJob,year),"sswwbvbssel_mjj", 0,year,legendBSM.Data(),SF_DY,isNeverBlinded,"",1,applyScaling,mlfitResult.Data(),channelName.Data());
    finalPlot(0,1,"#Delta#eta_{jj}","",Form("anaZ/fillhisto_sswwAnalysis%d_%d_18.root",whichCondorJob,year),"sswwvbssel_detajj", 0,year,legendBSM.Data(),SF_DY,isBlinded,"",1,applyScaling,mlfitResult.Data(),channelName.Data());
    finalPlot(0,1,"#Delta#eta_{jj}","",Form("anaZ/fillhisto_sswwAnalysis%d_%d_19.root",whichCondorJob,year),"sswwbvbssel_detajj", 0,year,legendBSM.Data(),SF_DY,isNeverBlinded,"",1,applyScaling,mlfitResult.Data(),channelName.Data());
    finalPlot(0,1,"#Delta#phi_{jj}","",Form("anaZ/fillhisto_sswwAnalysis%d_%d_20.root",whichCondorJob,year),"sswwvbssel_dphijj", 0,year,legendBSM.Data(),SF_DY,isBlinded,"",1,applyScaling,mlfitResult.Data(),channelName.Data());
    finalPlot(0,1,"#Delta#phi_{jj}","",Form("anaZ/fillhisto_sswwAnalysis%d_%d_21.root",whichCondorJob,year),"sswwbvbssel_dphijj", 0,year,legendBSM.Data(),SF_DY,isNeverBlinded,"",1,applyScaling,mlfitResult.Data(),channelName.Data());
    finalPlot(0,1,"Zep(V)","",Form("anaZ/fillhisto_sswwAnalysis%d_%d_22.root",whichCondorJob,year),"sswwvbssel_zepvv", 0,year,legendBSM.Data(),SF_DY,isBlinded,"",1,applyScaling,mlfitResult.Data(),channelName.Data());
    finalPlot(0,1,"Zep(V)","",Form("anaZ/fillhisto_sswwAnalysis%d_%d_23.root",whichCondorJob,year),"sswwbvbssel_zepvv", 0,year,legendBSM.Data(),SF_DY,isNeverBlinded,"",1,applyScaling,mlfitResult.Data(),channelName.Data());
    finalPlot(0,1,"BDT","",Form("anaZ/fillhisto_sswwAnalysis%d_%d_24.root",whichCondorJob,year),"sswwvbssel_bdt_vbfincl", 0,year,legendBSM.Data(),SF_DY,isBlinded,"",1,applyScaling,mlfitResult.Data(),channelName.Data());
    finalPlot(0,1,"BDT","",Form("anaZ/fillhisto_sswwAnalysis%d_%d_25.root",whichCondorJob,year),"sswwbvbssel_bdt_vbfincl", 0,year,legendBSM.Data(),SF_DY,isNeverBlinded,"",1,applyScaling,mlfitResult.Data(),channelName.Data());
    finalPlot(0,1,"p_{T}^{j1}","GeV",Form("anaZ/fillhisto_sswwAnalysis%d_%d_26.root",whichCondorJob,year),"sswwvbssel_ptj1", 0,year,legendBSM.Data(),SF_DY,isBlinded,"",1,applyScaling,mlfitResult.Data(),channelName.Data());
    finalPlot(0,1,"p_{T}^{j1}","GeV",Form("anaZ/fillhisto_sswwAnalysis%d_%d_27.root",whichCondorJob,year),"sswwbvbssel_ptj1", 0,year,legendBSM.Data(),SF_DY,isNeverBlinded,"",1,applyScaling,mlfitResult.Data(),channelName.Data());
    finalPlot(0,1,"p_{T}^{j2}","GeV",Form("anaZ/fillhisto_sswwAnalysis%d_%d_28.root",whichCondorJob,year),"sswwvbssel_ptj2", 0,year,legendBSM.Data(),SF_DY,isBlinded,"",1,applyScaling,mlfitResult.Data(),channelName.Data());
    finalPlot(0,1,"p_{T}^{j2}","GeV",Form("anaZ/fillhisto_sswwAnalysis%d_%d_29.root",whichCondorJob,year),"sswwbvbssel_ptj2", 0,year,legendBSM.Data(),SF_DY,isNeverBlinded,"",1,applyScaling,mlfitResult.Data(),channelName.Data());
    finalPlot(0,1,"#eta_{T}^{j1}","",Form("anaZ/fillhisto_sswwAnalysis%d_%d_30.root",whichCondorJob,year),"sswwvbssel_etaj1", 0,year,legendBSM.Data(),SF_DY,isBlinded,"",1,applyScaling,mlfitResult.Data(),channelName.Data());
    finalPlot(0,1,"#eta_{T}^{j1}","",Form("anaZ/fillhisto_sswwAnalysis%d_%d_31.root",whichCondorJob,year),"sswwbvbssel_etaj1", 0,year,legendBSM.Data(),SF_DY,isNeverBlinded,"",1,applyScaling,mlfitResult.Data(),channelName.Data());
    finalPlot(0,1,"#eta_{T}^{j2}","",Form("anaZ/fillhisto_sswwAnalysis%d_%d_32.root",whichCondorJob,year),"sswwvbssel_etaj2", 0,year,legendBSM.Data(),SF_DY,isBlinded,"",1,applyScaling,mlfitResult.Data(),channelName.Data());
    finalPlot(0,1,"#eta_{T}^{j2}","",Form("anaZ/fillhisto_sswwAnalysis%d_%d_33.root",whichCondorJob,year),"sswwbvbssel_etaj2", 0,year,legendBSM.Data(),SF_DY,isNeverBlinded,"",1,applyScaling,mlfitResult.Data(),channelName.Data());

    finalPlot(0,1,"#Delta#eta_{jj}","",Form("anaZ/fillhisto_sswwAnalysis%d_%d_34.root",whichCondorJob,year),"sswwjjsel_detajj", 0,year,legendBSM.Data(),SF_DY,isNeverBlinded,"",1,applyScaling,mlfitResult.Data(),channelName.Data());
    finalPlot(0,1,"#Delta#eta_{jj}","",Form("anaZ/fillhisto_sswwAnalysis%d_%d_35.root",whichCondorJob,year),"sswwbjjsel_detajj", 0,year,legendBSM.Data(),SF_DY,isNeverBlinded,"",1,applyScaling,mlfitResult.Data(),channelName.Data());
    finalPlot(0,1,"Lepton type","",Form("anaZ/fillhisto_sswwAnalysis%d_%d_36.root",whichCondorJob,year),"sswwjjsel_ltype", 0,year,legendBSM.Data(),SF_DY,isNeverBlinded,"",1,applyScaling,mlfitResult.Data(),channelName.Data());
    finalPlot(0,1,"Lepton type","",Form("anaZ/fillhisto_sswwAnalysis%d_%d_37.root",whichCondorJob,year),"sswwbjjsel_ltype", 0,year,legendBSM.Data(),SF_DY,isNeverBlinded,"",1,applyScaling,mlfitResult.Data(),channelName.Data());
    finalPlot(0,1,"N_{jets}","",Form("anaZ/fillhisto_sswwAnalysis%d_%d_38.root",whichCondorJob,year),"sswwjjsel_njets", 0,year,legendBSM.Data(),SF_DY,isNeverBlinded,"",1,applyScaling,mlfitResult.Data(),channelName.Data());
    finalPlot(0,1,"N_{jets}","",Form("anaZ/fillhisto_sswwAnalysis%d_%d_39.root",whichCondorJob,year),"sswwbjjsel_njets", 0,year,legendBSM.Data(),SF_DY,isNeverBlinded,"",1,applyScaling,mlfitResult.Data(),channelName.Data());
    finalPlot(0,1,"p_{T}^{j1}","GeV",Form("anaZ/fillhisto_sswwAnalysis%d_%d_40.root",whichCondorJob,year),"sswwjjsel_ptj1", 0,year,legendBSM.Data(),SF_DY,isNeverBlinded,"",1,applyScaling,mlfitResult.Data(),channelName.Data());
    finalPlot(0,1,"p_{T}^{j1}","GeV",Form("anaZ/fillhisto_sswwAnalysis%d_%d_41.root",whichCondorJob,year),"sswwbjjsel_ptj1", 0,year,legendBSM.Data(),SF_DY,isNeverBlinded,"",1,applyScaling,mlfitResult.Data(),channelName.Data());
    finalPlot(0,1,"p_{T}^{j2}","GeV",Form("anaZ/fillhisto_sswwAnalysis%d_%d_42.root",whichCondorJob,year),"sswwjjsel_ptj2", 0,year,legendBSM.Data(),SF_DY,isNeverBlinded,"",1,applyScaling,mlfitResult.Data(),channelName.Data());
    finalPlot(0,1,"p_{T}^{j2}","GeV",Form("anaZ/fillhisto_sswwAnalysis%d_%d_43.root",whichCondorJob,year),"sswwbjjsel_ptj2", 0,year,legendBSM.Data(),SF_DY,isNeverBlinded,"",1,applyScaling,mlfitResult.Data(),channelName.Data());
    finalPlot(0,1,"#eta_{T}^{j1}","",Form("anaZ/fillhisto_sswwAnalysis%d_%d_44.root",whichCondorJob,year),"sswwjjsel_etaj1", 0,year,legendBSM.Data(),SF_DY,isNeverBlinded,"",1,applyScaling,mlfitResult.Data(),channelName.Data());
    finalPlot(0,1,"#eta_{T}^{j1}","",Form("anaZ/fillhisto_sswwAnalysis%d_%d_45.root",whichCondorJob,year),"sswwbjjsel_etaj1", 0,year,legendBSM.Data(),SF_DY,isNeverBlinded,"",1,applyScaling,mlfitResult.Data(),channelName.Data());
    finalPlot(0,1,"#eta_{T}^{j2}","",Form("anaZ/fillhisto_sswwAnalysis%d_%d_46.root",whichCondorJob,year),"sswwjjsel_etaj2", 0,year,legendBSM.Data(),SF_DY,isNeverBlinded,"",1,applyScaling,mlfitResult.Data(),channelName.Data());
    finalPlot(0,1,"#eta_{T}^{j2}","",Form("anaZ/fillhisto_sswwAnalysis%d_%d_47.root",whichCondorJob,year),"sswwbjjsel_etaj2", 0,year,legendBSM.Data(),SF_DY,isNeverBlinded,"",1,applyScaling,mlfitResult.Data(),channelName.Data());

    finalPlot(0,1,"p_{T}^{l1}","GeV",Form("anaZ/fillhisto_sswwAnalysis%d_%d_50.root",whichCondorJob,year),"ssww_preselmm_ptl1", 0,year,legendBSM.Data(),SF_DY,isNeverBlinded,"",1,applyScaling,mlfitResult.Data(),channelName.Data());
    finalPlot(0,1,"p_{T}^{l1}","GeV",Form("anaZ/fillhisto_sswwAnalysis%d_%d_51.root",whichCondorJob,year),"ssww_preselee_ptl1", 0,year,legendBSM.Data(),SF_DY,isNeverBlinded,"",1,applyScaling,mlfitResult.Data(),channelName.Data());
    finalPlot(0,1,"p_{T}^{l1}","GeV",Form("anaZ/fillhisto_sswwAnalysis%d_%d_52.root",whichCondorJob,year),"ssww_preselme_ptl1", 0,year,legendBSM.Data(),SF_DY,isNeverBlinded,"",1,applyScaling,mlfitResult.Data(),channelName.Data());
    finalPlot(0,1,"p_{T}^{l1}","GeV",Form("anaZ/fillhisto_sswwAnalysis%d_%d_53.root",whichCondorJob,year),"ssww_preselem_ptl1", 0,year,legendBSM.Data(),SF_DY,isNeverBlinded,"",1,applyScaling,mlfitResult.Data(),channelName.Data());
    finalPlot(0,1,"p_{T}^{l1}","GeV",Form("anaZ/fillhisto_sswwAnalysis%d_%d_54.root",whichCondorJob,year),"ssww_preselbmm_ptl1", 0,year,legendBSM.Data(),SF_DY,isNeverBlinded,"",1,applyScaling,mlfitResult.Data(),channelName.Data());
    finalPlot(0,1,"p_{T}^{l1}","GeV",Form("anaZ/fillhisto_sswwAnalysis%d_%d_55.root",whichCondorJob,year),"ssww_preselbee_ptl1", 0,year,legendBSM.Data(),SF_DY,isNeverBlinded,"",1,applyScaling,mlfitResult.Data(),channelName.Data());
    finalPlot(0,1,"p_{T}^{l1}","GeV",Form("anaZ/fillhisto_sswwAnalysis%d_%d_56.root",whichCondorJob,year),"ssww_preselbme_ptl1", 0,year,legendBSM.Data(),SF_DY,isNeverBlinded,"",1,applyScaling,mlfitResult.Data(),channelName.Data());
    finalPlot(0,1,"p_{T}^{l1}","GeV",Form("anaZ/fillhisto_sswwAnalysis%d_%d_57.root",whichCondorJob,year),"ssww_preselbem_ptl1", 0,year,legendBSM.Data(),SF_DY,isNeverBlinded,"",1,applyScaling,mlfitResult.Data(),channelName.Data());
    finalPlot(0,1,"p_{T}^{l2}","GeV",Form("anaZ/fillhisto_sswwAnalysis%d_%d_58.root",whichCondorJob,year),"ssww_preselmm_ptl2", 0,year,legendBSM.Data(),SF_DY,isNeverBlinded,"",1,applyScaling,mlfitResult.Data(),channelName.Data());
    finalPlot(0,1,"p_{T}^{l2}","GeV",Form("anaZ/fillhisto_sswwAnalysis%d_%d_59.root",whichCondorJob,year),"ssww_preselee_ptl2", 0,year,legendBSM.Data(),SF_DY,isNeverBlinded,"",1,applyScaling,mlfitResult.Data(),channelName.Data());
    finalPlot(0,1,"p_{T}^{l2}","GeV",Form("anaZ/fillhisto_sswwAnalysis%d_%d_60.root",whichCondorJob,year),"ssww_preselme_ptl2", 0,year,legendBSM.Data(),SF_DY,isNeverBlinded,"",1,applyScaling,mlfitResult.Data(),channelName.Data());
    finalPlot(0,1,"p_{T}^{l2}","GeV",Form("anaZ/fillhisto_sswwAnalysis%d_%d_61.root",whichCondorJob,year),"ssww_preselem_ptl2", 0,year,legendBSM.Data(),SF_DY,isNeverBlinded,"",1,applyScaling,mlfitResult.Data(),channelName.Data());
    finalPlot(0,1,"p_{T}^{l2}","GeV",Form("anaZ/fillhisto_sswwAnalysis%d_%d_62.root",whichCondorJob,year),"ssww_preselbmm_ptl2", 0,year,legendBSM.Data(),SF_DY,isNeverBlinded,"",1,applyScaling,mlfitResult.Data(),channelName.Data());
    finalPlot(0,1,"p_{T}^{l2}","GeV",Form("anaZ/fillhisto_sswwAnalysis%d_%d_63.root",whichCondorJob,year),"ssww_preselbee_ptl2", 0,year,legendBSM.Data(),SF_DY,isNeverBlinded,"",1,applyScaling,mlfitResult.Data(),channelName.Data());
    finalPlot(0,1,"p_{T}^{l2}","GeV",Form("anaZ/fillhisto_sswwAnalysis%d_%d_64.root",whichCondorJob,year),"ssww_preselbme_ptl2", 0,year,legendBSM.Data(),SF_DY,isNeverBlinded,"",1,applyScaling,mlfitResult.Data(),channelName.Data());
    finalPlot(0,1,"p_{T}^{l2}","GeV",Form("anaZ/fillhisto_sswwAnalysis%d_%d_65.root",whichCondorJob,year),"ssww_preselbem_ptl2", 0,year,legendBSM.Data(),SF_DY,isNeverBlinded,"",1,applyScaling,mlfitResult.Data(),channelName.Data());
    finalPlot(0,1,"#eta_{T}^{l1}","GeV",Form("anaZ/fillhisto_sswwAnalysis%d_%d_66.root",whichCondorJob,year),"ssww_preselmm_etal1", 0,year,legendBSM.Data(),SF_DY,isNeverBlinded,"",1,applyScaling,mlfitResult.Data(),channelName.Data());
    finalPlot(0,1,"#eta_{T}^{l1}","GeV",Form("anaZ/fillhisto_sswwAnalysis%d_%d_67.root",whichCondorJob,year),"ssww_preselee_etal1", 0,year,legendBSM.Data(),SF_DY,isNeverBlinded,"",1,applyScaling,mlfitResult.Data(),channelName.Data());
    finalPlot(0,1,"#eta_{T}^{l1}","GeV",Form("anaZ/fillhisto_sswwAnalysis%d_%d_68.root",whichCondorJob,year),"ssww_preselme_etal1", 0,year,legendBSM.Data(),SF_DY,isNeverBlinded,"",1,applyScaling,mlfitResult.Data(),channelName.Data());
    finalPlot(0,1,"#eta_{T}^{l1}","GeV",Form("anaZ/fillhisto_sswwAnalysis%d_%d_69.root",whichCondorJob,year),"ssww_preselem_etal1", 0,year,legendBSM.Data(),SF_DY,isNeverBlinded,"",1,applyScaling,mlfitResult.Data(),channelName.Data());
    finalPlot(0,1,"#eta_{T}^{l1}","GeV",Form("anaZ/fillhisto_sswwAnalysis%d_%d_70.root",whichCondorJob,year),"ssww_preselbmm_etal1", 0,year,legendBSM.Data(),SF_DY,isNeverBlinded,"",1,applyScaling,mlfitResult.Data(),channelName.Data());
    finalPlot(0,1,"#eta_{T}^{l1}","GeV",Form("anaZ/fillhisto_sswwAnalysis%d_%d_71.root",whichCondorJob,year),"ssww_preselbee_etal1", 0,year,legendBSM.Data(),SF_DY,isNeverBlinded,"",1,applyScaling,mlfitResult.Data(),channelName.Data());
    finalPlot(0,1,"#eta_{T}^{l1}","GeV",Form("anaZ/fillhisto_sswwAnalysis%d_%d_72.root",whichCondorJob,year),"ssww_preselbme_etal1", 0,year,legendBSM.Data(),SF_DY,isNeverBlinded,"",1,applyScaling,mlfitResult.Data(),channelName.Data());
    finalPlot(0,1,"#eta_{T}^{l1}","GeV",Form("anaZ/fillhisto_sswwAnalysis%d_%d_73.root",whichCondorJob,year),"ssww_preselbem_etal1", 0,year,legendBSM.Data(),SF_DY,isNeverBlinded,"",1,applyScaling,mlfitResult.Data(),channelName.Data());
    finalPlot(0,1,"#eta_{T}^{l2}","GeV",Form("anaZ/fillhisto_sswwAnalysis%d_%d_74.root",whichCondorJob,year),"ssww_preselmm_etal2", 0,year,legendBSM.Data(),SF_DY,isNeverBlinded,"",1,applyScaling,mlfitResult.Data(),channelName.Data());
    finalPlot(0,1,"#eta_{T}^{l2}","GeV",Form("anaZ/fillhisto_sswwAnalysis%d_%d_75.root",whichCondorJob,year),"ssww_preselee_etal2", 0,year,legendBSM.Data(),SF_DY,isNeverBlinded,"",1,applyScaling,mlfitResult.Data(),channelName.Data());
    finalPlot(0,1,"#eta_{T}^{l2}","GeV",Form("anaZ/fillhisto_sswwAnalysis%d_%d_76.root",whichCondorJob,year),"ssww_preselme_etal2", 0,year,legendBSM.Data(),SF_DY,isNeverBlinded,"",1,applyScaling,mlfitResult.Data(),channelName.Data());
    finalPlot(0,1,"#eta_{T}^{l2}","GeV",Form("anaZ/fillhisto_sswwAnalysis%d_%d_77.root",whichCondorJob,year),"ssww_preselem_etal2", 0,year,legendBSM.Data(),SF_DY,isNeverBlinded,"",1,applyScaling,mlfitResult.Data(),channelName.Data());
    finalPlot(0,1,"#eta_{T}^{l2}","GeV",Form("anaZ/fillhisto_sswwAnalysis%d_%d_78.root",whichCondorJob,year),"ssww_preselbmm_etal2", 0,year,legendBSM.Data(),SF_DY,isNeverBlinded,"",1,applyScaling,mlfitResult.Data(),channelName.Data());
    finalPlot(0,1,"#eta_{T}^{l2}","GeV",Form("anaZ/fillhisto_sswwAnalysis%d_%d_79.root",whichCondorJob,year),"ssww_preselbee_etal2", 0,year,legendBSM.Data(),SF_DY,isNeverBlinded,"",1,applyScaling,mlfitResult.Data(),channelName.Data());
    finalPlot(0,1,"#eta_{T}^{l2}","GeV",Form("anaZ/fillhisto_sswwAnalysis%d_%d_80.root",whichCondorJob,year),"ssww_preselbme_etal2", 0,year,legendBSM.Data(),SF_DY,isNeverBlinded,"",1,applyScaling,mlfitResult.Data(),channelName.Data());
    finalPlot(0,1,"#eta_{T}^{l2}","GeV",Form("anaZ/fillhisto_sswwAnalysis%d_%d_81.root",whichCondorJob,year),"ssww_preselbem_etal2", 0,year,legendBSM.Data(),SF_DY,isNeverBlinded,"",1,applyScaling,mlfitResult.Data(),channelName.Data());
  }
  else if(nsel == "zmet"){
    legendBSM="";
    isNeverBlinded=0;
    ...
    finalPlot(0,1,"p_{T}^{miss} significance","",Form("anaZ/fillhisto_zmetAnalysis%d_%d_10.root",whichCondorJob,year),"zmetllsel_metsig", 0,year,legendBSM.Data(),SF_DY,isBlinded,"",1,applyScaling,mlfitResult.Data(),channelName.Data());
    finalPlot(0,1,"p_{T}^{miss} significance","",Form("anaZ/fillhisto_zmetAnalysis%d_%d_11.root",whichCondorJob,year),"zmetemsel_metsig", 0,year,legendBSM.Data(),SF_DY,isBlinded,"",1,applyScaling,mlfitResult.Data(),channelName.Data());
    finalPlot(0,1,"jetPtFrac","",Form("anaZ/fillhisto_zmetAnalysis%d_%d_12.root",whichCondorJob,year),"zmetllsel_jetptfrac", 0,year,legendBSM.Data(),SF_DY,isBlinded,"",1,applyScaling,mlfitResult.Data(),channelName.Data());
    finalPlot(0,1,"jetPtFrac","",Form("anaZ/fillhisto_zmetAnalysis%d_%d_13.root",whichCondorJob,year),"zmetemsel_jetptfrac", 0,year,legendBSM.Data(),SF_DY,isBlinded,"",1,applyScaling,mlfitResult.Data(),channelName.Data());
    ...
    finalPlot(0,1,"jetPtFrac","",Form("anaZ/fillhisto_zmetAnalysis%d_%d_16.root",whichCondorJob,year),"zmetllsel_jetptfrac2", 0,year,legendBSM.Data(),SF_DY,isBlinded,"",1,applyScaling,mlfitResult.Data(),channelName.Data());
    finalPlot(0,1,"jetPtFrac","",Form("anaZ/fillhisto_zmetAnalysis%d_%d_17.root",whichCondorJob,year),"zmetemsel_jetptfrac2", 0,year,legendBSM.Data(),SF_DY,isBlinded,"",1,applyScaling,mlfitResult.Data(),channelName.Data());
    ...
    finalPlot(0,1,"p_{T}^{l1}","GeV",Form("anaZ/fillhisto_zmetAnalysis%d_%d_26.root",whichCondorJob,year),"zmetllsel_ptl1", 0,year,legendBSM.Data(),SF_DY,isBlinded,"",1,applyScaling,mlfitResult.Data(),channelName.Data());
    finalPlot(0,1,"p_{T}^{l1}","GeV",Form("anaZ/fillhisto_zmetAnalysis%d_%d_27.root",whichCondorJob,year),"zmetemsel_ptl1", 0,year,legendBSM.Data(),SF_DY,isBlinded,"",1,applyScaling,mlfitResult.Data(),channelName.Data());
    finalPlot(0,1,"p_{T}^{l2}","GeV",Form("anaZ/fillhisto_zmetAnalysis%d_%d_28.root",whichCondorJob,year),"zmetllsel_ptl2", 0,year,legendBSM.Data(),SF_DY,isBlinded,"",1,applyScaling,mlfitResult.Data(),channelName.Data());
    finalPlot(0,1,"p_{T}^{l2}","GeV",Form("anaZ/fillhisto_zmetAnalysis%d_%d_29.root",whichCondorJob,year),"zmetemsel_ptl2", 0,year,legendBSM.Data(),SF_DY,isBlinded,"",1,applyScaling,mlfitResult.Data(),channelName.Data());
    ...
    finalPlot(0,1,"p_{T}^{l1}","GeV",Form("anaZ/fillhisto_wwAnalysis%d_%d_26.root",whichCondorJob,year),"ww_sel0_ssx_ptl1",0,year,legendBSM.Data(),1.0,isBlinded,"",1,applyScaling,mlfitResult.Data(),channelName.Data());
    finalPlot(0,1,"p_{T}^{l1}","GeV",Form("anaZ/fillhisto_wwAnalysis%d_%d_27.root",whichCondorJob,year),"ww_sel0_wwx_ptl1",0,year,legendBSM.Data(),1.0,isBlinded,"",1,applyScaling,mlfitResult.Data(),channelName.Data());
    finalPlot(0,1,"p_{T}^{l1}","GeV",Form("anaZ/fillhisto_wwAnalysis%d_%d_28.root",whichCondorJob,year),"ww_sel0_ztt_ptl1",0,year,legendBSM.Data(),1.0,isBlinded,"",1,applyScaling,mlfitResult.Data(),channelName.Data());
    finalPlot(0,1,"p_{T}^{l1}","GeV",Form("anaZ/fillhisto_wwAnalysis%d_%d_29.root",whichCondorJob,year),"ww_sel0_top_ptl1",0,year,legendBSM.Data(),1.0,isBlinded,"",1,applyScaling,mlfitResult.Data(),channelName.Data());

    finalPlot(0,1,"p_{T}^{l2}","GeV",Form("anaZ/fillhisto_wwAnalysis%d_%d_30.root",whichCondorJob,year),"ww_sel0_ssx_ptl2",0,year,legendBSM.Data(),1.0,isBlinded,"",1,applyScaling,mlfitResult.Data(),channelName.Data());
    finalPlot(0,1,"p_{T}^{l2}","GeV",Form("anaZ/fillhisto_wwAnalysis%d_%d_31.root",whichCondorJob,year),"ww_sel0_wwx_ptl2",0,year,legendBSM.Data(),1.0,isBlinded,"",1,applyScaling,mlfitResult.Data(),channelName.Data());
    finalPlot(0,1,"p_{T}^{l2}","GeV",Form("anaZ/fillhisto_wwAnalysis%d_%d_32.root",whichCondorJob,year),"ww_sel0_ztt_ptl2",0,year,legendBSM.Data(),1.0,isBlinded,"",1,applyScaling,mlfitResult.Data(),channelName.Data());
    finalPlot(0,1,"p_{T}^{l2}","GeV",Form("anaZ/fillhisto_wwAnalysis%d_%d_33.root",whichCondorJob,year),"ww_sel0_top_ptl2",0,year,legendBSM.Data(),1.0,isBlinded,"",1,applyScaling,mlfitResult.Data(),channelName.Data());
    ...
    finalPlot(0,1,"#eta_{j}","",Form("anaZ/fillhisto_wwAnalysis%d_%d_60.root",whichCondorJob,year),"ww_sel0_wwx_etaj",0,year,legendBSM.Data(),1.0,isBlinded,"",1,applyScaling,mlfitResult.Data(),channelName.Data());
    finalPlot(0,1,"#eta_{j}","",Form("anaZ/fillhisto_wwAnalysis%d_%d_63.root",whichCondorJob,year),"ww_sel0_ztt_etaj",0,year,legendBSM.Data(),1.0,isBlinded,"",1,applyScaling,mlfitResult.Data(),channelName.Data());
    finalPlot(0,1,"#eta_{j}","",Form("anaZ/fillhisto_wwAnalysis%d_%d_66.root",whichCondorJob,year),"ww_sel0_top_etaj",0,year,legendBSM.Data(),1.0,isBlinded,"",1,applyScaling,mlfitResult.Data(),channelName.Data());
