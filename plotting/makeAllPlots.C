...
void makeAllPlots(TString nsel, int applyScaling, int year, int whichCondorJob = 1001, bool doMerging = true){
  ...
  if(nsel.Contains(".root") == true){
    ...
    finalPlot(0,1,"m_{ee}","GeV"   ,Form("anaZ/fillhisto_zAnalysis%d_%d_390.root",whichCondorJob,year),"dy_tighteesel_corr_os_mass"  ,0,year,legendBSM.Data(),1.0,isBlinded,"",1,applyScaling,mlfitResult.Data(),channelName.Data());
    finalPlot(0,1,"m_{ee}","GeV"   ,Form("anaZ/fillhisto_zAnalysis%d_%d_391.root",whichCondorJob,year),"dy_tighteesel_corr_ss_mass"  ,0,year,legendBSM.Data(),1.0,isBlinded,"",1,applyScaling,mlfitResult.Data(),channelName.Data());
    finalPlot(0,1,"p_{T}^{e}","GeV",Form("anaZ/fillhisto_zAnalysis%d_%d_392.root",whichCondorJob,year),"dy_tighteesel_corr_os_pte"   ,0,year,legendBSM.Data(),1.0,isBlinded,"",1,applyScaling,mlfitResult.Data(),channelName.Data());
    finalPlot(0,1,"p_{T}^{e}","GeV",Form("anaZ/fillhisto_zAnalysis%d_%d_393.root",whichCondorJob,year),"dy_tighteesel_corr_ss_pte"   ,0,year,legendBSM.Data(),1.0,isBlinded,"",1,applyScaling,mlfitResult.Data(),channelName.Data());
    finalPlot(0,1,"#eta^{e}",""    ,Form("anaZ/fillhisto_zAnalysis%d_%d_394.root",whichCondorJob,year),"dy_tighteesel_corr_os_etae"  ,0,year,legendBSM.Data(),1.0,isBlinded,"",1,applyScaling,mlfitResult.Data(),channelName.Data());
    finalPlot(0,1,"#eta^{e}",""    ,Form("anaZ/fillhisto_zAnalysis%d_%d_395.root",whichCondorJob,year),"dy_tighteesel_corr_ss_etae"  ,0,year,legendBSM.Data(),1.0,isBlinded,"",1,applyScaling,mlfitResult.Data(),channelName.Data());
    ...
    finalPlot(0,1,"m_{ll}","GeV",Form("anaZ/fillhisto_zAnalysis%d_%d_157.root",whichCondorJob,year),"dy_vbssel_mmm",0,year,legendBSM.Data(),1.0,isBlinded,"",1,applyScaling,mlfitResult.Data(),channelName.Data());
    finalPlot(0,1,"m_{ll}","GeV",Form("anaZ/fillhisto_zAnalysis%d_%d_158.root",whichCondorJob,year),"dy_vbssel_mem",0,year,legendBSM.Data(),1.0,isBlinded,"",1,applyScaling,mlfitResult.Data(),channelName.Data());
    finalPlot(0,1,"m_{ll}","GeV",Form("anaZ/fillhisto_zAnalysis%d_%d_159.root",whichCondorJob,year),"dy_vbssel_mee",0,year,legendBSM.Data(),1.0,isBlinded,"",1,applyScaling,mlfitResult.Data(),channelName.Data());

    finalPlot(0,1,"m_{jj}","GeV",Form("anaZ/fillhisto_zAnalysis%d_%d_160.root",whichCondorJob,year),"dy_vbssel_mjjem",0,year,legendBSM.Data(),1.0,isBlinded,"",1,applyScaling,mlfitResult.Data(),channelName.Data());
    finalPlot(0,1,"m_{jj}","GeV",Form("anaZ/fillhisto_zAnalysis%d_%d_161.root",whichCondorJob,year),"dy_vbssel_mjjee",0,year,legendBSM.Data(),1.0,isBlinded,"",1,applyScaling,mlfitResult.Data(),channelName.Data());

    finalPlot(0,1,"N_{j}",""    ,Form("anaZ/fillhisto_zAnalysis%d_%d_162.root",whichCondorJob,year),"dy_vbssel_njetsem",0,year,legendBSM.Data(),1.0,isBlinded,"",1,applyScaling,mlfitResult.Data(),channelName.Data());
    finalPlot(0,1,"N_{j}",""    ,Form("anaZ/fillhisto_zAnalysis%d_%d_163.root",whichCondorJob,year),"dy_vbssel_njetsee",0,year,legendBSM.Data(),1.0,isBlinded,"",1,applyScaling,mlfitResult.Data(),channelName.Data());

    finalPlot(0,1,"#Delta#eta_{jj}","",Form("anaZ/fillhisto_zAnalysis%d_%d_164.root",whichCondorJob,year),"dy_vbssel_detajjem",0,year,legendBSM.Data(),1.0,isBlinded,"",1,applyScaling,mlfitResult.Data(),channelName.Data());
    finalPlot(0,1,"#Delta#eta_{jj}","",Form("anaZ/fillhisto_zAnalysis%d_%d_165.root",whichCondorJob,year),"dy_vbssel_detajjee",0,year,legendBSM.Data(),1.0,isBlinded,"",1,applyScaling,mlfitResult.Data(),channelName.Data());
