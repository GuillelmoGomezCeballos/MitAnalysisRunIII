...
void makeAllPlots(TString nsel, int applyScaling, int year, int whichCondorJob = 1001, bool doMerging = true){
  ...
  if(nsel.Contains(".root") == true){
    ...
    finalPlot(0,1,"#eta_{T}^{#mu}","",Form("anaZ/fillhisto_zAnalysis%d_%d_14.root",whichCondorJob,year),"dy_zsel_etam_long",0,year,legendBSM.Data(),1.0,isBlinded,"#mu#mu",1,applyScaling,mlfitResult.Data(),channelName.Data());
    finalPlot(0,1,"#eta_{T}^{#mu}","",Form("anaZ/fillhisto_zAnalysis%d_%d_15.root",whichCondorJob,year),"dy_zsel_etam"     ,0,year,legendBSM.Data(),1.0,isBlinded,"#mu#mu",1,applyScaling,mlfitResult.Data(),channelName.Data());
    ...
    finalPlot(0,1,"#eta_{T}^{e}","",Form("anaZ/fillhisto_zAnalysis%d_%d_18.root",whichCondorJob,year),"dy_zsel_etae_long",0,year,legendBSM.Data(),1.0,isBlinded,"ee",1,applyScaling,mlfitResult.Data(),channelName.Data());
    finalPlot(0,1,"#eta_{T}^{e}","",Form("anaZ/fillhisto_zAnalysis%d_%d_19.root",whichCondorJob,year),"dy_zsel_etae"	 ,0,year,legendBSM.Data(),1.0,isBlinded,"ee",1,applyScaling,mlfitResult.Data(),channelName.Data());
    ...
    finalPlot(0,1,"#eta_{T}^{e}","",Form("anaZ/fillhisto_zAnalysis%d_%d_394.root",whichCondorJob,year),"dy_tighteesel_corr_os_etae"  ,0,year,legendBSM.Data(),1.0,isBlinded,"",1,applyScaling,mlfitResult.Data(),channelName.Data());
    finalPlot(0,1,"#eta_{T}^{e}","",Form("anaZ/fillhisto_zAnalysis%d_%d_395.root",whichCondorJob,year),"dy_tighteesel_corr_ss_etae"  ,0,year,legendBSM.Data(),1.0,isBlinded,"",1,applyScaling,mlfitResult.Data(),channelName.Data());
    ...
    finalPlot(0,1,"m_{jj}","GeV",Form("anaZ/fillhisto_zAnalysis%d_%d_157.root",whichCondorJob,year),"dy_vbssel_mjjmm",0,year,legendBSM.Data(),1.0,isBlinded,"",1,applyScaling,mlfitResult.Data(),channelName.Data());
    finalPlot(0,1,"m_{jj}","GeV",Form("anaZ/fillhisto_zAnalysis%d_%d_158.root",whichCondorJob,year),"dy_vbssel_mjjem",0,year,legendBSM.Data(),1.0,isBlinded,"",1,applyScaling,mlfitResult.Data(),channelName.Data());
    finalPlot(0,1,"m_{jj}","GeV",Form("anaZ/fillhisto_zAnalysis%d_%d_159.root",whichCondorJob,year),"dy_vbssel_mjjee",0,year,legendBSM.Data(),1.0,isBlinded,"",1,applyScaling,mlfitResult.Data(),channelName.Data());

    finalPlot(0,1,"p_{T}^{jj}","GeV",Form("anaZ/fillhisto_zAnalysis%d_%d_160.root",whichCondorJob,year),"dy_vbssel_ptjjmm",0,year,legendBSM.Data(),1.0,isBlinded,"",1,applyScaling,mlfitResult.Data(),channelName.Data());
    finalPlot(0,1,"p_{T}^{jj}","GeV",Form("anaZ/fillhisto_zAnalysis%d_%d_161.root",whichCondorJob,year),"dy_vbssel_ptjjem",0,year,legendBSM.Data(),1.0,isBlinded,"",1,applyScaling,mlfitResult.Data(),channelName.Data());
    finalPlot(0,1,"p_{T}^{jj}","GeV",Form("anaZ/fillhisto_zAnalysis%d_%d_162.root",whichCondorJob,year),"dy_vbssel_ptjjee",0,year,legendBSM.Data(),1.0,isBlinded,"",1,applyScaling,mlfitResult.Data(),channelName.Data());

    finalPlot(0,1,"#eta max","",Form("anaZ/fillhisto_zAnalysis%d_%d_163.root",whichCondorJob,year),"dy_vbssel_etamax_mm",0,year,legendBSM.Data(),1.0,isBlinded,"",1,applyScaling,mlfitResult.Data(),channelName.Data());
    finalPlot(0,1,"#eta max","",Form("anaZ/fillhisto_zAnalysis%d_%d_164.root",whichCondorJob,year),"dy_vbssel_etamax_em",0,year,legendBSM.Data(),1.0,isBlinded,"",1,applyScaling,mlfitResult.Data(),channelName.Data());
    finalPlot(0,1,"#eta max","",Form("anaZ/fillhisto_zAnalysis%d_%d_165.root",whichCondorJob,year),"dy_vbssel_etamax_ee",0,year,legendBSM.Data(),1.0,isBlinded,"",1,applyScaling,mlfitResult.Data(),channelName.Data());
    ...
    finalPlot(0,1,"|#eta_{T}^{j1}|","",Form("anaZ/fillhisto_wzAnalysis%d_%d_114.root",whichCondorJob,year),"wzvbssel_etaj1", 0,year,legendBSM.Data(),SF_DY,isBlinded,"",1,applyScaling,mlfitResult.Data(),channelName.Data());
    finalPlot(0,1,"|#eta_{T}^{j1}|","",Form("anaZ/fillhisto_wzAnalysis%d_%d_115.root",whichCondorJob,year),"wzbvbssel_etaj1", 0,year,legendBSM.Data(),SF_DY,isNeverBlinded,"",1,applyScaling,mlfitResult.Data(),channelName.Data());
    finalPlot(0,1,"|#eta_{T}^{j2}|","",Form("anaZ/fillhisto_wzAnalysis%d_%d_116.root",whichCondorJob,year),"wzvbssel_etaj2", 0,year,legendBSM.Data(),SF_DY,isBlinded,"",1,applyScaling,mlfitResult.Data(),channelName.Data());
    finalPlot(0,1,"|#eta_{T}^{j2}|","",Form("anaZ/fillhisto_wzAnalysis%d_%d_117.root",whichCondorJob,year),"wzbvbssel_etaj2", 0,year,legendBSM.Data(),SF_DY,isNeverBlinded,"",1,applyScaling,mlfitResult.Data(),channelName.Data());
    ...
    finalPlot(0,1,"#Delta#eta_{jj}","BinWidth",Form("ssww_sswwAnalysis1008_bin0.root")        ,"ssww_sswwAnalysis1008_bin0"       ,0,year,legendBSM.Data(),1.0,isBlinded,"",1,applyScaling,mlfitResult.Data(),channelName.Data());
    finalPlot(0,1,"#Delta#eta_{jj}","BinWidth",Form("ssww_sswwAnalysis1008_bin1.root")        ,"ssww_sswwAnalysis1008_bin1"       ,0,year,legendBSM.Data(),1.0,isBlinded,"",1,applyScaling,mlfitResult.Data(),channelName.Data());
    finalPlot(0,1,"#Delta #phi_{jj}","BinWidth",Form("ssww_sswwAnalysis1009_bin0.root")       ,"ssww_sswwAnalysis1009_bin0"       ,0,year,legendBSM.Data(),1.0,isBlinded,"",1,applyScaling,mlfitResult.Data(),channelName.Data());
    finalPlot(0,1,"#Delta #phi_{jj}","BinWidth",Form("ssww_sswwAnalysis1009_bin1.root")       ,"ssww_sswwAnalysis1009_bin1"       ,0,year,legendBSM.Data(),1.0,isBlinded,"",1,applyScaling,mlfitResult.Data(),channelName.Data());
    ...
    finalPlot(0,1,"#Delta#eta_{jj}","BinWidth",Form("ssww_sswwAnalysis1008_bin0_prefit.root") ,"ssww_sswwAnalysis1008_bin0_prefit",0,year,legendBSM.Data(),1.0,isBlinded,"",1,applyScaling,mlfitResult.Data(),channelName.Data());
    finalPlot(0,1,"#Delta#eta_{jj}","BinWidth",Form("ssww_sswwAnalysis1008_bin1_prefit.root") ,"ssww_sswwAnalysis1008_bin1_prefit",0,year,legendBSM.Data(),1.0,isBlinded,"",1,applyScaling,mlfitResult.Data(),channelName.Data());
    finalPlot(0,1,"#Delta #phi_{jj}","BinWidth",Form("ssww_sswwAnalysis1009_bin0_prefit.root"),"ssww_sswwAnalysis1009_bin0_prefit",0,year,legendBSM.Data(),1.0,isBlinded,"",1,applyScaling,mlfitResult.Data(),channelName.Data());
    finalPlot(0,1,"#Delta #phi_{jj}","BinWidth",Form("ssww_sswwAnalysis1009_bin1_prefit.root"),"ssww_sswwAnalysis1009_bin1_prefit",0,year,legendBSM.Data(),1.0,isBlinded,"",1,applyScaling,mlfitResult.Data(),channelName.Data());
