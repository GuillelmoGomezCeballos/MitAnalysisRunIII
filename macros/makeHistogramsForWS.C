void makeHistogramsForWS(const int year){
  ...
  double WSSF20250[5]  = {1.815014,1.556227,1.461724,1.435135,1.598022};
  double WSSFE_mcanddata20250[5] = {0.089750,0.051663,0.028946,0.018087,0.020471};
  ...
  double WSEtaPtSF20250[6]  = {1.386701,1.478996,1.454139,2.232489,1.571003,1.439795};
  double WSEtaPtSFE_mcanddata20250[6] = {0.119372,0.041665,0.034686,0.090679,0.022383,0.017130};
