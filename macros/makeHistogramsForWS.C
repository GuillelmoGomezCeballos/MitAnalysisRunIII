void makeHistogramsForWS(const int year){
  ...
  double WSSF20250[5]  = {1.719214,1.541042,1.460771,1.486132,1.601885};
  double WSSFE_mcanddata20250[5] = {0.071328,0.044441,0.026245,0.016620,0.019299};
  ...
  double WSEtaPtSF20250[6]  = {1.313849,1.459670,1.452859,2.238501,1.570386,1.476240};
  double WSEtaPtSFE_mcanddata20250[6] = {0.106365,0.035588,0.028866,0.086016,0.020616,0.015874};
