void makeHistogramsForWS(const int year){
  ...
  double WSSF20220[nBinEta0]  = {1.076223,1.446123,1.807191,1.638194,1.323427};
  double WSSFE_mcanddata20220[nBinEta0] = {0.564113,0.144129,0.156472,0.099009,0.057268};

  double WSSF20221[nBinEta0]  = {1.136155,1.651197,1.946463,1.360493,1.399269};
  double WSSFE_mcanddata20221[nBinEta0] = {0.564060,0.093615,0.117099,0.058894,0.033602};

  double WSEtaPtSF20220[nBinEta1*nBinPt1]  = {1.536337,1.072608,1.863291,1.098218,1.394051,1.277488};
  double WSEtaPtSF20220_mcanddata[nBinEta1*nBinPt1] = {0.540289,0.185647,0.170679,0.191902,0.068699,0.059895};

  double WSEtaPtSF20221[nBinEta1*nBinPt1]  = {1.703592,1.624081,1.249210,1.907830,1.354303,1.385177};
  double WSEtaPtSF20221_mcanddata[nBinEta1*nBinPt1] = {0.448542,0.122143,0.105378,0.136017,0.041910,0.035673};
